...
- **Rust**: 1.97.1 (pinned via [`rust-toolchain.toml`](rust-toolchain.toml)). Published crates target **MSRV 1.97.1** (set in the workspace manifest and [`clippy.toml`](clippy.toml)).
