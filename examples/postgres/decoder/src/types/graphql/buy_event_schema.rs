...
impl From<crate::types::BuyEvent> for BuyEventGraphQL {
    fn from(original: crate::types::BuyEvent) -> Self {
        Self {
            ...
            max_quote_amount_in: carbon_core::graphql::primitives::U64(original.max_quote_amount_in),
            ...
            quote_amount_in_with_lp_fee: carbon_core::graphql::primitives::U64(original.quote_amount_in_with_lp_fee),
            user_quote_amount_in: carbon_core::graphql::primitives::U64(original.user_quote_amount_in),
            ...
            protocol_fee_recipient: carbon_core::graphql::primitives::Pubkey(original.protocol_fee_recipient),
            protocol_fee_recipient_token_account: carbon_core::graphql::primitives::Pubkey(original.protocol_fee_recipient_token_account),
            ...
            total_unclaimed_tokens: carbon_core::graphql::primitives::U64(original.total_unclaimed_tokens),
            total_claimed_tokens: carbon_core::graphql::primitives::U64(original.total_claimed_tokens),
