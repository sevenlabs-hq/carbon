...
impl From<crate::types::SellEvent> for SellEventGraphQL {
    fn from(original: crate::types::SellEvent) -> Self {
        Self {
            ...
            quote_amount_out_without_lp_fee: carbon_core::graphql::primitives::U64(original.quote_amount_out_without_lp_fee),
            user_quote_amount_out: carbon_core::graphql::primitives::U64(original.user_quote_amount_out),
