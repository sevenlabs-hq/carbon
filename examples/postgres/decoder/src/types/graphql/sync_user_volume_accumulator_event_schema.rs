...
impl From<crate::types::SyncUserVolumeAccumulatorEvent> for SyncUserVolumeAccumulatorEventGraphQL {
    fn from(original: crate::types::SyncUserVolumeAccumulatorEvent) -> Self {
        Self {
            ...
            total_claimed_tokens_before: carbon_core::graphql::primitives::U64(original.total_claimed_tokens_before),
            total_claimed_tokens_after: carbon_core::graphql::primitives::U64(original.total_claimed_tokens_after),
