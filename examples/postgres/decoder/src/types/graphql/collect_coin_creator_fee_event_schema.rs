...
impl From<crate::types::CollectCoinCreatorFeeEvent> for CollectCoinCreatorFeeEventGraphQL {
    fn from(original: crate::types::CollectCoinCreatorFeeEvent) -> Self {
        Self {
            ...
            coin_creator_vault_ata: carbon_core::graphql::primitives::Pubkey(original.coin_creator_vault_ata),
            coin_creator_token_account: carbon_core::graphql::primitives::Pubkey(original.coin_creator_token_account),
        }
    }
}