...
|----------------------------------------|---------------------------------------|----------------------------------------------|
| `carbon-memo-program-decoder`          | Memo Program Decoder                  | MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr  |
...
| `carbon-token-2022-program-decoder`    | Token-2022 Program Decoder            | TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb  |
|                                        |                                       |                                              |
...
| `carbon-name-service-decoder`          | Name Service Decoder                  |                                              |
