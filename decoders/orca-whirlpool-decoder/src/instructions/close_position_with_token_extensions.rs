...
/// wallet. Mint and TokenAccount are based on Token-2022. And Mint accout will
/// be also closed. ### Authority
...
impl CarbonDeserialize for ClosePositionWithTokenExtensions {
    const DISCRIMINATOR: &'static [u8] = &[1, 182, 135, 59, 155, 25, 99, 223];
