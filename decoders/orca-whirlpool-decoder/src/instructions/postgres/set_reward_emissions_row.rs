...
impl SetRewardEmissionsRow {
    pub fn from_parts(
        source: crate::instructions::set_reward_emissions::SetRewardEmissions,
    ...
    for crate::instructions::set_reward_emissions::SetRewardEmissions
{
    ...
    fn try_from(source: SetRewardEmissionsRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetRewardEmissionsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetRewardEmissionsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetRewardEmissionsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetRewardEmissionsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetRewardEmissionsMigrationOperation {
    async fn up(
        &self,
