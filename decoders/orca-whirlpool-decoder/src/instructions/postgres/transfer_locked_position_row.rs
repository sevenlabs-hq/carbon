...
impl TransferLockedPositionRow {
    pub fn from_parts(
        _source: crate::instructions::transfer_locked_position::TransferLockedPosition,
    ...
    for crate::instructions::transfer_locked_position::TransferLockedPosition
{
    ...
    fn try_from(_source: TransferLockedPositionRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for TransferLockedPositionRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TransferLockedPositionRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TransferLockedPositionRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TransferLockedPositionMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TransferLockedPositionMigrationOperation {
    async fn up(
        &self,
