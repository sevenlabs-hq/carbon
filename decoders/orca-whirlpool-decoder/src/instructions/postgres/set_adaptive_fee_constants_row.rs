...
impl carbon_core::postgres::operations::Insert for SetAdaptiveFeeConstantsRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO orca_whirlpool_set_adaptive_fee_constants_instruction (
                "filter_period",
                "decay_period",
                "reduction_factor",
                "adaptive_fee_control_factor",
...
impl carbon_core::postgres::operations::Upsert for SetAdaptiveFeeConstantsRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO orca_whirlpool_set_adaptive_fee_constants_instruction (
                "filter_period",
                "decay_period",
                "reduction_factor",
                "adaptive_fee_control_factor",
...
impl carbon_core::postgres::operations::Delete for SetAdaptiveFeeConstantsRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM orca_whirlpool_set_adaptive_fee_constants_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for SetAdaptiveFeeConstantsRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM orca_whirlpool_set_adaptive_fee_constants_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for SetAdaptiveFeeConstantsMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS orca_whirlpool_set_adaptive_fee_constants_instruction (
                -- Instruction data
                "filter_period" INT4,
                "decay_period" INT4,
    ...
    async fn down(
        ...
        sqlx::query(
            r#"DROP TABLE IF EXISTS orca_whirlpool_set_adaptive_fee_constants_instruction"#,
        )
        .execute(connection)
        .await?;
        Ok(())
