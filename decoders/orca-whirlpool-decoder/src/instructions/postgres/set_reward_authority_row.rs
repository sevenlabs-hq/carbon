...
impl SetRewardAuthorityRow {
    pub fn from_parts(
        source: crate::instructions::set_reward_authority::SetRewardAuthority,
    ...
    for crate::instructions::set_reward_authority::SetRewardAuthority
{
    ...
    fn try_from(source: SetRewardAuthorityRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetRewardAuthorityRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetRewardAuthorityRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetRewardAuthorityRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetRewardAuthorityMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetRewardAuthorityMigrationOperation {
    async fn up(
        &self,
