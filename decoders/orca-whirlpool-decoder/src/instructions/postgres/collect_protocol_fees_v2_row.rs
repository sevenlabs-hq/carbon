...
impl CollectProtocolFeesV2Row {
    pub fn from_parts(
        source: crate::instructions::collect_protocol_fees_v2::CollectProtocolFeesV2,
    ...
    for crate::instructions::collect_protocol_fees_v2::CollectProtocolFeesV2
{
    ...
    fn try_from(source: CollectProtocolFeesV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CollectProtocolFeesV2Row {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CollectProtocolFeesV2Row {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CollectProtocolFeesV2Row {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CollectProtocolFeesV2MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectProtocolFeesV2MigrationOperation {
    async fn up(
        &self,
