...
impl carbon_core::postgres::operations::Insert for SwapV2Row {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO orca_whirlpool_swap_v2_instruction (
                "amount",
                "other_amount_threshold",
                "sqrt_price_limit",
                "amount_specified_is_input",
...
impl carbon_core::postgres::operations::Upsert for SwapV2Row {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO orca_whirlpool_swap_v2_instruction (
                "amount",
                "other_amount_threshold",
                "sqrt_price_limit",
                "amount_specified_is_input",
...
impl carbon_core::postgres::operations::Delete for SwapV2Row {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM orca_whirlpool_swap_v2_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for SwapV2Row {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM orca_whirlpool_swap_v2_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for SwapV2MigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS orca_whirlpool_swap_v2_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS orca_whirlpool_swap_v2_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
