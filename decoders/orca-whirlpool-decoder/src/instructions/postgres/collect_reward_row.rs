...
impl CollectRewardRow {
    pub fn from_parts(
        source: crate::instructions::collect_reward::CollectReward,
...
impl TryFrom<CollectRewardRow> for crate::instructions::collect_reward::CollectReward {
    type Error = carbon_core::error::Error;
    fn try_from(source: CollectRewardRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CollectRewardRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CollectRewardRow {
    type Key = (
        String,
...
pub struct CollectRewardMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectRewardMigrationOperation {
    async fn up(
        &self,
