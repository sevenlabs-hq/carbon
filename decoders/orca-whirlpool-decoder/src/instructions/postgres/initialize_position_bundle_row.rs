...
impl InitializePositionBundleRow {
    pub fn from_parts(
        _source: crate::instructions::initialize_position_bundle::InitializePositionBundle,
...
impl TryFrom<InitializePositionBundleRow>
    for crate::instructions::initialize_position_bundle::InitializePositionBundle
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: InitializePositionBundleRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for InitializePositionBundleRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializePositionBundleRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializePositionBundleRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializePositionBundleMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializePositionBundleMigrationOperation {
    async fn up(
        &self,
