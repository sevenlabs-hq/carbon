...
impl CloseBundledPositionRow {
    pub fn from_parts(
        source: crate::instructions::close_bundled_position::CloseBundledPosition,
    ...
    for crate::instructions::close_bundled_position::CloseBundledPosition
{
    ...
    fn try_from(source: CloseBundledPositionRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CloseBundledPositionRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CloseBundledPositionRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CloseBundledPositionRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CloseBundledPositionMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseBundledPositionMigrationOperation {
    async fn up(
        &self,
