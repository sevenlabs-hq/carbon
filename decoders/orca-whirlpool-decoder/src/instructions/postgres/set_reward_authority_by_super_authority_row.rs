...
impl SetRewardAuthorityBySuperAuthorityRow {
    pub fn from_parts(
        source: crate::instructions::set_reward_authority_by_super_authority::SetRewardAuthorityBySuperAuthority,
...
impl TryFrom<SetRewardAuthorityBySuperAuthorityRow> for crate::instructions::set_reward_authority_by_super_authority::SetRewardAuthorityBySuperAuthority {
    type Error = carbon_core::error::Error;
    fn try_from(source: SetRewardAuthorityBySuperAuthorityRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetRewardAuthorityBySuperAuthorityRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetRewardAuthorityBySuperAuthorityRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetRewardAuthorityBySuperAuthorityRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetRewardAuthorityBySuperAuthorityMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for SetRewardAuthorityBySuperAuthorityMigrationOperation
{
    async fn up(
        &self,
