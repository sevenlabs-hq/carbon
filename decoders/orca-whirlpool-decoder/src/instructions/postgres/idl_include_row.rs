...
impl IdlIncludeRow {
    pub fn from_parts(
        _source: crate::instructions::idl_include::IdlInclude,
...
impl TryFrom<IdlIncludeRow> for crate::instructions::idl_include::IdlInclude {
    type Error = carbon_core::error::Error;
    fn try_from(_source: IdlIncludeRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for IdlIncludeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for IdlIncludeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for IdlIncludeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct IdlIncludeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for IdlIncludeMigrationOperation {
    async fn up(
        &self,
