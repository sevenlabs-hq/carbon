...
impl InitializeTickArrayRow {
    pub fn from_parts(
        source: crate::instructions::initialize_tick_array::InitializeTickArray,
    ...
    for crate::instructions::initialize_tick_array::InitializeTickArray
{
    ...
    fn try_from(source: InitializeTickArrayRow) -> Result<Self, Self::Error> {
        Ok(Self {
            start_tick_index: source.start_tick_index,
        })
    }
...
impl carbon_core::postgres::operations::Insert for InitializeTickArrayRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeTickArrayRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeTickArrayRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeTickArrayMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializeTickArrayMigrationOperation {
    async fn up(
        &self,
