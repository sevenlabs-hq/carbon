...
/// wallet. Additional Metaplex metadata is appended to identify the token.
...
impl CarbonDeserialize for InitializePositionBundleWithMetadata {
    const DISCRIMINATOR: &'static [u8] = &[93, 124, 16, 179, 249, 131, 115, 245];
