...
/// Only the current config extension authority has permission to invoke this
...
impl CarbonDeserialize for SetConfigExtensionAuthority {
    const DISCRIMINATOR: &'static [u8] = &[44, 94, 241, 116, 24, 188, 60, 143];
