...
#[graphql(name = "SetRewardEmissionsV2")]
pub struct SetRewardEmissionsV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::SetRewardEmissionsV2Row>
    for SetRewardEmissionsV2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetRewardEmissionsV2Row,
