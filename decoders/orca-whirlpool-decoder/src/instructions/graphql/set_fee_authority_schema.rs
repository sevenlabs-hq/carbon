...
#[graphql(name = "SetFeeAuthority")]
pub struct SetFeeAuthorityGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetFeeAuthorityRow> for SetFeeAuthorityGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetFeeAuthorityRow,
