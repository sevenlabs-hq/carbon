...
#[graphql(name = "OpenBundledPosition")]
pub struct OpenBundledPositionGraphQL {
...
impl TryFrom<crate::instructions::postgres::OpenBundledPositionRow> for OpenBundledPositionGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::OpenBundledPositionRow,
