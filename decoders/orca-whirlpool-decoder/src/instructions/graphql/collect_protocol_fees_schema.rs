...
#[graphql(name = "CollectProtocolFees")]
pub struct CollectProtocolFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectProtocolFeesRow> for CollectProtocolFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectProtocolFeesRow,
