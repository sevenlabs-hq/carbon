...
#[graphql(name = "DeleteTokenBadge")]
pub struct DeleteTokenBadgeGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeleteTokenBadgeRow> for DeleteTokenBadgeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeleteTokenBadgeRow,
