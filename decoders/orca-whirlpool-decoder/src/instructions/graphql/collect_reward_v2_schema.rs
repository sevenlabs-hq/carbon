...
use {
    crate::types::graphql::RemainingAccountsInfoGraphQL, carbon_core::graphql::primitives::U8,
    juniper::GraphQLObject, serde_json,
};

#[derive(Debug, Clone, GraphQLObject)]
#[graphql(name = "CollectRewardV2")]
pub struct CollectRewardV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectRewardV2Row> for CollectRewardV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectRewardV2Row,
