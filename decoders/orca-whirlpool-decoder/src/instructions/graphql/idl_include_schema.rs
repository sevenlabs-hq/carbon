...
#[graphql(name = "IdlInclude")]
pub struct IdlIncludeGraphQL {
...
impl TryFrom<crate::instructions::postgres::IdlIncludeRow> for IdlIncludeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::IdlIncludeRow) -> Result<Self, Self::Error> {
        Ok(Self {
