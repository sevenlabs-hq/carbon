...
#[graphql(name = "SetTokenBadgeAuthority")]
pub struct SetTokenBadgeAuthorityGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetTokenBadgeAuthorityRow>
    for SetTokenBadgeAuthorityGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetTokenBadgeAuthorityRow,
