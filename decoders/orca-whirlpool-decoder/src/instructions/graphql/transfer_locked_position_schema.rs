...
#[graphql(name = "TransferLockedPosition")]
pub struct TransferLockedPositionGraphQL {
...
impl TryFrom<crate::instructions::postgres::TransferLockedPositionRow>
    for TransferLockedPositionGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TransferLockedPositionRow,
