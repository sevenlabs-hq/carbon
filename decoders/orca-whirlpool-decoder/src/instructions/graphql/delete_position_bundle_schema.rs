...
#[graphql(name = "DeletePositionBundle")]
pub struct DeletePositionBundleGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeletePositionBundleRow>
    for DeletePositionBundleGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeletePositionBundleRow,
