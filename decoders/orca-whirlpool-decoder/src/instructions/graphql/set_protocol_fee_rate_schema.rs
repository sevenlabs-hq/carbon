...
#[graphql(name = "SetProtocolFeeRate")]
pub struct SetProtocolFeeRateGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetProtocolFeeRateRow> for SetProtocolFeeRateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetProtocolFeeRateRow,
