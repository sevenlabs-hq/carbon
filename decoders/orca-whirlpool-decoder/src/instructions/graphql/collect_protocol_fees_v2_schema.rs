...
#[graphql(name = "CollectProtocolFeesV2")]
pub struct CollectProtocolFeesV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectProtocolFeesV2Row>
    for CollectProtocolFeesV2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectProtocolFeesV2Row,
