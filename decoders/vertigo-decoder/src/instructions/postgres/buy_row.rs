...
impl carbon_core::postgres::operations::Insert for BuyRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO vertigo_buy_instruction (
                "params",
...
impl carbon_core::postgres::operations::Upsert for BuyRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO vertigo_buy_instruction (
                "params",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5, $6
...
impl carbon_core::postgres::operations::Delete for BuyRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM vertigo_buy_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for BuyRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM vertigo_buy_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for BuyMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS vertigo_buy_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS vertigo_buy_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
