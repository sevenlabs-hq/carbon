...
impl WhitelistDepositAccountRow {
    pub fn from_parts(
        source: crate::accounts::whitelist_deposit_account::WhitelistDepositAccount,
    ...
    for crate::accounts::whitelist_deposit_account::WhitelistDepositAccount
{
    ...
    fn try_from(source: WhitelistDepositAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for WhitelistDepositAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for WhitelistDepositAccountRow {
...
pub struct WhitelistDepositAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for WhitelistDepositAccountMigrationOperation {
    async fn up(
        &self,
