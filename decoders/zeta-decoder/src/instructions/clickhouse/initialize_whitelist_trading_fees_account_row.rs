...
impl
    TryFrom<(
        crate::instructions::initialize_whitelist_trading_fees_account::InitializeWhitelistTradingFeesAccount,
    ...
    )> for InitializeWhitelistTradingFeesAccountRow
{
...
impl carbon_core::clickhouse::ClusterTable for InitializeWhitelistTradingFeesAccountRow {
    fn local_table() -> &'static str {
        "zeta_initialize_whitelist_trading_fees_account_instruction_local"
    }
...
impl carbon_core::clickhouse::Table for InitializeWhitelistTradingFeesAccountRow {
    fn table() -> &'static str {
        "zeta_initialize_whitelist_trading_fees_account_instruction"
    }
}
...
pub struct InitializeWhitelistTradingFeesAccountRowMigrationOperation;
...
impl carbon_core::clickhouse::Operation for InitializeWhitelistTradingFeesAccountRowMigrationOperation {
    async fn up(
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/zeta_initialize_whitelist_trading_fees_account_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS zeta_initialize_whitelist_trading_fees_account_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS zeta_initialize_whitelist_trading_fees_account_instruction ON CLUSTER {cluster} AS zeta_initialize_whitelist_trading_fees_account_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), zeta_initialize_whitelist_trading_fees_account_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS zeta_initialize_whitelist_trading_fees_account_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS zeta_initialize_whitelist_trading_fees_account_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
...
impl carbon_core::clickhouse::Operation for InitializeWhitelistTradingFeesAccountRowMigrationOperation {
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS zeta_initialize_whitelist_trading_fees_account_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
