...
impl CarbonDeserialize for InitializeWhitelistInsuranceAccount {
    const DISCRIMINATOR: &'static [u8] = &[43, 46, 240, 155, 80, 4, 86, 102];
...
impl ArrangeAccounts for InitializeWhitelistInsuranceAccount {
