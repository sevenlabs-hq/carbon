...
impl InitializeZetaReferralsRewardsWalletRow {
    pub fn from_parts(
        _source: crate::instructions::initialize_zeta_referrals_rewards_wallet::InitializeZetaReferralsRewardsWallet,
...
impl TryFrom<InitializeZetaReferralsRewardsWalletRow> for crate::instructions::initialize_zeta_referrals_rewards_wallet::InitializeZetaReferralsRewardsWallet {
    type Error = carbon_core::error::Error;
    fn try_from(_source: InitializeZetaReferralsRewardsWalletRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for InitializeZetaReferralsRewardsWalletRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeZetaReferralsRewardsWalletRow {
    type Key = (
        String,
...
pub struct InitializeZetaReferralsRewardsWalletMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeZetaReferralsRewardsWalletMigrationOperation
{
    async fn up(
        &self,
