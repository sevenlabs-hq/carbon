...
impl UpdateReferralsAdminRow {
    pub fn from_parts(
        _source: crate::instructions::update_referrals_admin::UpdateReferralsAdmin,
    ...
    for crate::instructions::update_referrals_admin::UpdateReferralsAdmin
{
    ...
    fn try_from(_source: UpdateReferralsAdminRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for UpdateReferralsAdminRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateReferralsAdminRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateReferralsAdminRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateReferralsAdminMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateReferralsAdminMigrationOperation {
    async fn up(
        &self,
