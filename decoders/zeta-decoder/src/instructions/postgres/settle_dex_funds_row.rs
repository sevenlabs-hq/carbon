...
impl SettleDexFundsRow {
    pub fn from_parts(
        _source: crate::instructions::settle_dex_funds::SettleDexFunds,
...
impl TryFrom<SettleDexFundsRow> for crate::instructions::settle_dex_funds::SettleDexFunds {
    type Error = carbon_core::error::Error;
    fn try_from(_source: SettleDexFundsRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SettleDexFundsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SettleDexFundsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SettleDexFundsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SettleDexFundsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SettleDexFundsMigrationOperation {
    async fn up(
        &self,
