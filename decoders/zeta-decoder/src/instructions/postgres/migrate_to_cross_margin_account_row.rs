...
impl MigrateToCrossMarginAccountRow {
    pub fn from_parts(
        _source: crate::instructions::migrate_to_cross_margin_account::MigrateToCrossMarginAccount,
...
impl TryFrom<MigrateToCrossMarginAccountRow>
    for crate::instructions::migrate_to_cross_margin_account::MigrateToCrossMarginAccount
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: MigrateToCrossMarginAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrateToCrossMarginAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrateToCrossMarginAccountRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MigrateToCrossMarginAccountRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MigrateToCrossMarginAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MigrateToCrossMarginAccountMigrationOperation {
    async fn up(
        &self,
