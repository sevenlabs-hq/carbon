...
impl InitializeReferrerAliasRow {
    pub fn from_parts(
        source: crate::instructions::initialize_referrer_alias::InitializeReferrerAlias,
    ...
    for crate::instructions::initialize_referrer_alias::InitializeReferrerAlias
{
    ...
    fn try_from(source: InitializeReferrerAliasRow) -> Result<Self, Self::Error> {
        Ok(Self {
            alias: source.alias,
        })
    }
...
impl carbon_core::postgres::operations::Insert for InitializeReferrerAliasRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeReferrerAliasRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeReferrerAliasRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeReferrerAliasMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializeReferrerAliasMigrationOperation {
    async fn up(
        &self,
