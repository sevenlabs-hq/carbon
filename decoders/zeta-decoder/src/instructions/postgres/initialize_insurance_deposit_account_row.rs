...
impl InitializeInsuranceDepositAccountRow {
    pub fn from_parts(
        source: crate::instructions::initialize_insurance_deposit_account::InitializeInsuranceDepositAccount,
...
impl TryFrom<InitializeInsuranceDepositAccountRow>
    for crate::instructions::initialize_insurance_deposit_account::InitializeInsuranceDepositAccount
{
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializeInsuranceDepositAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializeInsuranceDepositAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeInsuranceDepositAccountRow {
    type Key = (
        String,
...
pub struct InitializeInsuranceDepositAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeInsuranceDepositAccountMigrationOperation
{
    async fn up(
        &self,
