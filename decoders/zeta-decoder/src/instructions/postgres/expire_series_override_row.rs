...
use {
    crate::types::ExpireSeriesOverrideArgs,
...
pub struct ExpireSeriesOverrideRow {
    ...
    pub args: sqlx::types::Json<ExpireSeriesOverrideArgs>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl ExpireSeriesOverrideRow {
    pub fn from_parts(
        source: crate::instructions::expire_series_override::ExpireSeriesOverride,
    ...
    for crate::instructions::expire_series_override::ExpireSeriesOverride
{
    ...
    fn try_from(source: ExpireSeriesOverrideRow) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
        })
    }
...
impl carbon_core::postgres::operations::Insert for ExpireSeriesOverrideRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ExpireSeriesOverrideRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ExpireSeriesOverrideRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ExpireSeriesOverrideMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ExpireSeriesOverrideMigrationOperation {
    async fn up(
        &self,
