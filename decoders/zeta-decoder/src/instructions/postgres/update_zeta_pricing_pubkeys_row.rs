...
pub struct UpdateZetaPricingPubkeysRow {
    ...
    pub args: sqlx::types::Json<UpdateZetaPricingPubkeysArgs>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl UpdateZetaPricingPubkeysRow {
    pub fn from_parts(
        source: crate::instructions::update_zeta_pricing_pubkeys::UpdateZetaPricingPubkeys,
...
impl TryFrom<UpdateZetaPricingPubkeysRow>
    for crate::instructions::update_zeta_pricing_pubkeys::UpdateZetaPricingPubkeys
{
    type Error = carbon_core::error::Error;
    fn try_from(source: UpdateZetaPricingPubkeysRow) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
        })
    }
...
impl carbon_core::postgres::operations::Insert for UpdateZetaPricingPubkeysRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateZetaPricingPubkeysRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateZetaPricingPubkeysRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateZetaPricingPubkeysMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateZetaPricingPubkeysMigrationOperation {
    async fn up(
        &self,
