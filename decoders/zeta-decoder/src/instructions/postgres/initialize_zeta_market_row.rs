...
pub struct InitializeZetaMarketRow {
    ...
    pub args: sqlx::types::Json<InitializeMarketArgs>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl InitializeZetaMarketRow {
    pub fn from_parts(
        source: crate::instructions::initialize_zeta_market::InitializeZetaMarket,
    ...
    for crate::instructions::initialize_zeta_market::InitializeZetaMarket
{
    ...
    fn try_from(source: InitializeZetaMarketRow) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
        })
    }
...
impl carbon_core::postgres::operations::Insert for InitializeZetaMarketRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeZetaMarketRow {
    type Key = (
        String,
...
pub struct InitializeZetaMarketMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializeZetaMarketMigrationOperation {
    async fn up(
        &self,
