...
pub struct UpdateZetaStateRow {
    ...
    pub args: sqlx::types::Json<UpdateStateArgs>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl UpdateZetaStateRow {
    pub fn from_parts(
        source: crate::instructions::update_zeta_state::UpdateZetaState,
...
impl TryFrom<UpdateZetaStateRow> for crate::instructions::update_zeta_state::UpdateZetaState {
    type Error = carbon_core::error::Error;
    fn try_from(source: UpdateZetaStateRow) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
        })
    }
...
impl carbon_core::postgres::operations::Insert for UpdateZetaStateRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateZetaStateRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateZetaStateRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateZetaStateMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateZetaStateMigrationOperation {
    async fn up(
        &self,
