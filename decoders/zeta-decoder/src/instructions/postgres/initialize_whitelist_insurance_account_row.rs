...
impl InitializeWhitelistInsuranceAccountRow {
    pub fn from_parts(
        source: crate::instructions::initialize_whitelist_insurance_account::InitializeWhitelistInsuranceAccount,
...
impl TryFrom<InitializeWhitelistInsuranceAccountRow> for crate::instructions::initialize_whitelist_insurance_account::InitializeWhitelistInsuranceAccount {
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializeWhitelistInsuranceAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializeWhitelistInsuranceAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeWhitelistInsuranceAccountRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeWhitelistInsuranceAccountRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeWhitelistInsuranceAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeWhitelistInsuranceAccountMigrationOperation
{
    async fn up(
        &self,
