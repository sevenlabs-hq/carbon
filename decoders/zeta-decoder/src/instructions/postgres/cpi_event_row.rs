    ...
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                ...
                CpiEvent::TradeEventV2(_) => "trade_event_v2".to_string(),
                CpiEvent::TradeEventV3(_) => "trade_event_v3".to_string(),
                CpiEvent::PositionMovementEvent(_) => "position_movement_event".to_string(),
                CpiEvent::PlaceOrderEvent(_) => "place_order_event".to_string(),
                CpiEvent::LiquidationEvent(_) => "liquidation_event".to_string(),
                CpiEvent::OrderCompleteEvent(_) => "order_complete_event".to_string(),
                CpiEvent::ApplyFundingEvent(_) => "apply_funding_event".to_string(),
            },
...
impl carbon_core::postgres::operations::Delete for CpiEventRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM zeta_cpi_events WHERE
...
impl carbon_core::postgres::operations::Lookup for CpiEventRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM zeta_cpi_events WHERE
            __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
        "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CpiEventMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS zeta_cpi_events (
            -- Instruction data
            "name" TEXT NOT NULL,
            "data" JSONB NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS zeta_cpi_events"#)
            .execute(connection)
            .await?;
        Ok(())
    }
