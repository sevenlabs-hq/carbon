...
impl InitializeCombinedSocializedLossAccountRow {
    pub fn from_parts(
        source: crate::instructions::initialize_combined_socialized_loss_account::InitializeCombinedSocializedLossAccount,
...
impl TryFrom<InitializeCombinedSocializedLossAccountRow> for crate::instructions::initialize_combined_socialized_loss_account::InitializeCombinedSocializedLossAccount {
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializeCombinedSocializedLossAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializeCombinedSocializedLossAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeCombinedSocializedLossAccountRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeCombinedSocializedLossAccountRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeCombinedSocializedLossAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeCombinedSocializedLossAccountMigrationOperation
{
    async fn up(
        &self,
