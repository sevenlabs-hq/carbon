...
impl InitializeCrossMarginAccountManagerRow {
    pub fn from_parts(
        _source: crate::instructions::initialize_cross_margin_account_manager::InitializeCrossMarginAccountManager,
...
impl TryFrom<InitializeCrossMarginAccountManagerRow> for crate::instructions::initialize_cross_margin_account_manager::InitializeCrossMarginAccountManager {
    type Error = carbon_core::error::Error;
    fn try_from(_source: InitializeCrossMarginAccountManagerRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for InitializeCrossMarginAccountManagerRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeCrossMarginAccountManagerRow {
    type Key = (
        String,
...
pub struct InitializeCrossMarginAccountManagerMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeCrossMarginAccountManagerMigrationOperation
{
    async fn up(
        &self,
