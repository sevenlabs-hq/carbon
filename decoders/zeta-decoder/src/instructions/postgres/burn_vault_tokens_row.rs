...
impl BurnVaultTokensRow {
    pub fn from_parts(
        _source: crate::instructions::burn_vault_tokens::BurnVaultTokens,
...
impl TryFrom<BurnVaultTokensRow> for crate::instructions::burn_vault_tokens::BurnVaultTokens {
    type Error = carbon_core::error::Error;
    fn try_from(_source: BurnVaultTokensRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for BurnVaultTokensRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for BurnVaultTokensRow {
    type Key = (
        String,
...
pub struct BurnVaultTokensMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for BurnVaultTokensMigrationOperation {
    async fn up(
        &self,
