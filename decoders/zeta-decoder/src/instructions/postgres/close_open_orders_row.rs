...
impl CloseOpenOrdersRow {
    pub fn from_parts(
        source: crate::instructions::close_open_orders::CloseOpenOrders,
...
impl TryFrom<CloseOpenOrdersRow> for crate::instructions::close_open_orders::CloseOpenOrders {
    type Error = carbon_core::error::Error;
    fn try_from(source: CloseOpenOrdersRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CloseOpenOrdersRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CloseOpenOrdersRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CloseOpenOrdersRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CloseOpenOrdersMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseOpenOrdersMigrationOperation {
    async fn up(
        &self,
