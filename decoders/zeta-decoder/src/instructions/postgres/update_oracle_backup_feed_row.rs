...
impl UpdateOracleBackupFeedRow {
    pub fn from_parts(
        _source: crate::instructions::update_oracle_backup_feed::UpdateOracleBackupFeed,
    ...
    for crate::instructions::update_oracle_backup_feed::UpdateOracleBackupFeed
{
    ...
    fn try_from(_source: UpdateOracleBackupFeedRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for UpdateOracleBackupFeedRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateOracleBackupFeedRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateOracleBackupFeedRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateOracleBackupFeedMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateOracleBackupFeedMigrationOperation {
    async fn up(
        &self,
