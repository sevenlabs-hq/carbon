...
impl ReferUserRow {
    pub fn from_parts(
        _source: crate::instructions::refer_user::ReferUser,
...
impl TryFrom<ReferUserRow> for crate::instructions::refer_user::ReferUser {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ReferUserRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ReferUserRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ReferUserRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ReferUserRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ReferUserMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ReferUserMigrationOperation {
    async fn up(
        &self,
