...
impl CarbonDeserialize for InitializeWhitelistTradingFeesAccount {
    const DISCRIMINATOR: &'static [u8] = &[198, 129, 216, 185, 247, 29, 105, 190];
...
impl ArrangeAccounts for InitializeWhitelistTradingFeesAccount {
    ...
    fn arrange_accounts(
        ...
        let whitelist_trading_fees_account = next_account(&mut iter)?;
