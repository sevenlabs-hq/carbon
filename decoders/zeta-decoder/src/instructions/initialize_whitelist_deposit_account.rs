...
impl CarbonDeserialize for InitializeWhitelistDepositAccount {
    const DISCRIMINATOR: &'static [u8] = &[61, 231, 115, 219, 81, 243, 158, 138];
...
impl ArrangeAccounts for InitializeWhitelistDepositAccount {
    ...
    fn arrange_accounts(
        ...
        let whitelist_deposit_account = next_account(&mut iter)?;
