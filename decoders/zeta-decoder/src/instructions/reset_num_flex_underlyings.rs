...
impl CarbonDeserialize for ResetNumFlexUnderlyings {
    const DISCRIMINATOR: &'static [u8] = &[48, 19, 254, 209, 200, 211, 49, 61];
...
impl ArrangeAccounts for ResetNumFlexUnderlyings {
