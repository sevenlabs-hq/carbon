...
#[graphql(name = "RebalanceInsuranceVault")]
pub struct RebalanceInsuranceVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::RebalanceInsuranceVaultRow>
    for RebalanceInsuranceVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RebalanceInsuranceVaultRow,
