...
#[graphql(name = "PruneExpiredTifOrders")]
pub struct PruneExpiredTifOrdersGraphQL {
...
impl TryFrom<crate::instructions::postgres::PruneExpiredTifOrdersRow>
    for PruneExpiredTifOrdersGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PruneExpiredTifOrdersRow,
