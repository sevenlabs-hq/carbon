...
#[graphql(name = "DepositV2")]
pub struct DepositV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositV2Row> for DepositV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DepositV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
