...
#[graphql(name = "BurnVaultTokens")]
pub struct BurnVaultTokensGraphQL {
...
impl TryFrom<crate::instructions::postgres::BurnVaultTokensRow> for BurnVaultTokensGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::BurnVaultTokensRow,
