...
#[graphql(name = "DepositInsuranceVaultV2")]
pub struct DepositInsuranceVaultV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositInsuranceVaultV2Row>
    for DepositInsuranceVaultV2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositInsuranceVaultV2Row,
