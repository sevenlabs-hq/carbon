...
#[graphql(name = "UpdateReferralsAdmin")]
pub struct UpdateReferralsAdminGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateReferralsAdminRow>
    for UpdateReferralsAdminGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateReferralsAdminRow,
