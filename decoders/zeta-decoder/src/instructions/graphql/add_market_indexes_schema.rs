...
#[graphql(name = "AddMarketIndexes")]
pub struct AddMarketIndexesGraphQL {
...
impl TryFrom<crate::instructions::postgres::AddMarketIndexesRow> for AddMarketIndexesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AddMarketIndexesRow,
