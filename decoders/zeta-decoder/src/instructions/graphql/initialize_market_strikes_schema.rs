...
#[graphql(name = "InitializeMarketStrikes")]
pub struct InitializeMarketStrikesGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeMarketStrikesRow>
    for InitializeMarketStrikesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeMarketStrikesRow,
