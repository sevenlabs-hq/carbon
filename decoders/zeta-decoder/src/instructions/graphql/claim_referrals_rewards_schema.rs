...
#[graphql(name = "ClaimReferralsRewards")]
pub struct ClaimReferralsRewardsGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimReferralsRewardsRow>
    for ClaimReferralsRewardsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimReferralsRewardsRow,
