...
#[graphql(name = "InitializeOpenOrdersV2")]
pub struct InitializeOpenOrdersV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeOpenOrdersV2Row>
    for InitializeOpenOrdersV2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeOpenOrdersV2Row,
