...
#[graphql(name = "InitializeSpreadAccount")]
pub struct InitializeSpreadAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeSpreadAccountRow>
    for InitializeSpreadAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeSpreadAccountRow,
