...
#[graphql(name = "WithdrawV2")]
pub struct WithdrawV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawV2Row> for WithdrawV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::WithdrawV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
