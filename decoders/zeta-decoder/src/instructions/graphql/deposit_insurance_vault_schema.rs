...
#[graphql(name = "DepositInsuranceVault")]
pub struct DepositInsuranceVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositInsuranceVaultRow>
    for DepositInsuranceVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositInsuranceVaultRow,
