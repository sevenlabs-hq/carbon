...
#[graphql(name = "Liquidate")]
pub struct LiquidateGraphQL {
...
impl TryFrom<crate::instructions::postgres::LiquidateRow> for LiquidateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::LiquidateRow) -> Result<Self, Self::Error> {
        Ok(Self {
