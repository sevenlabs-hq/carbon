...
#[graphql(name = "CleanZetaMarkets")]
pub struct CleanZetaMarketsGraphQL {
...
impl TryFrom<crate::instructions::postgres::CleanZetaMarketsRow> for CleanZetaMarketsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CleanZetaMarketsRow,
