...
#[graphql(name = "SettleDexFunds")]
pub struct SettleDexFundsGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettleDexFundsRow> for SettleDexFundsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SettleDexFundsRow,
