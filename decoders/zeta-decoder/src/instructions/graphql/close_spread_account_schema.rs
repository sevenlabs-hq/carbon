...
#[graphql(name = "CloseSpreadAccount")]
pub struct CloseSpreadAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseSpreadAccountRow> for CloseSpreadAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseSpreadAccountRow,
