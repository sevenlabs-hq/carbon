...
#[graphql(name = "UpdateOracle")]
pub struct UpdateOracleGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateOracleRow> for UpdateOracleGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::UpdateOracleRow) -> Result<Self, Self::Error> {
        Ok(Self {
