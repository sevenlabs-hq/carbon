...
#[graphql(name = "CollectTreasuryFunds")]
pub struct CollectTreasuryFundsGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectTreasuryFundsRow>
    for CollectTreasuryFundsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectTreasuryFundsRow,
