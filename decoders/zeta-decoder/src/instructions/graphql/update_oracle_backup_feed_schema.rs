...
#[graphql(name = "UpdateOracleBackupFeed")]
pub struct UpdateOracleBackupFeedGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateOracleBackupFeedRow>
    for UpdateOracleBackupFeedGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateOracleBackupFeedRow,
