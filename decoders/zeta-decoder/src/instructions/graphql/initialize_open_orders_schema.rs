...
#[graphql(name = "InitializeOpenOrders")]
pub struct InitializeOpenOrdersGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeOpenOrdersRow>
    for InitializeOpenOrdersGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeOpenOrdersRow,
