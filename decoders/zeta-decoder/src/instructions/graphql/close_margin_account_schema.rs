...
#[graphql(name = "CloseMarginAccount")]
pub struct CloseMarginAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseMarginAccountRow> for CloseMarginAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseMarginAccountRow,
