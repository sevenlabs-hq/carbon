...
#[graphql(name = "UpdateSecondaryAdmin")]
pub struct UpdateSecondaryAdminGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateSecondaryAdminRow>
    for UpdateSecondaryAdminGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateSecondaryAdminRow,
