...
#[graphql(name = "InitializeMarginAccount")]
pub struct InitializeMarginAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeMarginAccountRow>
    for InitializeMarginAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeMarginAccountRow,
