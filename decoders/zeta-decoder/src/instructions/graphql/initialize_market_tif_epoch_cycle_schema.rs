...
#[graphql(name = "InitializeMarketTifEpochCycle")]
pub struct InitializeMarketTifEpochCycleGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeMarketTifEpochCycleRow>
    for InitializeMarketTifEpochCycleGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeMarketTifEpochCycleRow,
