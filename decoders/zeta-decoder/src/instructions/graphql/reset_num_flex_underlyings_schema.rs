...
#[graphql(name = "ResetNumFlexUnderlyings")]
pub struct ResetNumFlexUnderlyingsGraphQL {
...
impl TryFrom<crate::instructions::postgres::ResetNumFlexUnderlyingsRow>
    for ResetNumFlexUnderlyingsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ResetNumFlexUnderlyingsRow,
