...
impl CarbonDeserialize for CancelOrderByClientOrderIdNoError {
    const DISCRIMINATOR: &'static [u8] = &[53, 77, 167, 157, 175, 131, 144, 171];
...
impl ArrangeAccounts for CancelOrderByClientOrderIdNoError {
