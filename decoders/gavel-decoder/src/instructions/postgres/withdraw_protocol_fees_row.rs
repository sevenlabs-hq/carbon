...
impl WithdrawProtocolFeesRow {
    pub fn from_parts(
        _source: crate::instructions::withdraw_protocol_fees::WithdrawProtocolFees,
    ...
    for crate::instructions::withdraw_protocol_fees::WithdrawProtocolFees
{
    ...
    fn try_from(_source: WithdrawProtocolFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for WithdrawProtocolFeesRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for WithdrawProtocolFeesRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for WithdrawProtocolFeesRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct WithdrawProtocolFeesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for WithdrawProtocolFeesMigrationOperation {
    async fn up(
        &self,
