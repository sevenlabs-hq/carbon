...
#[graphql(name = "WithdrawLpFees")]
pub struct WithdrawLpFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawLpFeesRow> for WithdrawLpFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawLpFeesRow,
