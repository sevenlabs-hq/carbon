...
#[graphql(name = "TransferLiquidity")]
pub struct TransferLiquidityGraphQL {
...
impl TryFrom<crate::instructions::postgres::TransferLiquidityRow> for TransferLiquidityGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TransferLiquidityRow,
