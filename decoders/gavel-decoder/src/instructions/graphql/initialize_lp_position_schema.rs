...
#[graphql(name = "InitializeLpPosition")]
pub struct InitializeLpPositionGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeLpPositionRow>
    for InitializeLpPositionGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeLpPositionRow,
