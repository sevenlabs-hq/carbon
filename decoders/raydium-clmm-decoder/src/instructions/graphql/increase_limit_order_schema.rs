...
#[graphql(name = "IncreaseLimitOrder")]
pub struct IncreaseLimitOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::IncreaseLimitOrderRow> for IncreaseLimitOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::IncreaseLimitOrderRow,
