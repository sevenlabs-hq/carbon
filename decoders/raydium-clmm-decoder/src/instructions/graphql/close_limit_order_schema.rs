...
#[graphql(name = "CloseLimitOrder")]
pub struct CloseLimitOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseLimitOrderRow> for CloseLimitOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseLimitOrderRow,
