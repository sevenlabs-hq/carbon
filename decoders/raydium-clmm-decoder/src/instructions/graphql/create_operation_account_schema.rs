...
#[graphql(name = "CreateOperationAccount")]
pub struct CreateOperationAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateOperationAccountRow>
    for CreateOperationAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateOperationAccountRow,
