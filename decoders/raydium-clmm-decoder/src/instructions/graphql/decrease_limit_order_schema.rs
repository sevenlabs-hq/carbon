...
#[graphql(name = "DecreaseLimitOrder")]
pub struct DecreaseLimitOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::DecreaseLimitOrderRow> for DecreaseLimitOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DecreaseLimitOrderRow,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            instruction_metadata: row.instruction_metadata.into(),
            amount: carbon_core::graphql::primitives::U64(*row.amount),
            amount_min: carbon_core::graphql::primitives::U64(*row.amount_min),
