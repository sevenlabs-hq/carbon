...
#[graphql(name = "CloseProtocolPosition")]
pub struct CloseProtocolPositionGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseProtocolPositionRow>
    for CloseProtocolPositionGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseProtocolPositionRow,
