...
#[graphql(name = "UpdateRewardInfos")]
pub struct UpdateRewardInfosGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateRewardInfosRow> for UpdateRewardInfosGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateRewardInfosRow,
