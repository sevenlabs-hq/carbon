...
impl TryFrom<crate::instructions::postgres::CollectRemainingRewardsRow>
    for CollectRemainingRewardsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectRemainingRewardsRow,
