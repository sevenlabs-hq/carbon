...
#[graphql(name = "SettleLimitOrder")]
pub struct SettleLimitOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettleLimitOrderRow> for SettleLimitOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SettleLimitOrderRow,
