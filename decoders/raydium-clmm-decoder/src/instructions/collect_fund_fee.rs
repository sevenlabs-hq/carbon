...
impl carbon_core::deserialize::ArrangeAccounts for CollectFundFee {
    ...
    fn arrange_accounts(
        ...
        let [owner, pool_state, amm_config, token_vault0, token_vault1, vault0_mint, vault1_mint, recipient_token_account0, recipient_token_account1, token_program, token_program2022] =
            accounts
        else {
            return None;
        };
