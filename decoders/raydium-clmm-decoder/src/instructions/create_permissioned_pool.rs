...
pub struct CreatePermissionedPool {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CreatePermissionedPoolInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for CreatePermissionedPool {
    const DISCRIMINATOR: &'static [u8] = &[36, 243, 179, 35, 42, 239, 53, 229];
...
impl ArrangeAccounts for CreatePermissionedPool {
    type ArrangedAccounts = CreatePermissionedPoolInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(CreatePermissionedPoolInstructionAccounts {
            payer,
            pool_creator,
            permission,
            amm_config,
