...
impl DecreaseLimitOrderRow {
    pub fn from_parts(
        source: crate::instructions::decrease_limit_order::DecreaseLimitOrder,
        ...
        Self {
            ...
            amount_min: source.amount_min.into(),
    ...
    for crate::instructions::decrease_limit_order::DecreaseLimitOrder
{
    ...
    fn try_from(source: DecreaseLimitOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for DecreaseLimitOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DecreaseLimitOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Lookup for DecreaseLimitOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct DecreaseLimitOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for DecreaseLimitOrderMigrationOperation {
    async fn up(
        &self,
