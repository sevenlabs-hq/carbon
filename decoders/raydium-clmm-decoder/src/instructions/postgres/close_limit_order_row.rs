...
impl CloseLimitOrderRow {
    pub fn from_parts(
        _source: crate::instructions::close_limit_order::CloseLimitOrder,
...
impl TryFrom<CloseLimitOrderRow> for crate::instructions::close_limit_order::CloseLimitOrder {
    type Error = carbon_core::error::Error;
    fn try_from(_source: CloseLimitOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CloseLimitOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CloseLimitOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Lookup for CloseLimitOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CloseLimitOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseLimitOrderMigrationOperation {
    async fn up(
        &self,
