...
impl CreateDynamicFeeConfigRow {
    pub fn from_parts(
        source: crate::instructions::create_dynamic_fee_config::CreateDynamicFeeConfig,
    ...
    for crate::instructions::create_dynamic_fee_config::CreateDynamicFeeConfig
{
    ...
    fn try_from(source: CreateDynamicFeeConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CreateDynamicFeeConfigRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CreateDynamicFeeConfigRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Lookup for CreateDynamicFeeConfigRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CreateDynamicFeeConfigMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CreateDynamicFeeConfigMigrationOperation {
    async fn up(
        &self,
