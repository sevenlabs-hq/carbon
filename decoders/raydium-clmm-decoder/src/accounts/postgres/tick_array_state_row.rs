...
impl TickArrayStateRow {
    pub fn from_parts(
        source: crate::accounts::tick_array_state::TickArrayState,
...
impl TryFrom<TickArrayStateRow> for crate::accounts::tick_array_state::TickArrayState {
    ...
    fn try_from(source: TickArrayStateRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            initialized_tick_count: source.initialized_tick_count.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
...
impl carbon_core::postgres::operations::Insert for TickArrayStateRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO raydium_clmm_tick_array_state_account (
                "pool_id",
                "start_tick_index",
                "ticks",
                "initialized_tick_count",
        ...
        .bind(&self.ticks)
        .bind(self.initialized_tick_count)
...
impl carbon_core::postgres::operations::Upsert for TickArrayStateRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO raydium_clmm_tick_array_state_account (
                "pool_id",
                "start_tick_index",
                "ticks",
                "initialized_tick_count",
...
impl carbon_core::postgres::operations::Delete for TickArrayStateRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM raydium_clmm_tick_array_state_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for TickArrayStateRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM raydium_clmm_tick_array_state_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for TickArrayStateMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS raydium_clmm_tick_array_state_account (
                -- Account data
                "pool_id" BYTEA NOT NULL,
                "start_tick_index" INT4 NOT NULL,
                "ticks" JSONB NOT NULL,
                "initialized_tick_count" INT2 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS raydium_clmm_tick_array_state_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
