...
impl TickArrayBitmapExtensionRow {
    pub fn from_parts(
        source: crate::accounts::tick_array_bitmap_extension::TickArrayBitmapExtension,
        metadata: AccountMetadata,
    ) -> Self {
        Self {
            account_metadata: metadata.into(),
            pool_id: source.pool_id.into(),
            positive_tick_array_bitmap: sqlx::types::Json(
                source
            ...
            negative_tick_array_bitmap: sqlx::types::Json(
                source
    ...
    for crate::accounts::tick_array_bitmap_extension::TickArrayBitmapExtension
{
    ...
    fn try_from(source: TickArrayBitmapExtensionRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            positive_tick_array_bitmap: source
                .positive_tick_array_bitmap
                .0
                .into_iter()
                .map(|element| {
            ...
            negative_tick_array_bitmap: source
                .negative_tick_array_bitmap
                .0
                .into_iter()
                .map(|element| {
...
impl carbon_core::postgres::operations::Insert for TickArrayBitmapExtensionRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO raydium_clmm_tick_array_bitmap_extension_account (
                "pool_id",
                "positive_tick_array_bitmap",
                "negative_tick_array_bitmap",
                __pubkey, __slot
        ...
        .bind(self.pool_id)
        .bind(&self.positive_tick_array_bitmap)
        .bind(&self.negative_tick_array_bitmap)
...
impl carbon_core::postgres::operations::Upsert for TickArrayBitmapExtensionRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO raydium_clmm_tick_array_bitmap_extension_account (
                "pool_id",
                "positive_tick_array_bitmap",
                "negative_tick_array_bitmap",
                __pubkey, __slot
...
impl carbon_core::postgres::operations::Delete for TickArrayBitmapExtensionRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM raydium_clmm_tick_array_bitmap_extension_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for TickArrayBitmapExtensionRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM raydium_clmm_tick_array_bitmap_extension_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for TickArrayBitmapExtensionMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS raydium_clmm_tick_array_bitmap_extension_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS raydium_clmm_tick_array_bitmap_extension_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
