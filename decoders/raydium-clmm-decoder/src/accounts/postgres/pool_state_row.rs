...
use {
    crate::types::{DynamicFeeInfo, RewardInfo},
    carbon_core::{
...
pub struct PoolStateRow {
    ...
    pub dynamic_fee_info: sqlx::types::Json<DynamicFeeInfo>,
...
impl PoolStateRow {
    pub fn from_parts(
        ...
        Self {
            ...
            dynamic_fee_info: sqlx::types::Json(source.dynamic_fee_info),
            padding1: source
                .padding1
                .into_iter()
                .map(|element| element.into())
...
impl TryFrom<PoolStateRow> for crate::accounts::pool_state::PoolState {
    ...
    fn try_from(source: PoolStateRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            fee_on: source.fee_on.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
            ...
            dynamic_fee_info: source.dynamic_fee_info.0,
            padding1: source
                .padding1
                .into_iter()
                .map(|element| Ok(*element))
...
impl carbon_core::postgres::operations::Upsert for PoolStateRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO pool_state_account (
                ...
                "dynamic_fee_info" = EXCLUDED."dynamic_fee_info",
    ...
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pool_state_account (
                ...
                "dynamic_fee_info" JSONB NOT NULL,
