...
#[graphql(name = "InitiateDlmmFill")]
pub struct InitiateDlmmFillGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitiateDlmmFillRow> for InitiateDlmmFillGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitiateDlmmFillRow,
