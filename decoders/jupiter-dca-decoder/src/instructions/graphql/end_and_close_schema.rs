...
#[graphql(name = "EndAndClose")]
pub struct EndAndCloseGraphQL {
...
impl TryFrom<crate::instructions::postgres::EndAndCloseRow> for EndAndCloseGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::EndAndCloseRow) -> Result<Self, Self::Error> {
        Ok(Self {
