...
#[graphql(name = "InitiateFlashFill")]
pub struct InitiateFlashFillGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitiateFlashFillRow> for InitiateFlashFillGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitiateFlashFillRow,
