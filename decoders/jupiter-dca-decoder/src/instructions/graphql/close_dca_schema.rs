...
#[graphql(name = "CloseDca")]
pub struct CloseDcaGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseDcaRow> for CloseDcaGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseDcaRow) -> Result<Self, Self::Error> {
        Ok(Self {
