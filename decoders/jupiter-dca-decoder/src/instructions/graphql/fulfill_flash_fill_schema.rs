...
#[graphql(name = "FulfillFlashFill")]
pub struct FulfillFlashFillGraphQL {
...
impl TryFrom<crate::instructions::postgres::FulfillFlashFillRow> for FulfillFlashFillGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::FulfillFlashFillRow,
