...
impl InitiateFlashFillRow {
    pub fn from_parts(
        _source: crate::instructions::initiate_flash_fill::InitiateFlashFill,
...
impl TryFrom<InitiateFlashFillRow> for crate::instructions::initiate_flash_fill::InitiateFlashFill {
    type Error = carbon_core::error::Error;
    fn try_from(_source: InitiateFlashFillRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for InitiateFlashFillRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitiateFlashFillRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitiateFlashFillRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitiateFlashFillMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitiateFlashFillMigrationOperation {
    async fn up(
        &self,
