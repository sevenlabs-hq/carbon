...
impl FulfillDlmmFillRow {
    pub fn from_parts(
        source: crate::instructions::fulfill_dlmm_fill::FulfillDlmmFill,
...
impl TryFrom<FulfillDlmmFillRow> for crate::instructions::fulfill_dlmm_fill::FulfillDlmmFill {
    type Error = carbon_core::error::Error;
    fn try_from(source: FulfillDlmmFillRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for FulfillDlmmFillRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for FulfillDlmmFillRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for FulfillDlmmFillRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct FulfillDlmmFillMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for FulfillDlmmFillMigrationOperation {
    async fn up(
        &self,
