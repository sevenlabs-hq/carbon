...
impl EndAndCloseRow {
    pub fn from_parts(
        _source: crate::instructions::end_and_close::EndAndClose,
...
impl TryFrom<EndAndCloseRow> for crate::instructions::end_and_close::EndAndClose {
    type Error = carbon_core::error::Error;
    fn try_from(_source: EndAndCloseRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for EndAndCloseRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for EndAndCloseRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for EndAndCloseRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct EndAndCloseMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for EndAndCloseMigrationOperation {
    async fn up(
        &self,
