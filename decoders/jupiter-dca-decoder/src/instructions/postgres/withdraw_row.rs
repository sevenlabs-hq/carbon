...
impl carbon_core::postgres::operations::Insert for WithdrawRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO jupiter_dca_withdraw_instruction (
                "withdraw_params",
...
impl carbon_core::postgres::operations::Upsert for WithdrawRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO jupiter_dca_withdraw_instruction (
                "withdraw_params",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5, $6
...
impl carbon_core::postgres::operations::Delete for WithdrawRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM jupiter_dca_withdraw_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for WithdrawRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM jupiter_dca_withdraw_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for WithdrawMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS jupiter_dca_withdraw_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS jupiter_dca_withdraw_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
