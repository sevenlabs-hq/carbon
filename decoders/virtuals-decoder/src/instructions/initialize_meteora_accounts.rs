...
#[carbon(discriminator = "0x350c769efdefb9d6")]
...
pub struct InitializeMeteoraAccountsInstructionAccounts {
    ...
    pub meteora_deployer: solana_sdk::pubkey::Pubkey,
    pub meteora_deployer_virtuals_ata: solana_sdk::pubkey::Pubkey,
    pub meteora_deployer_token_ata: solana_sdk::pubkey::Pubkey,
    ...
    pub virtuals_vault: solana_sdk::pubkey::Pubkey,
    pub token_vault: solana_sdk::pubkey::Pubkey,
    pub virtuals_token_vault: solana_sdk::pubkey::Pubkey,
    pub token_token_vault: solana_sdk::pubkey::Pubkey,
    pub virtuals_vault_lp_mint: solana_sdk::pubkey::Pubkey,
    pub token_vault_lp_mint: solana_sdk::pubkey::Pubkey,
    pub virtuals_vault_lp: solana_sdk::pubkey::Pubkey,
    pub token_vault_lp: solana_sdk::pubkey::Pubkey,
    pub pool_virtuals_ata: solana_sdk::pubkey::Pubkey,
    pub pool_token_ata: solana_sdk::pubkey::Pubkey,
    pub meteora_deployer_pool_lp: solana_sdk::pubkey::Pubkey,
    pub protocol_virtuals_fee: solana_sdk::pubkey::Pubkey,
    ...
    pub dynamic_amm_program: solana_sdk::pubkey::Pubkey,
}

impl carbon_core::deserialize::ArrangeAccounts for InitializeMeteoraAccounts {
