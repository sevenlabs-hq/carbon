...
impl BuyRow {
    pub fn from_parts(
        ...
        Self {
            ...
            max_amount_out: source.max_amount_out.into(),
...
impl TryFrom<BuyRow> for crate::instructions::buy::Buy {
    ...
    fn try_from(source: BuyRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            max_amount_out: *source.max_amount_out,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for BuyRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO virtuals_buy_instruction (
                "amount",
                "max_amount_out",
...
impl carbon_core::postgres::operations::Upsert for BuyRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO virtuals_buy_instruction (
                "amount",
                "max_amount_out",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                ...
                "max_amount_out" = EXCLUDED."max_amount_out",
...
impl carbon_core::postgres::operations::Delete for BuyRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM virtuals_buy_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for BuyRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM virtuals_buy_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for BuyMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS virtuals_buy_instruction (
                -- Instruction data
                "amount" NUMERIC(20) NOT NULL,
                "max_amount_out" NUMERIC(20) NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS virtuals_buy_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
