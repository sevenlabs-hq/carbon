...
impl ClaimFeesRow {
    pub fn from_parts(
        _source: crate::instructions::claim_fees::ClaimFees,
...
impl TryFrom<ClaimFeesRow> for crate::instructions::claim_fees::ClaimFees {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ClaimFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ClaimFeesRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ClaimFeesRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ClaimFeesRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ClaimFeesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ClaimFeesMigrationOperation {
    async fn up(
        &self,
