...
#[graphql(name = "ClaimFees")]
pub struct ClaimFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimFeesRow> for ClaimFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ClaimFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {
