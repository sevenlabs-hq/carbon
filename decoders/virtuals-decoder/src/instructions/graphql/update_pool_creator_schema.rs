...
#[graphql(name = "UpdatePoolCreator")]
pub struct UpdatePoolCreatorGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdatePoolCreatorRow> for UpdatePoolCreatorGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdatePoolCreatorRow,
