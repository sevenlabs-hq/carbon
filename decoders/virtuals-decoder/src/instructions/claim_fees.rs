...
pub struct ClaimFeesInstructionAccounts {
    ...
    pub platform: solana_sdk::pubkey::Pubkey,
    pub platform_virtuals_ata: solana_sdk::pubkey::Pubkey,
    pub platform_token_ata: solana_sdk::pubkey::Pubkey,
    pub creator_virtuals_ata: solana_sdk::pubkey::Pubkey,
    pub creator_token_ata: solana_sdk::pubkey::Pubkey,
