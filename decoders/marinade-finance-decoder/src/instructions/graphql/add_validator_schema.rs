...
#[graphql(name = "AddValidator")]
pub struct AddValidatorGraphQL {
...
impl TryFrom<crate::instructions::postgres::AddValidatorRow> for AddValidatorGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AddValidatorRow) -> Result<Self, Self::Error> {
        Ok(Self {
