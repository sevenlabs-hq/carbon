...
#[graphql(name = "UpdateActive")]
pub struct UpdateActiveGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateActiveRow> for UpdateActiveGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::UpdateActiveRow) -> Result<Self, Self::Error> {
        Ok(Self {
