...
#[graphql(name = "CreateCanonicalStake")]
pub struct CreateCanonicalStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateCanonicalStakeRow>
    for CreateCanonicalStakeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateCanonicalStakeRow,
