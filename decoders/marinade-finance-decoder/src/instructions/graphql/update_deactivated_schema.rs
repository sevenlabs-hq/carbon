...
#[graphql(name = "UpdateDeactivated")]
...
impl TryFrom<crate::instructions::postgres::UpdateDeactivatedRow> for UpdateDeactivatedGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateDeactivatedRow,
