...
#[graphql(name = "PartialUnstake")]
pub struct PartialUnstakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::PartialUnstakeRow> for PartialUnstakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PartialUnstakeRow,
        ...
        Ok(Self {
            ...
            desired_unstake_amount: carbon_core::graphql::primitives::U64(
                *row.desired_unstake_amount,
            ),
