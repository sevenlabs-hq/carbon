...
#[graphql(name = "EmergencyUnstake")]
pub struct EmergencyUnstakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::EmergencyUnstakeRow> for EmergencyUnstakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::EmergencyUnstakeRow,
