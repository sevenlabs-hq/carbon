...
impl MergeStakesRow {
    pub fn from_parts(
        source: crate::instructions::merge_stakes::MergeStakes,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            destination_stake_index: source.destination_stake_index.into(),
...
impl TryFrom<MergeStakesRow> for crate::instructions::merge_stakes::MergeStakes {
    type Error = carbon_core::error::Error;
    fn try_from(source: MergeStakesRow) -> Result<Self, Self::Error> {
        Ok(Self {
            destination_stake_index: source.destination_stake_index.try_into().map_err(|_| {
...
impl carbon_core::postgres::operations::Insert for MergeStakesRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(self.destination_stake_index)
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO merge_stakes_instruction (
                ...
                "destination_stake_index" = EXCLUDED."destination_stake_index",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MergeStakesRow {
    type Key = (
        String,
...
pub struct MergeStakesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MergeStakesMigrationOperation {
    async fn up(
        &self,
