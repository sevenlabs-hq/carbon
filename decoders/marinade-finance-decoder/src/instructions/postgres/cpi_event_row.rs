...
impl CpiEventRow {
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                CpiEvent::ChangeAuthorityEvent(_) => "change_authority_event".to_string(),
                CpiEvent::ConfigLpEvent(_) => "config_lp_event".to_string(),
                CpiEvent::ConfigMarinadeEvent(_) => "config_marinade_event".to_string(),
                CpiEvent::InitializeEvent(_) => "initialize_event".to_string(),
                CpiEvent::EmergencyPauseEvent(_) => "emergency_pause_event".to_string(),
                CpiEvent::ResumeEvent(_) => "resume_event".to_string(),
                CpiEvent::ReallocValidatorListEvent(_) => {
                    "realloc_validator_list_event".to_string()
                }
                ...
                CpiEvent::UpdateDeactivatedEvent(_) => "update_deactivated_event".to_string(),
                CpiEvent::ClaimEvent(_) => "claim_event".to_string(),
                CpiEvent::OrderUnstakeEvent(_) => "order_unstake_event".to_string(),
                CpiEvent::AddLiquidityEvent(_) => "add_liquidity_event".to_string(),
                CpiEvent::LiquidUnstakeEvent(_) => "liquid_unstake_event".to_string(),
                CpiEvent::RemoveLiquidityEvent(_) => "remove_liquidity_event".to_string(),
                CpiEvent::AddValidatorEvent(_) => "add_validator_event".to_string(),
                CpiEvent::RemoveValidatorEvent(_) => "remove_validator_event".to_string(),
                CpiEvent::SetValidatorScoreEvent(_) => "set_validator_score_event".to_string(),
                CpiEvent::DepositStakeAccountEvent(_) => "deposit_stake_account_event".to_string(),
                CpiEvent::DepositEvent(_) => "deposit_event".to_string(),
                CpiEvent::WithdrawStakeAccountEvent(_) => {
                    "withdraw_stake_account_event".to_string()
                }
            },
