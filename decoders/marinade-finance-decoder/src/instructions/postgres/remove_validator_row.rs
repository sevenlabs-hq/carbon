...
impl RemoveValidatorRow {
    pub fn from_parts(
        source: crate::instructions::remove_validator::RemoveValidator,
...
impl TryFrom<RemoveValidatorRow> for crate::instructions::remove_validator::RemoveValidator {
    type Error = carbon_core::error::Error;
    fn try_from(source: RemoveValidatorRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for RemoveValidatorRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RemoveValidatorRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for RemoveValidatorRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct RemoveValidatorMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RemoveValidatorMigrationOperation {
    async fn up(
        &self,
