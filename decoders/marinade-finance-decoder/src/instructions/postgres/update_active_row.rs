...
impl UpdateActiveRow {
    pub fn from_parts(
        source: crate::instructions::update_active::UpdateActive,
...
impl TryFrom<UpdateActiveRow> for crate::instructions::update_active::UpdateActive {
    type Error = carbon_core::error::Error;
    fn try_from(source: UpdateActiveRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdateActiveRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateActiveRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateActiveRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateActiveMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateActiveMigrationOperation {
    async fn up(
        &self,
