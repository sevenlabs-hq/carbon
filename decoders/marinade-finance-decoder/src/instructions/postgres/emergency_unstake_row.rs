...
impl EmergencyUnstakeRow {
    pub fn from_parts(
        source: crate::instructions::emergency_unstake::EmergencyUnstake,
...
impl TryFrom<EmergencyUnstakeRow> for crate::instructions::emergency_unstake::EmergencyUnstake {
    type Error = carbon_core::error::Error;
    fn try_from(source: EmergencyUnstakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for EmergencyUnstakeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for EmergencyUnstakeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for EmergencyUnstakeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct EmergencyUnstakeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for EmergencyUnstakeMigrationOperation {
    async fn up(
        &self,
