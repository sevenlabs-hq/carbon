...
use {
    crate::types::ZapInForMeteoraUninitializedParams,
    carbon_core::{account_utils::next_account, borsh, deserialize::ArrangeAccounts},
};

#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Debug, Clone, borsh::BorshSerialize, borsh::BorshDeserialize, PartialEq)]
pub struct ZapInForMeteoraUninitialized {
    pub params: ZapInForMeteoraUninitializedParams,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ZapInForMeteoraUninitializedInstructionAccounts {
...
impl ZapInForMeteoraUninitialized {
    pub fn decode(data: &[u8]) -> Option<Self> {
        if data.len() < 8 {
            return None;
        }
        let discriminator = &data[0..8];
        if discriminator != &[95, 77, 166, 222, 114, 215, 39, 244] {
            return None;
        }
...
impl ArrangeAccounts for ZapInForMeteoraUninitialized {
    type ArrangedAccounts = ZapInForMeteoraUninitializedInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ZapInForMeteoraUninitializedInstructionAccounts {
            ledger,
            user_token_x,
            user_token_y,
            reserve_x,
