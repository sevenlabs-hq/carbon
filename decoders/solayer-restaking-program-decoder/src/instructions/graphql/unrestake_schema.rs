...
#[graphql(name = "Unrestake")]
pub struct UnrestakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::UnrestakeRow> for UnrestakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::UnrestakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
