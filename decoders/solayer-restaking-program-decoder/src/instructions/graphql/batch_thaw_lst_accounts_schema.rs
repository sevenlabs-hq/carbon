...
#[graphql(name = "BatchThawLstAccounts")]
pub struct BatchThawLstAccountsGraphQL {
...
impl TryFrom<crate::instructions::postgres::BatchThawLstAccountsRow>
    for BatchThawLstAccountsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::BatchThawLstAccountsRow,
