...
#[graphql(name = "Restake")]
pub struct RestakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::RestakeRow> for RestakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RestakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
