...
impl QueryRoot {
    ...
    async fn list_init_token_ledger(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::InitTokenLedgerGraphQL>> {
    ...
    async fn swap_tob_with_receiver_token_ledger(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_swap_tob_with_receiver_token_ledger(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::SwapTobWithReceiverTokenLedgerGraphQL>> {
    ...
    async fn swap_tob_with_token_ledger(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_swap_tob_with_token_ledger(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::SwapTobWithTokenLedgerGraphQL>> {
