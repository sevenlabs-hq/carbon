...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobEnhancedInstructionAccounts {
...
impl CarbonDeserialize for SwapTobEnhanced {
    const DISCRIMINATOR: &'static [u8] = &[190, 156, 169, 176, 149, 154, 161, 108];
...
impl ArrangeAccounts for SwapTobEnhanced {
    type ArrangedAccounts = SwapTobEnhancedInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobEnhancedInstructionAccounts {
            payer,
