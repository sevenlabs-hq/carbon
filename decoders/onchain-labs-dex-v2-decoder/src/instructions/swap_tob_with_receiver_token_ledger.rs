...
pub struct SwapTobWithReceiverTokenLedger {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobWithReceiverTokenLedgerInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for SwapTobWithReceiverTokenLedger {
    const DISCRIMINATOR: &'static [u8] = &[239, 93, 10, 202, 161, 134, 127, 130];
...
impl ArrangeAccounts for SwapTobWithReceiverTokenLedger {
    type ArrangedAccounts = SwapTobWithReceiverTokenLedgerInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobWithReceiverTokenLedgerInstructionAccounts {
            payer,
