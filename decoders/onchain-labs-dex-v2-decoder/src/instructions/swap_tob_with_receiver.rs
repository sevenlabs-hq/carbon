...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobWithReceiverInstructionAccounts {
...
impl CarbonDeserialize for SwapTobWithReceiver {
    const DISCRIMINATOR: &'static [u8] = &[223, 170, 216, 234, 204, 6, 241, 25];
...
impl ArrangeAccounts for SwapTobWithReceiver {
    type ArrangedAccounts = SwapTobWithReceiverInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobWithReceiverInstructionAccounts {
            payer,
