...
pub struct SwapTobWithTokenLedger {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobWithTokenLedgerInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for SwapTobWithTokenLedger {
    const DISCRIMINATOR: &'static [u8] = &[36, 92, 147, 219, 26, 176, 159, 90];
...
impl ArrangeAccounts for SwapTobWithTokenLedger {
    type ArrangedAccounts = SwapTobWithTokenLedgerInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobWithTokenLedgerInstructionAccounts {
            payer,
