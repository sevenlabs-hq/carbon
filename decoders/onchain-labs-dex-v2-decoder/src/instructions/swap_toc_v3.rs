...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTocV3InstructionAccounts {
...
impl CarbonDeserialize for SwapTocV3 {
    const DISCRIMINATOR: &'static [u8] = &[86, 222, 68, 49, 225, 9, 201, 235];
...
impl ArrangeAccounts for SwapTocV3 {
    type ArrangedAccounts = SwapTocV3InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTocV3InstructionAccounts {
            payer,
