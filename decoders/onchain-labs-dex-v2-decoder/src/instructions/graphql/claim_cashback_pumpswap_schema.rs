...
#[graphql(name = "ClaimCashbackPumpswap")]
pub struct ClaimCashbackPumpswapGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimCashbackPumpswapRow>
    for ClaimCashbackPumpswapGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimCashbackPumpswapRow,
