...
pub struct SwapTobWithTokenLedgerV3 {
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobWithTokenLedgerV3InstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for SwapTobWithTokenLedgerV3 {
    const DISCRIMINATOR: &'static [u8] = &[132, 77, 6, 86, 35, 66, 224, 171];
...
impl ArrangeAccounts for SwapTobWithTokenLedgerV3 {
    type ArrangedAccounts = SwapTobWithTokenLedgerV3InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobWithTokenLedgerV3InstructionAccounts {
            payer,
