...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTocInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for SwapToc {
    const DISCRIMINATOR: &'static [u8] = &[187, 201, 212, 51, 16, 155, 236, 60];
...
impl ArrangeAccounts for SwapToc {
    type ArrangedAccounts = SwapTocInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTocInstructionAccounts {
            payer,
