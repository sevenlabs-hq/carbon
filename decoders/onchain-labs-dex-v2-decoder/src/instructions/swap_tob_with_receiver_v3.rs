...
pub struct SwapTobWithReceiverV3 {
    pub args: SwapArgs,
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobWithReceiverV3InstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for SwapTobWithReceiverV3 {
    const DISCRIMINATOR: &'static [u8] = &[26, 190, 234, 223, 241, 5, 177, 189];
...
impl ArrangeAccounts for SwapTobWithReceiverV3 {
    type ArrangedAccounts = SwapTobWithReceiverV3InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobWithReceiverV3InstructionAccounts {
            payer,
