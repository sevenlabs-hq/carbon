...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobV2InstructionAccounts {
...
impl CarbonDeserialize for SwapTobV2 {
    const DISCRIMINATOR: &'static [u8] = &[72, 1, 215, 242, 8, 75, 54, 216];
...
impl ArrangeAccounts for SwapTobV2 {
    type ArrangedAccounts = SwapTobV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobV2InstructionAccounts {
            payer,
