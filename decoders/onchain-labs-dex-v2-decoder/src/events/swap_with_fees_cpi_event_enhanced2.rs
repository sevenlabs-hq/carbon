...
pub struct SwapWithFeesCpiEventEnhanced2Event {
    pub order_id: u64,
...
impl CarbonDeserialize for SwapWithFeesCpiEventEnhanced2Event {
    const DISCRIMINATOR: &'static [u8] = &[84, 79, 219, 247, 218, 156, 219, 177];
