...
#[graphql(name = "EvictSeat")]
pub struct EvictSeatGraphQL {
...
impl TryFrom<crate::instructions::postgres::EvictSeatRow> for EvictSeatGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::EvictSeatRow) -> Result<Self, Self::Error> {
        Ok(Self {
