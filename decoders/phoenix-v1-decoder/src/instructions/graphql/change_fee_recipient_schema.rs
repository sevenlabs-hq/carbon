...
#[graphql(name = "ChangeFeeRecipient")]
pub struct ChangeFeeRecipientGraphQL {
...
impl TryFrom<crate::instructions::postgres::ChangeFeeRecipientRow> for ChangeFeeRecipientGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ChangeFeeRecipientRow,
