...
#[graphql(name = "RequestSeat")]
pub struct RequestSeatGraphQL {
...
impl TryFrom<crate::instructions::postgres::RequestSeatRow> for RequestSeatGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RequestSeatRow) -> Result<Self, Self::Error> {
        Ok(Self {
