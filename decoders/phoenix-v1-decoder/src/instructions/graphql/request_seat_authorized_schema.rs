...
#[graphql(name = "RequestSeatAuthorized")]
pub struct RequestSeatAuthorizedGraphQL {
...
impl TryFrom<crate::instructions::postgres::RequestSeatAuthorizedRow>
    for RequestSeatAuthorizedGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RequestSeatAuthorizedRow,
