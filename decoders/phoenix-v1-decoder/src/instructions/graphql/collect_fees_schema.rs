...
#[graphql(name = "CollectFees")]
pub struct CollectFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectFeesRow> for CollectFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CollectFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {
