...
#[graphql(name = "ClaimAuthority")]
pub struct ClaimAuthorityGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimAuthorityRow> for ClaimAuthorityGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimAuthorityRow,
