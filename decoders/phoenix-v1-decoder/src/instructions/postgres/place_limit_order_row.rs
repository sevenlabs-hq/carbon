...
impl PlaceLimitOrderRow {
    pub fn from_parts(
        source: crate::instructions::place_limit_order::PlaceLimitOrder,
...
impl TryFrom<PlaceLimitOrderRow> for crate::instructions::place_limit_order::PlaceLimitOrder {
    type Error = carbon_core::error::Error;
    fn try_from(source: PlaceLimitOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for PlaceLimitOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for PlaceLimitOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for PlaceLimitOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct PlaceLimitOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for PlaceLimitOrderMigrationOperation {
    async fn up(
        &self,
