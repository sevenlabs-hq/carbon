...
#[graphql(name = "SetDelegate")]
pub struct SetDelegateGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetDelegateRow> for SetDelegateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SetDelegateRow) -> Result<Self, Self::Error> {
        Ok(Self {
