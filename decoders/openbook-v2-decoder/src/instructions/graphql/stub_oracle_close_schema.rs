...
#[graphql(name = "StubOracleClose")]
pub struct StubOracleCloseGraphQL {
...
impl TryFrom<crate::instructions::postgres::StubOracleCloseRow> for StubOracleCloseGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::StubOracleCloseRow,
