...
#[graphql(name = "SettleFunds")]
pub struct SettleFundsGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettleFundsRow> for SettleFundsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SettleFundsRow) -> Result<Self, Self::Error> {
        Ok(Self {
