...
#[graphql(name = "SweepFees")]
pub struct SweepFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::SweepFeesRow> for SweepFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SweepFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {
