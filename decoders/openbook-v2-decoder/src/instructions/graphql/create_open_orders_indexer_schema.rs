...
#[graphql(name = "CreateOpenOrdersIndexer")]
pub struct CreateOpenOrdersIndexerGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateOpenOrdersIndexerRow>
    for CreateOpenOrdersIndexerGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateOpenOrdersIndexerRow,
