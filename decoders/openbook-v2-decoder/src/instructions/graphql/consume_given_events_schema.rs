...
#[graphql(name = "ConsumeGivenEvents")]
pub struct ConsumeGivenEventsGraphQL {
...
impl TryFrom<crate::instructions::postgres::ConsumeGivenEventsRow> for ConsumeGivenEventsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ConsumeGivenEventsRow,
