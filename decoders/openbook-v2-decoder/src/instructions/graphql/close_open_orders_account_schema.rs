...
#[graphql(name = "CloseOpenOrdersAccount")]
pub struct CloseOpenOrdersAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseOpenOrdersAccountRow>
    for CloseOpenOrdersAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseOpenOrdersAccountRow,
