...
#[graphql(name = "CloseMarket")]
pub struct CloseMarketGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseMarketRow> for CloseMarketGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseMarketRow) -> Result<Self, Self::Error> {
        Ok(Self {
