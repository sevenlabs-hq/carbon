...
#[graphql(name = "CreateOpenOrdersAccount")]
pub struct CreateOpenOrdersAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateOpenOrdersAccountRow>
    for CreateOpenOrdersAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateOpenOrdersAccountRow,
