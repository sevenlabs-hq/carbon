...
#[graphql(name = "StubOracleCreate")]
pub struct StubOracleCreateGraphQL {
...
impl TryFrom<crate::instructions::postgres::StubOracleCreateRow> for StubOracleCreateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::StubOracleCreateRow,
