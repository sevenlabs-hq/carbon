...
#[graphql(name = "SettleFundsExpired")]
pub struct SettleFundsExpiredGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettleFundsExpiredRow> for SettleFundsExpiredGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SettleFundsExpiredRow,
