...
pub struct EditOrderRow {
    ...
    pub place_order: sqlx::types::Json<PlaceOrderArgs>,
...
impl EditOrderRow {
    pub fn from_parts(
        source: crate::instructions::edit_order::EditOrder,
...
impl TryFrom<EditOrderRow> for crate::instructions::edit_order::EditOrder {
    type Error = carbon_core::error::Error;
    fn try_from(source: EditOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for EditOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for EditOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for EditOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct EditOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for EditOrderMigrationOperation {
    async fn up(
        &self,
