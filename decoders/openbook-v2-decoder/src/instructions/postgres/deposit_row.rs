...
impl carbon_core::postgres::operations::Insert for DepositRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO openbook_v2_deposit_instruction (
                "base_amount",
                "quote_amount",
...
impl carbon_core::postgres::operations::Upsert for DepositRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO openbook_v2_deposit_instruction (
                "base_amount",
                "quote_amount",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
...
impl carbon_core::postgres::operations::Delete for DepositRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM openbook_v2_deposit_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for DepositRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM openbook_v2_deposit_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for DepositMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS openbook_v2_deposit_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS openbook_v2_deposit_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
