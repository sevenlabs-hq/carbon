...
impl SettleFundsExpiredRow {
    pub fn from_parts(
        _source: crate::instructions::settle_funds_expired::SettleFundsExpired,
    ...
    for crate::instructions::settle_funds_expired::SettleFundsExpired
{
    ...
    fn try_from(_source: SettleFundsExpiredRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SettleFundsExpiredRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SettleFundsExpiredRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SettleFundsExpiredRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SettleFundsExpiredMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SettleFundsExpiredMigrationOperation {
    async fn up(
        &self,
