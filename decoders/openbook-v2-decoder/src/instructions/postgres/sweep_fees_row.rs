...
impl SweepFeesRow {
    pub fn from_parts(
        _source: crate::instructions::sweep_fees::SweepFees,
...
impl TryFrom<SweepFeesRow> for crate::instructions::sweep_fees::SweepFees {
    type Error = carbon_core::error::Error;
    fn try_from(_source: SweepFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SweepFeesRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SweepFeesRow {
    type Key = (
        String,
...
pub struct SweepFeesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SweepFeesMigrationOperation {
    async fn up(
        &self,
