...
impl SetDelegateRow {
    pub fn from_parts(
        _source: crate::instructions::set_delegate::SetDelegate,
...
impl TryFrom<SetDelegateRow> for crate::instructions::set_delegate::SetDelegate {
    type Error = carbon_core::error::Error;
    fn try_from(_source: SetDelegateRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SetDelegateRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetDelegateRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetDelegateRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetDelegateMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetDelegateMigrationOperation {
    async fn up(
        &self,
