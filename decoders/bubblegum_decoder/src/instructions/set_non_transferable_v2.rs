...
#[carbon(discriminator = "0xb58dce3af2c798a8")]
...
pub struct SetNonTransferableV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for SetNonTransferableV2 {
    type ArrangedAccounts = SetNonTransferableV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SetNonTransferableV2InstructionAccounts {
