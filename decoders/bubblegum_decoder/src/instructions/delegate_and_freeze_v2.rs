...
#[carbon(discriminator = "0x11e523dabef1fa7b")]
pub struct DelegateAndFreezeV2 {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
pub struct DelegateAndFreezeV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for DelegateAndFreezeV2 {
    type ArrangedAccounts = DelegateAndFreezeV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(DelegateAndFreezeV2InstructionAccounts {
