...
#[carbon(discriminator = "0x3b386f2b5f0e0b3d")]
pub struct UpdateAssetDataV2 {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
    pub creator_hash: [u8; 32],
    pub previous_asset_data_hash: Option<[u8; 32]>,
    pub flags: Option<u8>,
    pub nonce: u64,
    pub index: u32,
    pub new_asset_data: Option<Vec<u8>>,
    pub new_asset_data_schema: Option<AssetDataSchema>,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct UpdateAssetDataV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for UpdateAssetDataV2 {
    type ArrangedAccounts = UpdateAssetDataV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(UpdateAssetDataV2InstructionAccounts {
