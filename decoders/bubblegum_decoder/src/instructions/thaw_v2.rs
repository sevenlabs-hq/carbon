...
#[carbon(discriminator = "0x6085655d52dc92bf")]
pub struct ThawV2 {
    pub root: [u8; 32],
    pub data_hash: [u8; 32],
...
pub struct ThawV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for ThawV2 {
    type ArrangedAccounts = ThawV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ThawV2InstructionAccounts {
