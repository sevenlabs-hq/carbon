...
#[carbon(discriminator = "0x558a8c2a16f17666")]
...
pub struct VerifyCreatorV2InstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for VerifyCreatorV2 {
    type ArrangedAccounts = VerifyCreatorV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(VerifyCreatorV2InstructionAccounts {
