...
#[graphql(name = "CancelExpiredOrder")]
pub struct CancelExpiredOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::CancelExpiredOrderRow> for CancelExpiredOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CancelExpiredOrderRow,
