...
impl InitFeeRow {
    pub fn from_parts(
        source: crate::instructions::init_fee::InitFee,
...
impl TryFrom<InitFeeRow> for crate::instructions::init_fee::InitFee {
    type Error = carbon_core::error::Error;
    fn try_from(source: InitFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitFeeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitFeeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitFeeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitFeeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitFeeMigrationOperation {
    async fn up(
        &self,
