...
#[graphql(name = "DeprecatedSignV1")]
pub struct DeprecatedSignV1GraphQL {
...
impl TryFrom<crate::instructions::postgres::DeprecatedSignV1Row> for DeprecatedSignV1GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeprecatedSignV1Row,
