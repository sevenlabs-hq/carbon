...
#[graphql(name = "CloseTokenAccountV1")]
pub struct CloseTokenAccountV1GraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseTokenAccountV1Row> for CloseTokenAccountV1GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseTokenAccountV1Row,
