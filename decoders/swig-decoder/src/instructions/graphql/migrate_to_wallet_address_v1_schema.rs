...
impl TryFrom<crate::instructions::postgres::MigrateToWalletAddressV1Row>
    for MigrateToWalletAddressV1GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MigrateToWalletAddressV1Row,
