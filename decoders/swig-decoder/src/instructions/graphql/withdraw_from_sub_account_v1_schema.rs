...
impl TryFrom<crate::instructions::postgres::WithdrawFromSubAccountV1Row>
    for WithdrawFromSubAccountV1GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawFromSubAccountV1Row,
