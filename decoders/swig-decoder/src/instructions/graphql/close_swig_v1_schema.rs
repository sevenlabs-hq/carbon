...
#[graphql(name = "CloseSwigV1")]
pub struct CloseSwigV1GraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseSwigV1Row> for CloseSwigV1GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseSwigV1Row) -> Result<Self, Self::Error> {
        Ok(Self {
