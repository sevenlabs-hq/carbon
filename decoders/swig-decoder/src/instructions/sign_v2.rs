...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SignV2InstructionAccounts {
...
impl CarbonDeserialize for SignV2 {
...
impl ArrangeAccounts for SignV2 {
    type ArrangedAccounts = SignV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SignV2InstructionAccounts {
            swig,
            swig_wallet_address,
            system_program,
