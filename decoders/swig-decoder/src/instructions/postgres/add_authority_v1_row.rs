...
use crate::instructions::AddAuthorityV1;
...
impl AddAuthorityV1Row {
    pub fn from_parts(_source: AddAuthorityV1, metadata: InstructionMetadata) -> Self {
        Self {
...
impl TryFrom<AddAuthorityV1Row> for AddAuthorityV1 {
...
impl carbon_core::postgres::operations::Table for AddAuthorityV1 {
    fn table() -> &'static str {
