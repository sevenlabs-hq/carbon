...
impl sqlx_migrator::Migration<sqlx::Postgres> for SwigInstructionsMigration {
    ...
    fn operations(&self) -> Vec<Box<dyn sqlx_migrator::Operation<sqlx::Postgres>>> {
        vec![
            ...
            Box::new(CloseSwigV1MigrationOperation),
            Box::new(CloseTokenAccountV1MigrationOperation),
            Box::new(CreateSessionV1MigrationOperation),
            Box::new(CreateSubAccountV1MigrationOperation),
            Box::new(CreateV1MigrationOperation),
            Box::new(DeprecatedSignV1MigrationOperation),
...
impl carbon_core::postgres::operations::Insert for SwigInstructionWithMetadata {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        match decoded_instruction {
            ...
            SwigInstruction::DeprecatedSignV1 { data, .. } => {
                let row = deprecated_sign_v1_row::DeprecatedSignV1Row::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
            ...
            SwigInstruction::CloseTokenAccountV1 { data, .. } => {
                let row = close_token_account_v1_row::CloseTokenAccountV1Row::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
            ...
            SwigInstruction::CloseSwigV1 { data, .. } => {
                let row = close_swig_v1_row::CloseSwigV1Row::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
