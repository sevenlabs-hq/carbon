...
#[graphql(name = "IsNonceUsed")]
pub struct IsNonceUsedGraphQL {
...
impl TryFrom<crate::instructions::postgres::IsNonceUsedRow> for IsNonceUsedGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::IsNonceUsedRow) -> Result<Self, Self::Error> {
        Ok(Self {
