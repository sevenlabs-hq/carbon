...
use {
    crate::types::EnableAttesterParams,
...
pub struct EnableAttesterRow {
    ...
    pub params: sqlx::types::Json<EnableAttesterParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl EnableAttesterRow {
    pub fn from_parts(
        source: crate::instructions::enable_attester::EnableAttester,
...
impl TryFrom<EnableAttesterRow> for crate::instructions::enable_attester::EnableAttester {
    type Error = carbon_core::error::Error;
    fn try_from(source: EnableAttesterRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for EnableAttesterRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for EnableAttesterRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for EnableAttesterRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct EnableAttesterMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for EnableAttesterMigrationOperation {
    async fn up(
        &self,
