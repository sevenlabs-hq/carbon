...
pub struct SendMessageRow {
    ...
    pub params: sqlx::types::Json<SendMessageParams>,
...
impl SendMessageRow {
    pub fn from_parts(
        source: crate::instructions::send_message::SendMessage,
...
impl TryFrom<SendMessageRow> for crate::instructions::send_message::SendMessage {
    type Error = carbon_core::error::Error;
    fn try_from(source: SendMessageRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SendMessageRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SendMessageRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SendMessageRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SendMessageMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SendMessageMigrationOperation {
    async fn up(
        &self,
