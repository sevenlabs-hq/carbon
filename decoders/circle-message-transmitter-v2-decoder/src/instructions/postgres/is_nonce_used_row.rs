...
impl IsNonceUsedRow {
    pub fn from_parts(
        _source: crate::instructions::is_nonce_used::IsNonceUsed,
...
impl TryFrom<IsNonceUsedRow> for crate::instructions::is_nonce_used::IsNonceUsed {
    type Error = carbon_core::error::Error;
    fn try_from(_source: IsNonceUsedRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for IsNonceUsedRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for IsNonceUsedRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for IsNonceUsedRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct IsNonceUsedMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for IsNonceUsedMigrationOperation {
    async fn up(
        &self,
