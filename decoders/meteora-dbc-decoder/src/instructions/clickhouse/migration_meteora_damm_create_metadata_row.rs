...
pub struct MigrationMeteoraDammCreateMetadataRow {
...
impl
    TryFrom<(
        crate::instructions::migration_meteora_damm_create_metadata::MigrationMeteoraDammCreateMetadata,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::migration_meteora_damm_create_metadata::MigrationMeteoraDammCreateMetadataInstructionAccounts,
    )> for MigrationMeteoraDammCreateMetadataRow
{
...
impl carbon_core::clickhouse::ClusterTable for MigrationMeteoraDammCreateMetadataRow {
    fn local_table() -> &'static str {
        "meteora_dbc_migration_meteora_damm_create_metadata_instruction_local"
    }
...
impl carbon_core::clickhouse::Table for MigrationMeteoraDammCreateMetadataRow {
    fn table() -> &'static str {
        "meteora_dbc_migration_meteora_damm_create_metadata_instruction"
    }
}
...
pub struct MigrationMeteoraDammCreateMetadataRowMigrationOperation;
    ...
    for MigrationMeteoraDammCreateMetadataRowMigrationOperation
{
    async fn up(
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/meteora_dbc_migration_meteora_damm_create_metadata_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS meteora_dbc_migration_meteora_damm_create_metadata_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS meteora_dbc_migration_meteora_damm_create_metadata_instruction ON CLUSTER {cluster} AS meteora_dbc_migration_meteora_damm_create_metadata_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), meteora_dbc_migration_meteora_damm_create_metadata_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS meteora_dbc_migration_meteora_damm_create_metadata_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS meteora_dbc_migration_meteora_damm_create_metadata_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
    ...
    for MigrationMeteoraDammCreateMetadataRowMigrationOperation
{
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS meteora_dbc_migration_meteora_damm_create_metadata_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS meteora_dbc_migration_meteora_damm_create_metadata_instruction")
            .execute()
            .await?;
