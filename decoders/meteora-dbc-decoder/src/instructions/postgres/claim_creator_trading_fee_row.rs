...
impl ClaimCreatorTradingFeeRow {
    pub fn from_parts(
        source: crate::instructions::claim_creator_trading_fee::ClaimCreatorTradingFee,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            max_base_amount: source.max_base_amount.into(),
            max_quote_amount: source.max_quote_amount.into(),
    ...
    for crate::instructions::claim_creator_trading_fee::ClaimCreatorTradingFee
{
    ...
    fn try_from(source: ClaimCreatorTradingFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
            max_base_amount: *source.max_base_amount,
            max_quote_amount: *source.max_quote_amount,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for ClaimCreatorTradingFeeRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(&self.max_base_amount)
        .bind(&self.max_quote_amount)
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO claim_creator_trading_fee_instruction (
                ...
                "max_base_amount" = EXCLUDED."max_base_amount",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ClaimCreatorTradingFeeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ClaimCreatorTradingFeeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ClaimCreatorTradingFeeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ClaimCreatorTradingFeeMigrationOperation {
    async fn up(
        &self,
