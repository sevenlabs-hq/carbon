...
impl MigrationMeteoraDammCreateMetadataRow {
    pub fn from_parts(
        _source: crate::instructions::migration_meteora_damm_create_metadata::MigrationMeteoraDammCreateMetadata,
...
impl TryFrom<MigrationMeteoraDammCreateMetadataRow> for crate::instructions::migration_meteora_damm_create_metadata::MigrationMeteoraDammCreateMetadata {
    type Error = carbon_core::error::Error;
    fn try_from(_source: MigrationMeteoraDammCreateMetadataRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrationMeteoraDammCreateMetadataRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrationMeteoraDammCreateMetadataRow {
    type Key = (
        String,
...
pub struct MigrationMeteoraDammCreateMetadataMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for MigrationMeteoraDammCreateMetadataMigrationOperation
{
    async fn up(
        &self,
