...
impl InitializeVirtualPoolWithToken2022Row {
    pub fn from_parts(
        source: crate::instructions::initialize_virtual_pool_with_token2022::InitializeVirtualPoolWithToken2022,
...
impl TryFrom<InitializeVirtualPoolWithToken2022Row> for crate::instructions::initialize_virtual_pool_with_token2022::InitializeVirtualPoolWithToken2022 {
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializeVirtualPoolWithToken2022Row) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializeVirtualPoolWithToken2022Row {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeVirtualPoolWithToken2022Row {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeVirtualPoolWithToken2022Row {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeVirtualPoolWithToken2022MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeVirtualPoolWithToken2022MigrationOperation
{
    async fn up(
        &self,
