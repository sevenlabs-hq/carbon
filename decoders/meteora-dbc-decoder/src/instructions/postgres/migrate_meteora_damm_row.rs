...
impl MigrateMeteoraDammRow {
    pub fn from_parts(
        _source: crate::instructions::migrate_meteora_damm::MigrateMeteoraDamm,
    ...
    for crate::instructions::migrate_meteora_damm::MigrateMeteoraDamm
{
    ...
    fn try_from(_source: MigrateMeteoraDammRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrateMeteoraDammRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrateMeteoraDammRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MigrateMeteoraDammRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MigrateMeteoraDammMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MigrateMeteoraDammMigrationOperation {
    async fn up(
        &self,
