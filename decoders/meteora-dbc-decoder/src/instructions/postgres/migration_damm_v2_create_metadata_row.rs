...
impl MigrationDammV2CreateMetadataRow {
    pub fn from_parts(
        _source: crate::instructions::migration_damm_v2_create_metadata::MigrationDammV2CreateMetadata,
...
impl TryFrom<MigrationDammV2CreateMetadataRow>
    for crate::instructions::migration_damm_v2_create_metadata::MigrationDammV2CreateMetadata
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: MigrationDammV2CreateMetadataRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrationDammV2CreateMetadataRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrationDammV2CreateMetadataRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MigrationDammV2CreateMetadataRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MigrationDammV2CreateMetadataMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MigrationDammV2CreateMetadataMigrationOperation {
    async fn up(
        &self,
