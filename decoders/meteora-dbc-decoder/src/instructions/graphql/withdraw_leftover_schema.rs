...
#[graphql(name = "WithdrawLeftover")]
pub struct WithdrawLeftoverGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawLeftoverRow> for WithdrawLeftoverGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawLeftoverRow,
