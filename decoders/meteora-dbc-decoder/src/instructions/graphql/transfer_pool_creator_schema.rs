...
#[graphql(name = "TransferPoolCreator")]
pub struct TransferPoolCreatorGraphQL {
...
impl TryFrom<crate::instructions::postgres::TransferPoolCreatorRow> for TransferPoolCreatorGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TransferPoolCreatorRow,
