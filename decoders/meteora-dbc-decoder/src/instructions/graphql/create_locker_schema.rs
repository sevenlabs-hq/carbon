...
#[graphql(name = "CreateLocker")]
pub struct CreateLockerGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateLockerRow> for CreateLockerGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CreateLockerRow) -> Result<Self, Self::Error> {
        Ok(Self {
