...
#[graphql(name = "MigrateMeteoraDamm")]
pub struct MigrateMeteoraDammGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateMeteoraDammRow> for MigrateMeteoraDammGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MigrateMeteoraDammRow,
