...
#[graphql(name = "PartnerWithdrawSurplus")]
pub struct PartnerWithdrawSurplusGraphQL {
...
impl TryFrom<crate::instructions::postgres::PartnerWithdrawSurplusRow>
    for PartnerWithdrawSurplusGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PartnerWithdrawSurplusRow,
