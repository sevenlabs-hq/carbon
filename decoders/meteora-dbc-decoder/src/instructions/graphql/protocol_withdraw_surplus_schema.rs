...
#[graphql(name = "ProtocolWithdrawSurplus")]
pub struct ProtocolWithdrawSurplusGraphQL {
...
impl TryFrom<crate::instructions::postgres::ProtocolWithdrawSurplusRow>
    for ProtocolWithdrawSurplusGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ProtocolWithdrawSurplusRow,
