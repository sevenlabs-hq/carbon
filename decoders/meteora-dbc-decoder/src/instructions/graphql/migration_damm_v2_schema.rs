...
#[graphql(name = "MigrationDammV2")]
pub struct MigrationDammV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrationDammV2Row> for MigrationDammV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MigrationDammV2Row,
