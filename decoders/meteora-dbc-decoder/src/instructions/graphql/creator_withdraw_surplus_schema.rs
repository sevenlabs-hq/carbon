...
#[graphql(name = "CreatorWithdrawSurplus")]
pub struct CreatorWithdrawSurplusGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreatorWithdrawSurplusRow>
    for CreatorWithdrawSurplusGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreatorWithdrawSurplusRow,
