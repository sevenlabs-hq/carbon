...
impl carbon_core::postgres::operations::Insert for LockEscrowRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO meteora_dbc_lock_escrow_account (
                "pool",
                "owner",
                "escrow_vault",
                "bump",
...
impl carbon_core::postgres::operations::Upsert for LockEscrowRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO meteora_dbc_lock_escrow_account (
                "pool",
                "owner",
                "escrow_vault",
                "bump",
...
impl carbon_core::postgres::operations::Delete for LockEscrowRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM meteora_dbc_lock_escrow_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for LockEscrowRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM meteora_dbc_lock_escrow_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for LockEscrowMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS meteora_dbc_lock_escrow_account (
                -- Account data
                "pool" BYTEA NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS meteora_dbc_lock_escrow_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
