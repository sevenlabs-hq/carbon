...
impl<'a> carbon_core::account::AccountDecoder<'a> for PumpDecoder {
    ...
    fn decode_account(
        ...
        
        {
            if let Some(decoded) = bonding_curve::BondingCurve::decode(data) {
                return Some(carbon_core::account::DecodedAccount {
                    ...
                    data: PumpAccount::BondingCurve(Box::new(decoded)),
                    owner: account.owner,
        ...
        }
        {
            if let Some(decoded) = fee_config::FeeConfig::decode(data) {
                return Some(carbon_core::account::DecodedAccount {
                    lamports: account.lamports,
                    data: PumpAccount::FeeConfig(Box::new(decoded)),
                    owner: account.owner,
                    executable: account.executable,
                    rent_epoch: account.rent_epoch,
                });
        ...
        }
        {
            if let Some(decoded) = global::Global::decode(data) {
                return Some(carbon_core::account::DecodedAccount {
                    lamports: account.lamports,
                    data: PumpAccount::Global(Box::new(decoded)),
                    owner: account.owner,
                    executable: account.executable,
                    rent_epoch: account.rent_epoch,
                });
        ...
        }
        {
            if let Some(decoded) = global_volume_accumulator::GlobalVolumeAccumulator::decode(data) {
                return Some(carbon_core::account::DecodedAccount {
                    lamports: account.lamports,
                    data: PumpAccount::GlobalVolumeAccumulator(Box::new(decoded)),
                    owner: account.owner,
                    executable: account.executable,
                    rent_epoch: account.rent_epoch,
                });
        ...
        }
        {
            if let Some(decoded) = sharing_config::SharingConfig::decode(data) {
                return Some(carbon_core::account::DecodedAccount {
                    lamports: account.lamports,
                    data: PumpAccount::SharingConfig(Box::new(decoded)),
                    owner: account.owner,
                    executable: account.executable,
                    rent_epoch: account.rent_epoch,
                });
        ...
        }
        {
            if let Some(decoded) = user_volume_accumulator::UserVolumeAccumulator::decode(data) {
                return Some(carbon_core::account::DecodedAccount {
                    lamports: account.lamports,
                    data: PumpAccount::UserVolumeAccumulator(Box::new(decoded)),
                    owner: account.owner,
                    executable: account.executable,
                    rent_epoch: account.rent_epoch,
                });
