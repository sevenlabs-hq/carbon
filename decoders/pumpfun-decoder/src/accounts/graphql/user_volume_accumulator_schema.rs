...
impl TryFrom<crate::accounts::postgres::UserVolumeAccumulatorRow> for UserVolumeAccumulatorGraphQL {
    ...
    fn try_from(row: crate::accounts::postgres::UserVolumeAccumulatorRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            total_cashback_claimed: carbon_core::graphql::primitives::U64(*row.total_cashback_claimed),
        })
    }
}
