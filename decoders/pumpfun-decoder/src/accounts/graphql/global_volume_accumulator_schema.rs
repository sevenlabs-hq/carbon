...
impl TryFrom<crate::accounts::postgres::GlobalVolumeAccumulatorRow> for GlobalVolumeAccumulatorGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::accounts::postgres::GlobalVolumeAccumulatorRow) -> Result<Self, Self::Error> {
        Ok(Self {
