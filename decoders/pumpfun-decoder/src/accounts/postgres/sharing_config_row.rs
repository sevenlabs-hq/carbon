...
impl SharingConfigRow {
    pub fn from_parts(source: crate::accounts::sharing_config::SharingConfig, metadata: AccountMetadata) -> Self {
        Self {
            ...
            admin_revoked: source.admin_revoked.into(),
...
impl carbon_core::postgres::operations::Upsert for SharingConfigRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO sharing_config_account (
                "bump",
                "version",
                "status",
                "mint",
...
impl carbon_core::postgres::operations::Delete for SharingConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"DELETE FROM sharing_config_account WHERE
                __pubkey = $1
            "#)
        .bind(key)
        .execute(pool).await
...
impl carbon_core::postgres::operations::LookUp for SharingConfigRow {
    ...
    async fn lookup(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<Option<Self>> {
        let row = sqlx::query_as(r#"SELECT * FROM sharing_config_account WHERE
                __pubkey = $1
            "#)
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for SharingConfigMigrationOperation {
    async fn up(&self, connection: &mut sqlx::PgConnection) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(r#"CREATE TABLE IF NOT EXISTS sharing_config_account (
                -- Account data
                "bump" INT2 NOT NULL,
    ...
    async fn down(&self, connection: &mut sqlx::PgConnection) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(r#"DROP TABLE IF EXISTS sharing_config_account"#).execute(connection).await?;
        Ok(())
    }
}
