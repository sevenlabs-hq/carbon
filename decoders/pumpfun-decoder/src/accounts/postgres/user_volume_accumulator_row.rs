...
impl carbon_core::postgres::operations::Insert for UserVolumeAccumulatorRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pumpfun_user_volume_accumulator_account (
                "user",
                "needs_claim",
                "total_unclaimed_tokens",
                "total_claimed_tokens",
...
impl carbon_core::postgres::operations::Upsert for UserVolumeAccumulatorRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pumpfun_user_volume_accumulator_account (
                "user",
                "needs_claim",
                "total_unclaimed_tokens",
                "total_claimed_tokens",
...
impl carbon_core::postgres::operations::Delete for UserVolumeAccumulatorRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pumpfun_user_volume_accumulator_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for UserVolumeAccumulatorRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pumpfun_user_volume_accumulator_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for UserVolumeAccumulatorMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pumpfun_user_volume_accumulator_account (
                -- Account data
                "user" BYTEA NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pumpfun_user_volume_accumulator_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
