...
impl carbon_core::postgres::operations::Insert for ClaimTokenIncentivesRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pumpfun_claim_token_incentives_instruction (
...
impl carbon_core::postgres::operations::Upsert for ClaimTokenIncentivesRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pumpfun_claim_token_incentives_instruction (
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5
            ) ON CONFLICT (
...
impl carbon_core::postgres::operations::Delete for ClaimTokenIncentivesRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pumpfun_claim_token_incentives_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for ClaimTokenIncentivesRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pumpfun_claim_token_incentives_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for ClaimTokenIncentivesMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pumpfun_claim_token_incentives_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pumpfun_claim_token_incentives_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
