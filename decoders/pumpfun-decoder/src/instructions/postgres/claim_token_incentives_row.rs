...
impl ClaimTokenIncentivesRow {
    pub fn from_parts(_source: crate::instructions::claim_token_incentives::ClaimTokenIncentives, metadata: InstructionMetadata) -> Self {
        Self {
...
impl TryFrom<ClaimTokenIncentivesRow> for crate::instructions::claim_token_incentives::ClaimTokenIncentives {
...
impl carbon_core::postgres::operations::Table for crate::instructions::claim_token_incentives::ClaimTokenIncentives {
    fn table() -> &'static str {
