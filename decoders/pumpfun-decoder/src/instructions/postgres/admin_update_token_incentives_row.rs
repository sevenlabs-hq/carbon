...
impl carbon_core::postgres::operations::Insert for AdminUpdateTokenIncentivesRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pumpfun_admin_update_token_incentives_instruction (
                "start_time",
                "end_time",
                "seconds_in_a_day",
                "day_number",
...
impl carbon_core::postgres::operations::Upsert for AdminUpdateTokenIncentivesRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pumpfun_admin_update_token_incentives_instruction (
                "start_time",
                "end_time",
                "seconds_in_a_day",
                "day_number",
...
impl carbon_core::postgres::operations::Delete for AdminUpdateTokenIncentivesRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pumpfun_admin_update_token_incentives_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for AdminUpdateTokenIncentivesRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pumpfun_admin_update_token_incentives_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for AdminUpdateTokenIncentivesMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pumpfun_admin_update_token_incentives_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pumpfun_admin_update_token_incentives_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
