...
impl carbon_core::postgres::operations::Insert for SetReservedFeeRecipientsRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pumpfun_set_reserved_fee_recipients_instruction (
                "whitelist_pda",
...
impl carbon_core::postgres::operations::Upsert for SetReservedFeeRecipientsRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pumpfun_set_reserved_fee_recipients_instruction (
                "whitelist_pda",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5, $6
...
impl carbon_core::postgres::operations::Delete for SetReservedFeeRecipientsRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pumpfun_set_reserved_fee_recipients_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for SetReservedFeeRecipientsRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pumpfun_set_reserved_fee_recipients_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for SetReservedFeeRecipientsMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pumpfun_set_reserved_fee_recipients_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pumpfun_set_reserved_fee_recipients_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
