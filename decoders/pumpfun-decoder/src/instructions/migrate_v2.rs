...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct MigrateV2InstructionAccounts {
    #[cfg_attr(
        feature = "base58",
    ...
    pub pool_authority_quote_account: solana_pubkey::Pubkey,
    #[cfg_attr(
        feature = "base58",
        serde(serialize_with = "carbon_core::convert::base58::serialize")
    )]
...
impl CarbonDeserialize for MigrateV2 {
    const DISCRIMINATOR: &'static [u8] = &[187, 203, 18, 31, 206, 237, 254, 41];
...
impl ArrangeAccounts for MigrateV2 {
    type ArrangedAccounts = MigrateV2InstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        let pool_authority_quote_account = next_account(&mut iter)?;
        ...
        Some(MigrateV2InstructionAccounts {
            global,
            withdraw_authority,
            base_mint,
            quote_mint,
