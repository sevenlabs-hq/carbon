...
#[graphql(name = "UpdateGlobalAuthority")]
pub struct UpdateGlobalAuthorityGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateGlobalAuthorityRow>
    for UpdateGlobalAuthorityGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateGlobalAuthorityRow,
