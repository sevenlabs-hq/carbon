...
#[graphql(name = "CollectCreatorFeeV2")]
pub struct CollectCreatorFeeV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectCreatorFeeV2Row> for CollectCreatorFeeV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectCreatorFeeV2Row,
