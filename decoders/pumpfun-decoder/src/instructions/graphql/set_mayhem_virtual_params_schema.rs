...
#[graphql(name = "SetMayhemVirtualParams")]
pub struct SetMayhemVirtualParamsGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetMayhemVirtualParamsRow>
    for SetMayhemVirtualParamsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetMayhemVirtualParamsRow,
