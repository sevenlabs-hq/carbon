...
#[graphql(name = "SetMetaplexCreator")]
pub struct SetMetaplexCreatorGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetMetaplexCreatorRow> for SetMetaplexCreatorGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetMetaplexCreatorRow,
