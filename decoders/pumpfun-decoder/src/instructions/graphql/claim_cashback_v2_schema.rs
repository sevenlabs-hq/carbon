...
#[graphql(name = "ClaimCashbackV2")]
pub struct ClaimCashbackV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimCashbackV2Row> for ClaimCashbackV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimCashbackV2Row,
