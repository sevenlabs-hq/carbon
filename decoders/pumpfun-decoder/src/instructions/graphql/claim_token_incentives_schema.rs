...
#[graphql(name = "ClaimTokenIncentives")]
pub struct ClaimTokenIncentivesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimTokenIncentivesRow>
    for ClaimTokenIncentivesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimTokenIncentivesRow,
