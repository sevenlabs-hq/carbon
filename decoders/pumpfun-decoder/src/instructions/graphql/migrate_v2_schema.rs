...
#[graphql(name = "MigrateV2")]
pub struct MigrateV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateV2Row> for MigrateV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::MigrateV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
