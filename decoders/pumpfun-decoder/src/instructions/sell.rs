...
/// For cashback coins, optionally pass user_volume_accumulator as
/// remaining_accounts[0]. If provided and valid, creator_fee goes to
/// user_volume_accumulator. Otherwise, falls back to transferring creator_fee
/// to creator_vault.
