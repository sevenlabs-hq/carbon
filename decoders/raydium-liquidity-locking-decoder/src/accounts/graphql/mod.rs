...
pub mod locked_clmm_position_state_schema;
pub mod locked_cp_liquidity_state_schema;

use juniper::GraphQLObject;
pub use {locked_clmm_position_state_schema::*, locked_cp_liquidity_state_schema::*};
