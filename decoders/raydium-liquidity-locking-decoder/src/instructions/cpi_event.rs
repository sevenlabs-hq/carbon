...
pub enum CpiEvent {
    SettleCpFeeEvent(events::settle_cp_fee_event::SettleCpFeeEventEvent),
}
...
impl CarbonDeserialize for CpiEvent {
    ...
    fn decode(data: &[u8]) -> Option<Self> {
        ...
        if let Some(decoded) =
            events::settle_cp_fee_event::SettleCpFeeEventEvent::decode(event_data)
        {
            return Some(CpiEvent::SettleCpFeeEvent(decoded));
        }
        None
    }
}
