...
impl LockClmmPositionRow {
    pub fn from_parts(
        source: crate::instructions::lock_clmm_position::LockClmmPosition,
...
impl TryFrom<LockClmmPositionRow> for crate::instructions::lock_clmm_position::LockClmmPosition {
    type Error = carbon_core::error::Error;
    fn try_from(source: LockClmmPositionRow) -> Result<Self, Self::Error> {
        Ok(Self {
            with_metadata: source.with_metadata,
        })
    }
...
impl carbon_core::postgres::operations::Insert for LockClmmPositionRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for LockClmmPositionRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for LockClmmPositionRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct LockClmmPositionMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for LockClmmPositionMigrationOperation {
    async fn up(
        &self,
