...
impl CollectClmmFeesAndRewardsRow {
    pub fn from_parts(
        _source: crate::instructions::collect_clmm_fees_and_rewards::CollectClmmFeesAndRewards,
...
impl TryFrom<CollectClmmFeesAndRewardsRow>
    for crate::instructions::collect_clmm_fees_and_rewards::CollectClmmFeesAndRewards
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: CollectClmmFeesAndRewardsRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CollectClmmFeesAndRewardsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CollectClmmFeesAndRewardsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CollectClmmFeesAndRewardsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CollectClmmFeesAndRewardsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectClmmFeesAndRewardsMigrationOperation {
    async fn up(
        &self,
