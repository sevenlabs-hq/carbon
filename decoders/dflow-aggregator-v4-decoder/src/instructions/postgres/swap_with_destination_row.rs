...
impl SwapWithDestinationRow {
    pub fn from_parts(
        source: crate::instructions::swap_with_destination::SwapWithDestination,
    ...
    for crate::instructions::swap_with_destination::SwapWithDestination
{
    ...
    fn try_from(source: SwapWithDestinationRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SwapWithDestinationRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SwapWithDestinationRow {
    type Key = (
        String,
...
pub struct SwapWithDestinationMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SwapWithDestinationMigrationOperation {
    async fn up(
        &self,
