...
impl CloseEmptyTokenAccountRow {
    pub fn from_parts(
        _source: crate::instructions::close_empty_token_account::CloseEmptyTokenAccount,
    ...
    for crate::instructions::close_empty_token_account::CloseEmptyTokenAccount
{
    ...
    fn try_from(_source: CloseEmptyTokenAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CloseEmptyTokenAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CloseEmptyTokenAccountRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CloseEmptyTokenAccountRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CloseEmptyTokenAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseEmptyTokenAccountMigrationOperation {
    async fn up(
        &self,
