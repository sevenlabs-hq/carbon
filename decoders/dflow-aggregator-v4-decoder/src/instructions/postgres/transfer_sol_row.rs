...
impl TransferSolRow {
    pub fn from_parts(
        source: crate::instructions::transfer_sol::TransferSol,
...
impl TryFrom<TransferSolRow> for crate::instructions::transfer_sol::TransferSol {
    type Error = carbon_core::error::Error;
    fn try_from(source: TransferSolRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for TransferSolRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TransferSolRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TransferSolRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TransferSolMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TransferSolMigrationOperation {
    async fn up(
        &self,
