...
impl TransferToSponsorRow {
    pub fn from_parts(
        source: crate::instructions::transfer_to_sponsor::TransferToSponsor,
...
impl TryFrom<TransferToSponsorRow> for crate::instructions::transfer_to_sponsor::TransferToSponsor {
    type Error = carbon_core::error::Error;
    fn try_from(source: TransferToSponsorRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for TransferToSponsorRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TransferToSponsorRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TransferToSponsorRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TransferToSponsorMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TransferToSponsorMigrationOperation {
    async fn up(
        &self,
