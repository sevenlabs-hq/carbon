...
#[graphql(name = "CloseEmptyTokenAccount")]
pub struct CloseEmptyTokenAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseEmptyTokenAccountRow>
    for CloseEmptyTokenAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseEmptyTokenAccountRow,
