...
#[graphql(name = "CloseOrder")]
pub struct CloseOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseOrderRow> for CloseOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
