...
#[graphql(name = "UnwrapSol")]
pub struct UnwrapSolGraphQL {
...
impl TryFrom<crate::instructions::postgres::UnwrapSolRow> for UnwrapSolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::UnwrapSolRow) -> Result<Self, Self::Error> {
        Ok(Self {
