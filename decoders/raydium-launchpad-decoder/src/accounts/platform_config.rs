...
use {
    crate::types::PlatformCurveParam, carbon_core::deserialize::CarbonDeserialize,
...
impl CarbonDeserialize for PlatformConfig {
    const DISCRIMINATOR: &'static [u8] = &[160, 78, 128, 0, 248, 83, 230, 160];
