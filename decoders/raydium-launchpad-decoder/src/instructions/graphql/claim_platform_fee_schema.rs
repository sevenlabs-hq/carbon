...
#[graphql(name = "ClaimPlatformFee")]
pub struct ClaimPlatformFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimPlatformFeeRow> for ClaimPlatformFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimPlatformFeeRow,
