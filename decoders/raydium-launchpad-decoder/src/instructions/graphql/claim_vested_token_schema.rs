...
#[graphql(name = "ClaimVestedToken")]
pub struct ClaimVestedTokenGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimVestedTokenRow> for ClaimVestedTokenGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimVestedTokenRow,
