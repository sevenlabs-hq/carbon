...
#[graphql(name = "CollectFee")]
pub struct CollectFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectFeeRow> for CollectFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CollectFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
