...
#[graphql(name = "MigrateToCpswap")]
pub struct MigrateToCpswapGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateToCpswapRow> for MigrateToCpswapGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MigrateToCpswapRow,
