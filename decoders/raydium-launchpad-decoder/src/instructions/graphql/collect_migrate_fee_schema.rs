...
#[graphql(name = "CollectMigrateFee")]
pub struct CollectMigrateFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectMigrateFeeRow> for CollectMigrateFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectMigrateFeeRow,
