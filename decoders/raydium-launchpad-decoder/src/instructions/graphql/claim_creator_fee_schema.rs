...
#[graphql(name = "ClaimCreatorFee")]
pub struct ClaimCreatorFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimCreatorFeeRow> for ClaimCreatorFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimCreatorFeeRow,
