...
#[graphql(name = "BuyExactOut")]
pub struct BuyExactOutGraphQL {
...
impl TryFrom<crate::instructions::postgres::BuyExactOutRow> for BuyExactOutGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::BuyExactOutRow) -> Result<Self, Self::Error> {
        Ok(Self {
