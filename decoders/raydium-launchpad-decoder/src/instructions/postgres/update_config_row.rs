...
impl carbon_core::postgres::operations::Insert for UpdateConfigRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO raydium_launchpad_update_config_instruction (
                "param",
                "value",
...
impl carbon_core::postgres::operations::Upsert for UpdateConfigRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO raydium_launchpad_update_config_instruction (
                "param",
                "value",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
...
impl carbon_core::postgres::operations::Delete for UpdateConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM raydium_launchpad_update_config_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for UpdateConfigRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM raydium_launchpad_update_config_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateConfigMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS raydium_launchpad_update_config_instruction (
                -- Instruction data
                "param" INT2 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS raydium_launchpad_update_config_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
