...
impl MigrateToCpswapRow {
    pub fn from_parts(
        _source: crate::instructions::migrate_to_cpswap::MigrateToCpswap,
...
impl TryFrom<MigrateToCpswapRow> for crate::instructions::migrate_to_cpswap::MigrateToCpswap {
    type Error = carbon_core::error::Error;
    fn try_from(_source: MigrateToCpswapRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrateToCpswapRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrateToCpswapRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MigrateToCpswapRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MigrateToCpswapMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MigrateToCpswapMigrationOperation {
    async fn up(
        &self,
