...
impl CreateVestingAccountRow {
    pub fn from_parts(
        source: crate::instructions::create_vesting_account::CreateVestingAccount,
    ...
    for crate::instructions::create_vesting_account::CreateVestingAccount
{
    ...
    fn try_from(source: CreateVestingAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
            share_amount: *source.share_amount,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for CreateVestingAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CreateVestingAccountRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CreateVestingAccountRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CreateVestingAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CreateVestingAccountMigrationOperation {
    async fn up(
        &self,
