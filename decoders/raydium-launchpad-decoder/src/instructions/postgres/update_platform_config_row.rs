...
pub struct UpdatePlatformConfigRow {
    ...
    pub param: sqlx::types::Json<PlatformConfigParam>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl UpdatePlatformConfigRow {
    pub fn from_parts(
        source: crate::instructions::update_platform_config::UpdatePlatformConfig,
    ...
    for crate::instructions::update_platform_config::UpdatePlatformConfig
{
    ...
    fn try_from(source: UpdatePlatformConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdatePlatformConfigRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdatePlatformConfigRow {
    type Key = (
        String,
...
pub struct UpdatePlatformConfigMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdatePlatformConfigMigrationOperation {
    async fn up(
        &self,
