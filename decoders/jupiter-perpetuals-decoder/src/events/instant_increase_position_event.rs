...
pub struct InstantIncreasePositionEventEvent {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for InstantIncreasePositionEventEvent {
    const DISCRIMINATOR: &'static [u8] = &[
        228, 69, 165, 46, 81, 203, 154, 29, 205, 236, 57, 4, 209, 106, 87, 69,
    ];
