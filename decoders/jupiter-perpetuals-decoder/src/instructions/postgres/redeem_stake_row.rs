...
impl RedeemStakeRow {
    pub fn from_parts(
        _source: crate::instructions::redeem_stake::RedeemStake,
...
impl TryFrom<RedeemStakeRow> for crate::instructions::redeem_stake::RedeemStake {
    type Error = carbon_core::error::Error;
    fn try_from(_source: RedeemStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for RedeemStakeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RedeemStakeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for RedeemStakeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct RedeemStakeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RedeemStakeMigrationOperation {
    async fn up(
        &self,
