...
pub struct DecreasePositionWithTpslAndInternalSwapRow {
    ...
    pub params: sqlx::types::Json<DecreasePositionWithTpslAndInternalSwapParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl DecreasePositionWithTpslAndInternalSwapRow {
    pub fn from_parts(
        source: crate::instructions::decrease_position_with_tpsl_and_internal_swap::DecreasePositionWithTpslAndInternalSwap,
...
impl TryFrom<DecreasePositionWithTpslAndInternalSwapRow> for crate::instructions::decrease_position_with_tpsl_and_internal_swap::DecreasePositionWithTpslAndInternalSwap {
    type Error = carbon_core::error::Error;
    fn try_from(source: DecreasePositionWithTpslAndInternalSwapRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DecreasePositionWithTpslAndInternalSwapRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for DecreasePositionWithTpslAndInternalSwapRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct DecreasePositionWithTpslAndInternalSwapMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for DecreasePositionWithTpslAndInternalSwapMigrationOperation
{
    async fn up(
        &self,
