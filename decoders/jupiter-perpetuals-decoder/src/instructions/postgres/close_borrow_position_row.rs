...
pub struct CloseBorrowPositionRow {
    ...
    pub params: sqlx::types::Json<CloseBorrowPositionParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl CloseBorrowPositionRow {
    pub fn from_parts(
        source: crate::instructions::close_borrow_position::CloseBorrowPosition,
    ...
    for crate::instructions::close_borrow_position::CloseBorrowPosition
{
    ...
    fn try_from(source: CloseBorrowPositionRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CloseBorrowPositionRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CloseBorrowPositionRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CloseBorrowPositionRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CloseBorrowPositionMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseBorrowPositionMigrationOperation {
    async fn up(
        &self,
