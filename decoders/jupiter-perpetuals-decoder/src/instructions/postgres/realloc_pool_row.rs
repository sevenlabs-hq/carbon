...
impl ReallocPoolRow {
    pub fn from_parts(
        _source: crate::instructions::realloc_pool::ReallocPool,
...
impl TryFrom<ReallocPoolRow> for crate::instructions::realloc_pool::ReallocPool {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ReallocPoolRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ReallocPoolRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ReallocPoolRow {
    type Key = (
        String,
...
pub struct ReallocPoolMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ReallocPoolMigrationOperation {
    async fn up(
        &self,
