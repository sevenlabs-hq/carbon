...
pub struct InstantDecreasePositionRow {
    ...
    pub params: sqlx::types::Json<InstantDecreasePositionParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl InstantDecreasePositionRow {
    pub fn from_parts(
        source: crate::instructions::instant_decrease_position::InstantDecreasePosition,
    ...
    for crate::instructions::instant_decrease_position::InstantDecreasePosition
{
    ...
    fn try_from(source: InstantDecreasePositionRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InstantDecreasePositionRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InstantDecreasePositionRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InstantDecreasePositionRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InstantDecreasePositionMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InstantDecreasePositionMigrationOperation {
    async fn up(
        &self,
