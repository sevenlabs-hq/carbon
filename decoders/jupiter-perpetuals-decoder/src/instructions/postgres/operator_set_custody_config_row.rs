...
pub struct OperatorSetCustodyConfigRow {
    ...
    pub params: sqlx::types::Json<OperatorSetCustodyConfigParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl OperatorSetCustodyConfigRow {
    pub fn from_parts(
        source: crate::instructions::operator_set_custody_config::OperatorSetCustodyConfig,
...
impl TryFrom<OperatorSetCustodyConfigRow>
    for crate::instructions::operator_set_custody_config::OperatorSetCustodyConfig
{
    type Error = carbon_core::error::Error;
    fn try_from(source: OperatorSetCustodyConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for OperatorSetCustodyConfigRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for OperatorSetCustodyConfigRow {
    type Key = (
        String,
...
pub struct OperatorSetCustodyConfigMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for OperatorSetCustodyConfigMigrationOperation {
    async fn up(
        &self,
