...
pub struct CreateDecreasePositionMarketRequestRow {
    ...
    pub params: sqlx::types::Json<CreateDecreasePositionMarketRequestParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl CreateDecreasePositionMarketRequestRow {
    pub fn from_parts(
        source: crate::instructions::create_decrease_position_market_request::CreateDecreasePositionMarketRequest,
...
impl TryFrom<CreateDecreasePositionMarketRequestRow> for crate::instructions::create_decrease_position_market_request::CreateDecreasePositionMarketRequest {
    type Error = carbon_core::error::Error;
    fn try_from(source: CreateDecreasePositionMarketRequestRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CreateDecreasePositionMarketRequestRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CreateDecreasePositionMarketRequestRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CreateDecreasePositionMarketRequestRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CreateDecreasePositionMarketRequestMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for CreateDecreasePositionMarketRequestMigrationOperation
{
    async fn up(
        &self,
