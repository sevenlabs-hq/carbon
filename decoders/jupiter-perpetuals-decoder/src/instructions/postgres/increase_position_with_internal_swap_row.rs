...
pub struct IncreasePositionWithInternalSwapRow {
    ...
    pub params: sqlx::types::Json<IncreasePositionWithInternalSwapParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl IncreasePositionWithInternalSwapRow {
    pub fn from_parts(
        source: crate::instructions::increase_position_with_internal_swap::IncreasePositionWithInternalSwap,
...
impl TryFrom<IncreasePositionWithInternalSwapRow>
    for crate::instructions::increase_position_with_internal_swap::IncreasePositionWithInternalSwap
{
    type Error = carbon_core::error::Error;
    fn try_from(source: IncreasePositionWithInternalSwapRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for IncreasePositionWithInternalSwapRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for IncreasePositionWithInternalSwapRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for IncreasePositionWithInternalSwapRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct IncreasePositionWithInternalSwapMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for IncreasePositionWithInternalSwapMigrationOperation
{
    async fn up(
        &self,
