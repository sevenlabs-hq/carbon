...
pub struct GetAddLiquidityAmountAndFee2Row {
    ...
    pub params: sqlx::types::Json<GetAddLiquidityAmountAndFee2Params>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl GetAddLiquidityAmountAndFee2Row {
    pub fn from_parts(
        source: crate::instructions::get_add_liquidity_amount_and_fee2::GetAddLiquidityAmountAndFee2,
...
impl TryFrom<GetAddLiquidityAmountAndFee2Row>
    for crate::instructions::get_add_liquidity_amount_and_fee2::GetAddLiquidityAmountAndFee2
{
    type Error = carbon_core::error::Error;
    fn try_from(source: GetAddLiquidityAmountAndFee2Row) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for GetAddLiquidityAmountAndFee2Row {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for GetAddLiquidityAmountAndFee2Row {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for GetAddLiquidityAmountAndFee2Row {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct GetAddLiquidityAmountAndFee2MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for GetAddLiquidityAmountAndFee2MigrationOperation {
    async fn up(
        &self,
