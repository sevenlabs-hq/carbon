...
pub struct SetTestTimeRow {
    ...
    pub params: sqlx::types::Json<SetTestTimeParams>,
...
impl SetTestTimeRow {
    pub fn from_parts(
        source: crate::instructions::set_test_time::SetTestTime,
...
impl TryFrom<SetTestTimeRow> for crate::instructions::set_test_time::SetTestTime {
    type Error = carbon_core::error::Error;
    fn try_from(source: SetTestTimeRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetTestTimeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetTestTimeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetTestTimeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetTestTimeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetTestTimeMigrationOperation {
    async fn up(
        &self,
