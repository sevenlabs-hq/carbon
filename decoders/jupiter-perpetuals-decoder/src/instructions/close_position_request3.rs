...
impl CarbonDeserialize for ClosePositionRequest3 {
    const DISCRIMINATOR: &'static [u8] = &[122, 130, 33, 18, 211, 44, 161, 58];
...
impl ArrangeAccounts for ClosePositionRequest3 {
