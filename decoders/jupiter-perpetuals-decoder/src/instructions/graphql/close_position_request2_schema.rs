...
#[graphql(name = "ClosePositionRequest2")]
pub struct ClosePositionRequest2GraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePositionRequest2Row>
    for ClosePositionRequest2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePositionRequest2Row,
