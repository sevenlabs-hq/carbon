...
#[graphql(name = "ReallocPool")]
pub struct ReallocPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReallocPoolRow> for ReallocPoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReallocPoolRow) -> Result<Self, Self::Error> {
        Ok(Self {
