...
#[graphql(name = "WithdrawStake")]
pub struct WithdrawStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawStakeRow> for WithdrawStakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::WithdrawStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
