...
#[graphql(name = "ClosePositionRequest3")]
pub struct ClosePositionRequest3GraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePositionRequest3Row>
    for ClosePositionRequest3GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePositionRequest3Row,
