...
#[graphql(name = "RedeemStake")]
pub struct RedeemStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::RedeemStakeRow> for RedeemStakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RedeemStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
