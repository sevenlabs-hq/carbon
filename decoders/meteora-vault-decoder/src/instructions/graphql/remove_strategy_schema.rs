...
#[graphql(name = "RemoveStrategy")]
pub struct RemoveStrategyGraphQL {
...
impl TryFrom<crate::instructions::postgres::RemoveStrategyRow> for RemoveStrategyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RemoveStrategyRow,
