...
#[graphql(name = "AddStrategy")]
pub struct AddStrategyGraphQL {
...
impl TryFrom<crate::instructions::postgres::AddStrategyRow> for AddStrategyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AddStrategyRow) -> Result<Self, Self::Error> {
        Ok(Self {
