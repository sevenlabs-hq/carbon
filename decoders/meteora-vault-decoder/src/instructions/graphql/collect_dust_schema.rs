...
#[graphql(name = "CollectDust")]
pub struct CollectDustGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectDustRow> for CollectDustGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CollectDustRow) -> Result<Self, Self::Error> {
        Ok(Self {
