...
#[graphql(name = "RemoveStrategy2")]
pub struct RemoveStrategy2GraphQL {
...
impl TryFrom<crate::instructions::postgres::RemoveStrategy2Row> for RemoveStrategy2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RemoveStrategy2Row,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            instruction_metadata: row.instruction_metadata.into(),
            max_admin_pay_amount: carbon_core::graphql::primitives::U64(*row.max_admin_pay_amount),
