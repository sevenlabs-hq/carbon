...
#[graphql(name = "DepositStrategy")]
pub struct DepositStrategyGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositStrategyRow> for DepositStrategyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositStrategyRow,
