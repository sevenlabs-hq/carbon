...
#[graphql(name = "WithdrawStrategy")]
pub struct WithdrawStrategyGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawStrategyRow> for WithdrawStrategyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawStrategyRow,
