...
impl CollectDustRow {
    pub fn from_parts(
        _source: crate::instructions::collect_dust::CollectDust,
...
impl TryFrom<CollectDustRow> for crate::instructions::collect_dust::CollectDust {
    type Error = carbon_core::error::Error;
    fn try_from(_source: CollectDustRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CollectDustRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CollectDustRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CollectDustRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CollectDustMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectDustMigrationOperation {
    async fn up(
        &self,
