...
use {
    crate::types::StrategyType, carbon_core::deserialize::CarbonDeserialize, solana_pubkey::Pubkey,
};
...
impl CarbonDeserialize for Strategy {
    const DISCRIMINATOR: &'static [u8] = &[174, 110, 39, 119, 82, 106, 169, 102];
