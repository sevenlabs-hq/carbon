...
impl TryFrom<crate::instructions::postgres::DeleteRow> for DeleteGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DeleteRow) -> Result<Self, Self::Error> {
        Ok(Self {
