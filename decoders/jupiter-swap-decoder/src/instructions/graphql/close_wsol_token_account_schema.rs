...
#[graphql(name = "CloseWsolTokenAccount")]
pub struct CloseWsolTokenAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseWsolTokenAccountRow>
    for CloseWsolTokenAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseWsolTokenAccountRow,
