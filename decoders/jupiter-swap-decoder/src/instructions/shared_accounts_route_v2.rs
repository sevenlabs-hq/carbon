...
impl CarbonDeserialize for SharedAccountsRouteV2 {
    const DISCRIMINATOR: &'static [u8] = &[209, 152, 83, 147, 124, 254, 216, 233];
...
impl ArrangeAccounts for SharedAccountsRouteV2 {
