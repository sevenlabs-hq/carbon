...
#[graphql(name = "AdminClaimMsol")]
pub struct AdminClaimMsolGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminClaimMsolRow> for AdminClaimMsolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminClaimMsolRow,
