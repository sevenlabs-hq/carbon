...
#[graphql(name = "AdminClaimStakingRewards")]
pub struct AdminClaimStakingRewardsGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminClaimStakingRewardsRow>
    for AdminClaimStakingRewardsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminClaimStakingRewardsRow,
