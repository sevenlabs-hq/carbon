...
#[graphql(name = "ClaimProCreatorTradingFees")]
pub struct ClaimProCreatorTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimProCreatorTradingFeesRow>
    for ClaimProCreatorTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimProCreatorTradingFeesRow,
