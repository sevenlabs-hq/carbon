...
#[graphql(name = "AdminClaimProCreatorTradingFees")]
pub struct AdminClaimProCreatorTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminClaimProCreatorTradingFeesRow>
    for AdminClaimProCreatorTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminClaimProCreatorTradingFeesRow,
