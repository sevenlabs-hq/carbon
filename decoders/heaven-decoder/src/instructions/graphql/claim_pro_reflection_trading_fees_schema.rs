...
#[graphql(name = "ClaimProReflectionTradingFees")]
pub struct ClaimProReflectionTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimProReflectionTradingFeesRow>
    for ClaimProReflectionTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimProReflectionTradingFeesRow,
