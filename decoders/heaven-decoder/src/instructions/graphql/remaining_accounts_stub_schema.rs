...
#[graphql(name = "RemainingAccountsStub")]
pub struct RemainingAccountsStubGraphQL {
...
impl TryFrom<crate::instructions::postgres::RemainingAccountsStubRow>
    for RemainingAccountsStubGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RemainingAccountsStubRow,
