...
#[graphql(name = "AdminMintMsol")]
pub struct AdminMintMsolGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminMintMsolRow> for AdminMintMsolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AdminMintMsolRow) -> Result<Self, Self::Error> {
        Ok(Self {
