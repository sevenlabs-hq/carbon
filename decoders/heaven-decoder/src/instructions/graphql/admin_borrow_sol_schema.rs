...
#[graphql(name = "AdminBorrowSol")]
pub struct AdminBorrowSolGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminBorrowSolRow> for AdminBorrowSolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminBorrowSolRow,
