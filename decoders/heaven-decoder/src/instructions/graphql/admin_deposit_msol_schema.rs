...
#[graphql(name = "AdminDepositMsol")]
pub struct AdminDepositMsolGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminDepositMsolRow> for AdminDepositMsolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminDepositMsolRow,
