...
#[graphql(name = "AdminWithdrawMsol")]
pub struct AdminWithdrawMsolGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminWithdrawMsolRow> for AdminWithdrawMsolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminWithdrawMsolRow,
