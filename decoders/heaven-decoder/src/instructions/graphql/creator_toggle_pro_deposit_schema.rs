...
#[graphql(name = "CreatorToggleProDeposit")]
pub struct CreatorToggleProDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreatorToggleProDepositRow>
    for CreatorToggleProDepositGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreatorToggleProDepositRow,
