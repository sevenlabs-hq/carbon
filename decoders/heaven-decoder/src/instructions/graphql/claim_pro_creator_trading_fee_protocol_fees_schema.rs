...
#[graphql(name = "ClaimProCreatorTradingFeeProtocolFees")]
pub struct ClaimProCreatorTradingFeeProtocolFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimProCreatorTradingFeeProtocolFeesRow>
    for ClaimProCreatorTradingFeeProtocolFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimProCreatorTradingFeeProtocolFeesRow,
