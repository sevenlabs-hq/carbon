...
#[graphql(name = "ClaimProProtocolTradingFees")]
pub struct ClaimProProtocolTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimProProtocolTradingFeesRow>
    for ClaimProProtocolTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimProProtocolTradingFeesRow,
