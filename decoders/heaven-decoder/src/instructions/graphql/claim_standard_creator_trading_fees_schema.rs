...
#[graphql(name = "ClaimStandardCreatorTradingFees")]
pub struct ClaimStandardCreatorTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimStandardCreatorTradingFeesRow>
    for ClaimStandardCreatorTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimStandardCreatorTradingFeesRow,
