...
#[graphql(name = "ClaimStandardReflectionTradingFees")]
pub struct ClaimStandardReflectionTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimStandardReflectionTradingFeesRow>
    for ClaimStandardReflectionTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimStandardReflectionTradingFeesRow,
