...
#[graphql(name = "TransferLpTokens")]
pub struct TransferLpTokensGraphQL {
...
impl TryFrom<crate::instructions::postgres::TransferLpTokensRow> for TransferLpTokensGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TransferLpTokensRow,
