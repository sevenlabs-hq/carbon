...
#[graphql(name = "CreatorToggleProSwap")]
pub struct CreatorToggleProSwapGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreatorToggleProSwapRow>
    for CreatorToggleProSwapGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreatorToggleProSwapRow,
