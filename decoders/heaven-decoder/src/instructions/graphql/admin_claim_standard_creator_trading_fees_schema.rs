...
#[graphql(name = "AdminClaimStandardCreatorTradingFees")]
pub struct AdminClaimStandardCreatorTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminClaimStandardCreatorTradingFeesRow>
    for AdminClaimStandardCreatorTradingFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminClaimStandardCreatorTradingFeesRow,
