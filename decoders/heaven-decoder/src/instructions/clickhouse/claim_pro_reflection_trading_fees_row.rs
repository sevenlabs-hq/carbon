...
pub struct ClaimProReflectionTradingFeesRow {
...
impl
    TryFrom<(
        crate::instructions::claim_pro_reflection_trading_fees::ClaimProReflectionTradingFees,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::claim_pro_reflection_trading_fees::ClaimProReflectionTradingFeesInstructionAccounts,
    )> for ClaimProReflectionTradingFeesRow
{
...
impl carbon_core::clickhouse::ClusterTable for ClaimProReflectionTradingFeesRow {
    fn local_table() -> &'static str {
        "heaven_claim_pro_reflection_trading_fees_instruction_local"
    }

    fn distributed_table() -> &'static str {
        "heaven_claim_pro_reflection_trading_fees_instruction"
    }
}

#[cfg(not(feature = "clickhouse-cluster"))]
impl carbon_core::clickhouse::Table for ClaimProReflectionTradingFeesRow {
    fn table() -> &'static str {
        "heaven_claim_pro_reflection_trading_fees_instruction"
    }
}
...
pub struct ClaimProReflectionTradingFeesRowMigrationOperation;

#[cfg(feature = "clickhouse-cluster")]
#[async_trait::async_trait]
impl carbon_core::clickhouse::Operation for ClaimProReflectionTradingFeesRowMigrationOperation {
    async fn up(
        &self,
        client: &clickhouse::Client,
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/heaven_claim_pro_reflection_trading_fees_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS heaven_claim_pro_reflection_trading_fees_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS heaven_claim_pro_reflection_trading_fees_instruction ON CLUSTER {cluster} AS heaven_claim_pro_reflection_trading_fees_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), heaven_claim_pro_reflection_trading_fees_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS heaven_claim_pro_reflection_trading_fees_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS heaven_claim_pro_reflection_trading_fees_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
...
impl carbon_core::clickhouse::Operation for ClaimProReflectionTradingFeesRowMigrationOperation {
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS heaven_claim_pro_reflection_trading_fees_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS heaven_claim_pro_reflection_trading_fees_instruction")
            .execute()
            .await?;
