...
impl CarbonDeserialize for AdminClaimStandardCreatorTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[182, 39, 168, 25, 96, 63, 76, 17];
...
impl ArrangeAccounts for AdminClaimStandardCreatorTradingFees {
