...
impl CarbonDeserialize for ExtendProtocolLookupTable {
    const DISCRIMINATOR: &'static [u8] = &[7, 227, 198, 1, 107, 113, 31, 88];
...
impl ArrangeAccounts for ExtendProtocolLookupTable {
