...
pub struct AdminClaimProCreatorTradingFees {
    pub amount: u64,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AdminClaimProCreatorTradingFeesInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for AdminClaimProCreatorTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[68, 130, 250, 72, 60, 94, 31, 22];
...
impl ArrangeAccounts for AdminClaimProCreatorTradingFees {
    type ArrangedAccounts = AdminClaimProCreatorTradingFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(AdminClaimProCreatorTradingFeesInstructionAccounts {
            token_a_program,
            token_b_program,
