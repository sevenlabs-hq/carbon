...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ProSellInstructionAccounts {
...
impl CarbonDeserialize for ProSell {
    const DISCRIMINATOR: &'static [u8] = &[140, 79, 122, 96, 22, 137, 238, 124];
...
impl ArrangeAccounts for ProSell {
    type ArrangedAccounts = ProSellInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ProSellInstructionAccounts {
            token_a_program,
            token_b_program,
