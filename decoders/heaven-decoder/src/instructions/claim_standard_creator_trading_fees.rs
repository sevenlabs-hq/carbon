...
impl CarbonDeserialize for ClaimStandardCreatorTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[165, 89, 221, 52, 170, 249, 34, 111];
...
impl ArrangeAccounts for ClaimStandardCreatorTradingFees {
