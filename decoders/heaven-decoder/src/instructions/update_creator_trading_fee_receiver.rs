...
impl CarbonDeserialize for UpdateCreatorTradingFeeReceiver {
    const DISCRIMINATOR: &'static [u8] = &[246, 229, 200, 79, 31, 21, 120, 25];
...
impl ArrangeAccounts for UpdateCreatorTradingFeeReceiver {
