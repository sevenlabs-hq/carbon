...
pub struct ClaimProCreatorTradingFees {
    pub amount: u64,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimProCreatorTradingFeesInstructionAccounts {
...
impl CarbonDeserialize for ClaimProCreatorTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[81, 123, 103, 113, 109, 150, 138, 93];
...
impl ArrangeAccounts for ClaimProCreatorTradingFees {
    type ArrangedAccounts = ClaimProCreatorTradingFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ClaimProCreatorTradingFeesInstructionAccounts {
            token_a_program,
            token_b_program,
