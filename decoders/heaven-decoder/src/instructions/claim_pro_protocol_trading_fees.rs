...
pub struct ClaimProProtocolTradingFees {
    pub amount: u64,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimProProtocolTradingFeesInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for ClaimProProtocolTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[221, 192, 101, 189, 255, 79, 194, 57];
...
impl ArrangeAccounts for ClaimProProtocolTradingFees {
    type ArrangedAccounts = ClaimProProtocolTradingFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ClaimProProtocolTradingFeesInstructionAccounts {
            token_a_program,
            token_b_program,
