...
pub struct ClaimProCreatorTradingFeeProtocolFees {
    pub amount: u64,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimProCreatorTradingFeeProtocolFeesInstructionAccounts {
...
impl CarbonDeserialize for ClaimProCreatorTradingFeeProtocolFees {
    const DISCRIMINATOR: &'static [u8] = &[234, 35, 237, 15, 138, 49, 236, 153];
...
impl ArrangeAccounts for ClaimProCreatorTradingFeeProtocolFees {
    type ArrangedAccounts = ClaimProCreatorTradingFeeProtocolFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ClaimProCreatorTradingFeeProtocolFeesInstructionAccounts {
            token_a_program,
            token_b_program,
