...
pub struct ClaimProLiquidityProviderTradingFees {}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimProLiquidityProviderTradingFeesInstructionAccounts {
    ...
    pub user_lp_position: solana_pubkey::Pubkey,
    pub remaining: Vec<solana_instruction::AccountMeta>,
}

impl CarbonDeserialize for ClaimProLiquidityProviderTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[242, 116, 228, 52, 32, 116, 172, 148];
...
impl ArrangeAccounts for ClaimProLiquidityProviderTradingFees {
    type ArrangedAccounts = ClaimProLiquidityProviderTradingFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        let user_lp_position = next_account(&mut iter)?;

        let remaining = iter.as_slice();

        Some(ClaimProLiquidityProviderTradingFeesInstructionAccounts {
            token_a_program,
            token_b_program,
            system_program,
