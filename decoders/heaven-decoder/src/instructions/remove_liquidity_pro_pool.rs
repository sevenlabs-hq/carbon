...
pub struct RemoveLiquidityProPool {
    pub params: RemoveLiquidityParams,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RemoveLiquidityProPoolInstructionAccounts {
...
impl CarbonDeserialize for RemoveLiquidityProPool {
    const DISCRIMINATOR: &'static [u8] = &[191, 55, 42, 44, 226, 98, 172, 79];
...
impl ArrangeAccounts for RemoveLiquidityProPool {
    type ArrangedAccounts = RemoveLiquidityProPoolInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(RemoveLiquidityProPoolInstructionAccounts {
            token_a_program,
            token_b_program,
