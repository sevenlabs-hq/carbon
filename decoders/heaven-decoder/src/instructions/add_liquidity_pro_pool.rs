...
pub struct AddLiquidityProPool {
    pub params: AddLiquidityParams,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddLiquidityProPoolInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for AddLiquidityProPool {
    const DISCRIMINATOR: &'static [u8] = &[125, 59, 108, 42, 18, 28, 34, 7];
...
impl ArrangeAccounts for AddLiquidityProPool {
    type ArrangedAccounts = AddLiquidityProPoolInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(AddLiquidityProPoolInstructionAccounts {
            token_a_program,
            token_b_program,
