...
pub struct UpdateProCreatorTradingFeeReceiver {}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct UpdateProCreatorTradingFeeReceiverInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for UpdateProCreatorTradingFeeReceiver {
    const DISCRIMINATOR: &'static [u8] = &[156, 240, 27, 243, 42, 165, 31, 0];
...
impl ArrangeAccounts for UpdateProCreatorTradingFeeReceiver {
    type ArrangedAccounts = UpdateProCreatorTradingFeeReceiverInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(UpdateProCreatorTradingFeeReceiverInstructionAccounts {
            token_a_program,
            token_b_program,
