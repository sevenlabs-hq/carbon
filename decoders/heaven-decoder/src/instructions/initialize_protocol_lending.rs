...
impl CarbonDeserialize for InitializeProtocolLending {
    const DISCRIMINATOR: &'static [u8] = &[0, 205, 237, 240, 27, 79, 27, 59];
...
impl ArrangeAccounts for InitializeProtocolLending {
