...
impl CarbonDeserialize for ClaimStandardReflectionTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[70, 148, 37, 147, 102, 20, 30, 23];
...
impl ArrangeAccounts for ClaimStandardReflectionTradingFees {
