...
impl CarbonDeserialize for ClaimStandardProtocolTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[84, 206, 140, 245, 63, 212, 64, 237];
...
impl ArrangeAccounts for ClaimStandardProtocolTradingFees {
