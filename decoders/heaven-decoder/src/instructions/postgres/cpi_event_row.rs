...
impl CpiEventRow {
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                CpiEvent::CreateLiquidityPoolEvent(_) => "create_liquidity_pool_event".to_string(),
                CpiEvent::CreateStandardLiquidityPoolEvent(_) => {
                    "create_standard_liquidity_pool_event".to_string()
                }
