...
pub struct ClaimProReflectionTradingFees {
    pub amount: u64,
}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClaimProReflectionTradingFeesInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for ClaimProReflectionTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[234, 144, 48, 252, 111, 6, 80, 58];
...
impl ArrangeAccounts for ClaimProReflectionTradingFees {
    type ArrangedAccounts = ClaimProReflectionTradingFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ClaimProReflectionTradingFeesInstructionAccounts {
            token_a_program,
            token_b_program,
