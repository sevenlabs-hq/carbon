...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ProBuyInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for ProBuy {
    const DISCRIMINATOR: &'static [u8] = &[103, 171, 196, 238, 159, 45, 187, 246];
...
impl ArrangeAccounts for ProBuy {
    type ArrangedAccounts = ProBuyInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(ProBuyInstructionAccounts {
            token_a_program,
            token_b_program,
