...
impl carbon_core::deserialize::ArrangeAccounts for RemainingAccountsStub {
    ...
    fn arrange_accounts(
        ...
        let [create_protocol_config_remaining_accounts, kamino_lending_user_metadata, kamino_lending_init_obligation, kamino_lending_refresh_reserve, kamino_lending_refresh_obligation, refresh_msol_price_list, msol_liquid_staking, msol_liquid_staking_cpi, kamino_deposit_with_farm, kamino_deposit_with_farm_cpi, kamino_deposit_with_farm_client, kamino_borrow_with_farm, kamino_borrow_with_farm_cpi, kamino_borrow_with_farm_client, kamino_repay_with_farm, kamino_repay_with_farm_cpi, kamino_repay_with_farm_client, order_unstake_msol_client, order_unstake_msol_cpi, claim_msol_cpi, kamino_withdraw_with_farm, kamino_withdraw_with_farm_cpi, kamino_withdraw_with_farm_client, _remaining @ ..] =
            accounts
        else {
            return None;
        };
