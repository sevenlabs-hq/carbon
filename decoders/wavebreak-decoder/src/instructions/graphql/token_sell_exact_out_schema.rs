...
#[graphql(name = "TokenSellExactOut")]
pub struct TokenSellExactOutGraphQL {
...
impl TryFrom<crate::instructions::postgres::TokenSellExactOutRow> for TokenSellExactOutGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TokenSellExactOutRow,
