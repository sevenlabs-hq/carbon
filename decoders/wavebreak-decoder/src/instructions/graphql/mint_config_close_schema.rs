...
#[graphql(name = "MintConfigClose")]
pub struct MintConfigCloseGraphQL {
...
impl TryFrom<crate::instructions::postgres::MintConfigCloseRow> for MintConfigCloseGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MintConfigCloseRow,
