...
#[graphql(name = "ReservedGraduateY")]
pub struct ReservedGraduateYGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedGraduateYRow> for ReservedGraduateYGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedGraduateYRow,
