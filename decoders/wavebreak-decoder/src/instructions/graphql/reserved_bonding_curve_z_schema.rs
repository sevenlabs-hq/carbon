...
#[graphql(name = "ReservedBondingCurveZ")]
pub struct ReservedBondingCurveZGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedBondingCurveZRow>
    for ReservedBondingCurveZGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedBondingCurveZRow,
