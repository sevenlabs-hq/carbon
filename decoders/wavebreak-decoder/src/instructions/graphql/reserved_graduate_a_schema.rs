...
#[graphql(name = "ReservedGraduateA")]
pub struct ReservedGraduateAGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedGraduateARow> for ReservedGraduateAGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedGraduateARow,
