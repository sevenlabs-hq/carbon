...
#[graphql(name = "ReservedMintConfigC")]
pub struct ReservedMintConfigCGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedMintConfigCRow> for ReservedMintConfigCGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedMintConfigCRow,
