...
#[graphql(name = "BondingCurveClose")]
pub struct BondingCurveCloseGraphQL {
...
impl TryFrom<crate::instructions::postgres::BondingCurveCloseRow> for BondingCurveCloseGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::BondingCurveCloseRow,
