...
#[graphql(name = "ReservedLpY")]
pub struct ReservedLpYGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedLpYRow> for ReservedLpYGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReservedLpYRow) -> Result<Self, Self::Error> {
        Ok(Self {
