...
#[graphql(name = "ReservedCreateC")]
pub struct ReservedCreateCGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedCreateCRow> for ReservedCreateCGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedCreateCRow,
