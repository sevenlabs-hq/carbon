...
#[graphql(name = "LpTransfer")]
pub struct LpTransferGraphQL {
...
impl TryFrom<crate::instructions::postgres::LpTransferRow> for LpTransferGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::LpTransferRow) -> Result<Self, Self::Error> {
        Ok(Self {
