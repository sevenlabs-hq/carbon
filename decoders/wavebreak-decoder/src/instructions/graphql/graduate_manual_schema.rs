...
#[graphql(name = "GraduateManual")]
pub struct GraduateManualGraphQL {
...
impl TryFrom<crate::instructions::postgres::GraduateManualRow> for GraduateManualGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::GraduateManualRow,
