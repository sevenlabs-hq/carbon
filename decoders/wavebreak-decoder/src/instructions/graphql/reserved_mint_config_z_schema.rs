...
#[graphql(name = "ReservedMintConfigZ")]
pub struct ReservedMintConfigZGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedMintConfigZRow> for ReservedMintConfigZGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedMintConfigZRow,
