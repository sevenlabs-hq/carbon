...
#[graphql(name = "ReservedLpB")]
pub struct ReservedLpBGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedLpBRow> for ReservedLpBGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReservedLpBRow) -> Result<Self, Self::Error> {
        Ok(Self {
