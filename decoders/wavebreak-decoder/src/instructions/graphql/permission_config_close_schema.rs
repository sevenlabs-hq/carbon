...
#[graphql(name = "PermissionConfigClose")]
pub struct PermissionConfigCloseGraphQL {
...
impl TryFrom<crate::instructions::postgres::PermissionConfigCloseRow>
    for PermissionConfigCloseGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PermissionConfigCloseRow,
