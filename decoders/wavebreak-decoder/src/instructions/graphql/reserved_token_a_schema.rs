...
#[graphql(name = "ReservedTokenA")]
pub struct ReservedTokenAGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedTokenARow> for ReservedTokenAGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedTokenARow,
