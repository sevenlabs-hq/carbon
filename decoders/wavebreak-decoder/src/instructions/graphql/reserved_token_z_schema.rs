...
#[graphql(name = "ReservedTokenZ")]
pub struct ReservedTokenZGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedTokenZRow> for ReservedTokenZGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedTokenZRow,
