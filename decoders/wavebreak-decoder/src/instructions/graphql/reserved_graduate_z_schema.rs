...
#[graphql(name = "ReservedGraduateZ")]
pub struct ReservedGraduateZGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedGraduateZRow> for ReservedGraduateZGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedGraduateZRow,
