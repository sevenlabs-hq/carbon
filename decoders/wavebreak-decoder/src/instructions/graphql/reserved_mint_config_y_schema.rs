...
#[graphql(name = "ReservedMintConfigY")]
pub struct ReservedMintConfigYGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedMintConfigYRow> for ReservedMintConfigYGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedMintConfigYRow,
