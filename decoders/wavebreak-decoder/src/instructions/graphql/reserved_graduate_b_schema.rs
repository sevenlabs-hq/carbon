...
#[graphql(name = "ReservedGraduateB")]
pub struct ReservedGraduateBGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedGraduateBRow> for ReservedGraduateBGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedGraduateBRow,
