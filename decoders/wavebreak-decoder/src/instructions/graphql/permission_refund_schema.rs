...
#[graphql(name = "PermissionRefund")]
pub struct PermissionRefundGraphQL {
...
impl TryFrom<crate::instructions::postgres::PermissionRefundRow> for PermissionRefundGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PermissionRefundRow,
