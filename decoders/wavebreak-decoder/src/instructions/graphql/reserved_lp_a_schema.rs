...
#[graphql(name = "ReservedLpA")]
pub struct ReservedLpAGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedLpARow> for ReservedLpAGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReservedLpARow) -> Result<Self, Self::Error> {
        Ok(Self {
