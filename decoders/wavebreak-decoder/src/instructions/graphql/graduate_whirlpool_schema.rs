...
#[graphql(name = "GraduateWhirlpool")]
pub struct GraduateWhirlpoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::GraduateWhirlpoolRow> for GraduateWhirlpoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::GraduateWhirlpoolRow,
