...
#[graphql(name = "ReservedTokenY")]
pub struct ReservedTokenYGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedTokenYRow> for ReservedTokenYGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedTokenYRow,
