...
#[graphql(name = "ReservedCreateZ")]
pub struct ReservedCreateZGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedCreateZRow> for ReservedCreateZGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedCreateZRow,
