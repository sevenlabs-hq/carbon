...
#[graphql(name = "ReservedGraduateC")]
pub struct ReservedGraduateCGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedGraduateCRow> for ReservedGraduateCGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedGraduateCRow,
