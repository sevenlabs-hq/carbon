...
#[graphql(name = "ReservedPermissionA")]
pub struct ReservedPermissionAGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedPermissionARow> for ReservedPermissionAGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedPermissionARow,
