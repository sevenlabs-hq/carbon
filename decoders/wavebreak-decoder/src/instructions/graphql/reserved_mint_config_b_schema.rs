...
#[graphql(name = "ReservedMintConfigB")]
pub struct ReservedMintConfigBGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedMintConfigBRow> for ReservedMintConfigBGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedMintConfigBRow,
