...
#[graphql(name = "LpTakeover")]
pub struct LpTakeoverGraphQL {
...
impl TryFrom<crate::instructions::postgres::LpTakeoverRow> for LpTakeoverGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::LpTakeoverRow) -> Result<Self, Self::Error> {
        Ok(Self {
