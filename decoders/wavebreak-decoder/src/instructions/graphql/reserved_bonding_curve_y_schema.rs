...
#[graphql(name = "ReservedBondingCurveY")]
pub struct ReservedBondingCurveYGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedBondingCurveYRow>
    for ReservedBondingCurveYGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedBondingCurveYRow,
