...
#[graphql(name = "ReservedLpX")]
pub struct ReservedLpXGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedLpXRow> for ReservedLpXGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReservedLpXRow) -> Result<Self, Self::Error> {
        Ok(Self {
