...
#[graphql(name = "ReservedMintConfigA")]
pub struct ReservedMintConfigAGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedMintConfigARow> for ReservedMintConfigAGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedMintConfigARow,
