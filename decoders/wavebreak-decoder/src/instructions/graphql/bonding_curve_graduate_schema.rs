...
#[graphql(name = "BondingCurveGraduate")]
pub struct BondingCurveGraduateGraphQL {
...
impl TryFrom<crate::instructions::postgres::BondingCurveGraduateRow>
    for BondingCurveGraduateGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::BondingCurveGraduateRow,
