...
#[graphql(name = "ReservedBondingCurveA")]
pub struct ReservedBondingCurveAGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedBondingCurveARow>
    for ReservedBondingCurveAGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedBondingCurveARow,
