...
#[graphql(name = "BondingCurveCollectFees")]
pub struct BondingCurveCollectFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::BondingCurveCollectFeesRow>
    for BondingCurveCollectFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::BondingCurveCollectFeesRow,
