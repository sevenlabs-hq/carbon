...
#[graphql(name = "LpHarvest")]
pub struct LpHarvestGraphQL {
...
impl TryFrom<crate::instructions::postgres::LpHarvestRow> for LpHarvestGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::LpHarvestRow) -> Result<Self, Self::Error> {
        Ok(Self {
