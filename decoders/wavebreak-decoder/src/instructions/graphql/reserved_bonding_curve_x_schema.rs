...
#[graphql(name = "ReservedBondingCurveX")]
pub struct ReservedBondingCurveXGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedBondingCurveXRow>
    for ReservedBondingCurveXGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedBondingCurveXRow,
