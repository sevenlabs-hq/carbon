...
#[graphql(name = "TokenRefund")]
pub struct TokenRefundGraphQL {
...
impl TryFrom<crate::instructions::postgres::TokenRefundRow> for TokenRefundGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::TokenRefundRow) -> Result<Self, Self::Error> {
        Ok(Self {
