...
#[graphql(name = "ReservedCreateY")]
pub struct ReservedCreateYGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedCreateYRow> for ReservedCreateYGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedCreateYRow,
