...
#[graphql(name = "ReservedCreateB")]
pub struct ReservedCreateBGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedCreateBRow> for ReservedCreateBGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedCreateBRow,
