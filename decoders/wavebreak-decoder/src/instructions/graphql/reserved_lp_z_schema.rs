...
#[graphql(name = "ReservedLpZ")]
pub struct ReservedLpZGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedLpZRow> for ReservedLpZGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReservedLpZRow) -> Result<Self, Self::Error> {
        Ok(Self {
