...
#[graphql(name = "ReservedGraduateX")]
pub struct ReservedGraduateXGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReservedGraduateXRow> for ReservedGraduateXGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ReservedGraduateXRow,
