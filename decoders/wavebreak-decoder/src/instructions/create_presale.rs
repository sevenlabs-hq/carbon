...
pub struct CreatePresaleInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for CreatePresale {
    type ArrangedAccounts = CreatePresaleInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(CreatePresaleInstructionAccounts {
            creator,
            bonding_curve,
            base_mint,
            quote_mint,
