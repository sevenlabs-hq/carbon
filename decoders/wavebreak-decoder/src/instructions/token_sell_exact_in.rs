...
pub struct TokenSellExactInInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for TokenSellExactIn {
    type ArrangedAccounts = TokenSellExactInInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(TokenSellExactInInstructionAccounts {
            seller,
            bonding_curve,
            base_mint,
            base_ata,
