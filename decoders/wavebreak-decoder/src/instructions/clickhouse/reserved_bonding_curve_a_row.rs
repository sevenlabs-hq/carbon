...
pub struct ReservedBondingCurveARow {
...
impl carbon_core::clickhouse::ClusterTable for ReservedBondingCurveARow {
    fn local_table() -> &'static str {
        "wavebreak_reserved_bonding_curve_a_instruction_local"
    }

    fn distributed_table() -> &'static str {
        "wavebreak_reserved_bonding_curve_a_instruction"
    }
}

#[cfg(not(feature = "clickhouse-cluster"))]
impl carbon_core::clickhouse::Table for ReservedBondingCurveARow {
    fn table() -> &'static str {
        "wavebreak_reserved_bonding_curve_a_instruction"
    }
}
...
pub struct ReservedBondingCurveARowMigrationOperation;

#[cfg(feature = "clickhouse-cluster")]
#[async_trait::async_trait]
impl carbon_core::clickhouse::Operation for ReservedBondingCurveARowMigrationOperation {
    async fn up(
        &self,
        client: &clickhouse::Client,
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/wavebreak_reserved_bonding_curve_a_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS wavebreak_reserved_bonding_curve_a_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS wavebreak_reserved_bonding_curve_a_instruction ON CLUSTER {cluster} AS wavebreak_reserved_bonding_curve_a_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), wavebreak_reserved_bonding_curve_a_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS wavebreak_reserved_bonding_curve_a_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS wavebreak_reserved_bonding_curve_a_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
...
impl carbon_core::clickhouse::Operation for ReservedBondingCurveARowMigrationOperation {
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS wavebreak_reserved_bonding_curve_a_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS wavebreak_reserved_bonding_curve_a_instruction")
            .execute()
            .await?;
