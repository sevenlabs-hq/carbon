...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapTobV3EnhancedInstructionAccounts {
...
impl CarbonDeserialize for SwapTobV3Enhanced {
    const DISCRIMINATOR: &'static [u8] = &[236, 71, 155, 68, 198, 98, 14, 118];
...
impl ArrangeAccounts for SwapTobV3Enhanced {
    type ArrangedAccounts = SwapTobV3EnhancedInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SwapTobV3EnhancedInstructionAccounts {
            payer,
