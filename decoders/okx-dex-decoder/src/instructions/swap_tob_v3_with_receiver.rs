...
/// - For swap to SOL with custom receiver: sol_receiver should be Some and
///   acc_close_flag must be true
...
impl CarbonDeserialize for SwapTobV3WithReceiver {
    const DISCRIMINATOR: &'static [u8] = &[63, 114, 246, 131, 51, 2, 247, 29];
...
impl ArrangeAccounts for SwapTobV3WithReceiver {
