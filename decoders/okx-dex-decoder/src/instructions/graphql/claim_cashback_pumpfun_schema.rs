...
#[graphql(name = "ClaimCashbackPumpfun")]
pub struct ClaimCashbackPumpfunGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimCashbackPumpfunRow>
    for ClaimCashbackPumpfunGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimCashbackPumpfunRow,
