...
impl WrapUnwrapV3Row {
    pub fn from_parts(
        source: crate::instructions::wrap_unwrap_v3::WrapUnwrapV3,
...
impl TryFrom<WrapUnwrapV3Row> for crate::instructions::wrap_unwrap_v3::WrapUnwrapV3 {
    type Error = carbon_core::error::Error;
    fn try_from(source: WrapUnwrapV3Row) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
        })
    }
...
impl carbon_core::postgres::operations::Insert for WrapUnwrapV3Row {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for WrapUnwrapV3Row {
    type Key = (
        String,
...
pub struct WrapUnwrapV3MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for WrapUnwrapV3MigrationOperation {
    async fn up(
        &self,
