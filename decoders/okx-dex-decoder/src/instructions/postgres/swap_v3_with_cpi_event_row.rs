...
impl SwapV3WithCpiEventRow {
    pub fn from_parts(
        source: crate::instructions::swap_v3_with_cpi_event::SwapV3WithCpiEvent,
    ...
    for crate::instructions::swap_v3_with_cpi_event::SwapV3WithCpiEvent
{
    ...
    fn try_from(source: SwapV3WithCpiEventRow) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
...
impl carbon_core::postgres::operations::Insert for SwapV3WithCpiEventRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SwapV3WithCpiEventRow {
    type Key = (
        String,
...
pub struct SwapV3WithCpiEventMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SwapV3WithCpiEventMigrationOperation {
    async fn up(
        &self,
