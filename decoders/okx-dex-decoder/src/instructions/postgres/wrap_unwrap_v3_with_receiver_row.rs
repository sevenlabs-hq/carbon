...
impl WrapUnwrapV3WithReceiverRow {
    pub fn from_parts(
        source: crate::instructions::wrap_unwrap_v3_with_receiver::WrapUnwrapV3WithReceiver,
...
impl TryFrom<WrapUnwrapV3WithReceiverRow>
    for crate::instructions::wrap_unwrap_v3_with_receiver::WrapUnwrapV3WithReceiver
{
    type Error = carbon_core::error::Error;
    fn try_from(source: WrapUnwrapV3WithReceiverRow) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
        })
    }
...
impl carbon_core::postgres::operations::Insert for WrapUnwrapV3WithReceiverRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for WrapUnwrapV3WithReceiverRow {
    type Key = (
        String,
...
pub struct WrapUnwrapV3WithReceiverMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for WrapUnwrapV3WithReceiverMigrationOperation {
    async fn up(
        &self,
