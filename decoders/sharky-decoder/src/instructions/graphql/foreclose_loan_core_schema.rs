...
#[graphql(name = "ForecloseLoanCore")]
pub struct ForecloseLoanCoreGraphQL {
...
impl TryFrom<crate::instructions::postgres::ForecloseLoanCoreRow> for ForecloseLoanCoreGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ForecloseLoanCoreRow,
