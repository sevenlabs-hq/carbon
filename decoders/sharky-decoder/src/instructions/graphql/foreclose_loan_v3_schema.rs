...
#[graphql(name = "ForecloseLoanV3")]
pub struct ForecloseLoanV3GraphQL {
...
impl TryFrom<crate::instructions::postgres::ForecloseLoanV3Row> for ForecloseLoanV3GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ForecloseLoanV3Row,
