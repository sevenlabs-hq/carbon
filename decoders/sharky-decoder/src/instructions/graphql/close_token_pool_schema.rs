...
#[graphql(name = "CloseTokenPool")]
pub struct CloseTokenPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseTokenPoolRow> for CloseTokenPoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseTokenPoolRow,
