...
#[graphql(name = "CloseTokenOrderbook")]
pub struct CloseTokenOrderbookGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseTokenOrderbookRow> for CloseTokenOrderbookGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseTokenOrderbookRow,
