...
#[graphql(name = "RepayLoanV3")]
pub struct RepayLoanV3GraphQL {
...
impl TryFrom<crate::instructions::postgres::RepayLoanV3Row> for RepayLoanV3GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RepayLoanV3Row) -> Result<Self, Self::Error> {
        Ok(Self {
