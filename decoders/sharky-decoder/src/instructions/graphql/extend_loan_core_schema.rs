...
#[graphql(name = "ExtendLoanCore")]
pub struct ExtendLoanCoreGraphQL {
...
impl TryFrom<crate::instructions::postgres::ExtendLoanCoreRow> for ExtendLoanCoreGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ExtendLoanCoreRow,
