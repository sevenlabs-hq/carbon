...
#[graphql(name = "ForecloseTokenLoan")]
pub struct ForecloseTokenLoanGraphQL {
...
impl TryFrom<crate::instructions::postgres::ForecloseTokenLoanRow> for ForecloseTokenLoanGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ForecloseTokenLoanRow,
