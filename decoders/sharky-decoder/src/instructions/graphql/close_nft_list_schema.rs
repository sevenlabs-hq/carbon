...
#[graphql(name = "CloseNftList")]
pub struct CloseNftListGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseNftListRow> for CloseNftListGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseNftListRow) -> Result<Self, Self::Error> {
        Ok(Self {
