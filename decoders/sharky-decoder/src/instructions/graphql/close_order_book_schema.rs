...
#[graphql(name = "CloseOrderBook")]
pub struct CloseOrderBookGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseOrderBookRow> for CloseOrderBookGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseOrderBookRow,
