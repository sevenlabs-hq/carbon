...
#[graphql(name = "RepayTokenLoan")]
pub struct RepayTokenLoanGraphQL {
...
impl TryFrom<crate::instructions::postgres::RepayTokenLoanRow> for RepayTokenLoanGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RepayTokenLoanRow,
