...
#[graphql(name = "RescindLoan")]
pub struct RescindLoanGraphQL {
...
impl TryFrom<crate::instructions::postgres::RescindLoanRow> for RescindLoanGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RescindLoanRow) -> Result<Self, Self::Error> {
        Ok(Self {
