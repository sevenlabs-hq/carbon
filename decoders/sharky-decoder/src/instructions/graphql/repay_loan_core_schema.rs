...
#[graphql(name = "RepayLoanCore")]
pub struct RepayLoanCoreGraphQL {
...
impl TryFrom<crate::instructions::postgres::RepayLoanCoreRow> for RepayLoanCoreGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RepayLoanCoreRow) -> Result<Self, Self::Error> {
        Ok(Self {
