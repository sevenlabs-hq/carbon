...
impl ApproveStrategyRow {
    pub fn from_parts(
        _source: crate::instructions::approve_strategy::ApproveStrategy,
...
impl TryFrom<ApproveStrategyRow> for crate::instructions::approve_strategy::ApproveStrategy {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ApproveStrategyRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ApproveStrategyRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ApproveStrategyRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ApproveStrategyRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ApproveStrategyMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ApproveStrategyMigrationOperation {
    async fn up(
        &self,
