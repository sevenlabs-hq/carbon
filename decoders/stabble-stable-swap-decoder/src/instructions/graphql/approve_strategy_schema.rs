...
#[graphql(name = "ApproveStrategy")]
pub struct ApproveStrategyGraphQL {
...
impl TryFrom<crate::instructions::postgres::ApproveStrategyRow> for ApproveStrategyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ApproveStrategyRow,
