...
#[graphql(name = "Shutdown")]
pub struct ShutdownGraphQL {
...
impl TryFrom<crate::instructions::postgres::ShutdownRow> for ShutdownGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ShutdownRow) -> Result<Self, Self::Error> {
        Ok(Self {
