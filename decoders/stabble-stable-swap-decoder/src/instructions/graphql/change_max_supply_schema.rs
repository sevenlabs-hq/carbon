...
#[graphql(name = "ChangeMaxSupply")]
pub struct ChangeMaxSupplyGraphQL {
...
impl TryFrom<crate::instructions::postgres::ChangeMaxSupplyRow> for ChangeMaxSupplyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ChangeMaxSupplyRow,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            instruction_metadata: row.instruction_metadata.into(),
            new_max_supply: carbon_core::graphql::primitives::U64(*row.new_max_supply),
