...
#[graphql(name = "AcceptOwner")]
pub struct AcceptOwnerGraphQL {
...
impl TryFrom<crate::instructions::postgres::AcceptOwnerRow> for AcceptOwnerGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AcceptOwnerRow) -> Result<Self, Self::Error> {
        Ok(Self {
