...
#[graphql(name = "ChangeSwapFee")]
pub struct ChangeSwapFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::ChangeSwapFeeRow> for ChangeSwapFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ChangeSwapFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
