...
#[graphql(name = "CloseStrategy")]
pub struct CloseStrategyGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseStrategyRow> for CloseStrategyGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseStrategyRow) -> Result<Self, Self::Error> {
        Ok(Self {
