...
impl PoolRow {
    pub fn from_parts(source: crate::accounts::pool::Pool, metadata: AccountMetadata) -> Self {
        Self {
            ...
            amp_initial_factor: source.amp_initial_factor.into(),
            amp_target_factor: source.amp_target_factor.into(),
            ramp_start_ts: source.ramp_start_ts,
            ramp_stop_ts: source.ramp_stop_ts,
...
impl TryFrom<PoolRow> for crate::accounts::pool::Pool {
    ...
    fn try_from(source: PoolRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            is_active: source.is_active,
            amp_initial_factor: source.amp_initial_factor.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
            amp_target_factor: source.amp_target_factor.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
...
impl carbon_core::postgres::operations::Insert for PoolRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(self.is_active)
        .bind(self.amp_initial_factor)
        .bind(self.amp_target_factor)
        .bind(self.ramp_start_ts)
        .bind(self.ramp_stop_ts)
        .bind(&self.swap_fee)
        .bind(&self.tokens)
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pool_account (
                ...
                "amp_initial_factor" = EXCLUDED."amp_initial_factor",
                "amp_target_factor" = EXCLUDED."amp_target_factor",
                "ramp_start_ts" = EXCLUDED."ramp_start_ts",
                "ramp_stop_ts" = EXCLUDED."ramp_stop_ts",
    ...
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pool_account (
                ...
                "amp_initial_factor" INT4 NOT NULL,
                "amp_target_factor" INT4 NOT NULL,
                "ramp_start_ts" INT8 NOT NULL,
                "ramp_stop_ts" INT8 NOT NULL,
