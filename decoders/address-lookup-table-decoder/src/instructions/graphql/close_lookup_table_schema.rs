...
#[graphql(name = "CloseLookupTable")]
pub struct CloseLookupTableGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseLookupTableRow> for CloseLookupTableGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseLookupTableRow,
