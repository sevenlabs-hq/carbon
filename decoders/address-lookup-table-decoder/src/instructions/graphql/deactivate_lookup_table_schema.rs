...
#[graphql(name = "DeactivateLookupTable")]
pub struct DeactivateLookupTableGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeactivateLookupTableRow>
    for DeactivateLookupTableGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeactivateLookupTableRow,
