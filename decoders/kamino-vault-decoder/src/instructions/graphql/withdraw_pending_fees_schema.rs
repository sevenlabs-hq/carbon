...
#[graphql(name = "WithdrawPendingFees")]
pub struct WithdrawPendingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawPendingFeesRow> for WithdrawPendingFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawPendingFeesRow,
