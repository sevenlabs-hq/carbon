...
impl TryFrom<crate::instructions::postgres::InvestRow> for InvestGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::InvestRow) -> Result<Self, Self::Error> {
        Ok(Self {
