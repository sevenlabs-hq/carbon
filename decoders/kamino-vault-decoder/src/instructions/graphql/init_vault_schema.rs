...
#[graphql(name = "InitVault")]
pub struct InitVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitVaultRow> for InitVaultGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::InitVaultRow) -> Result<Self, Self::Error> {
        Ok(Self {
