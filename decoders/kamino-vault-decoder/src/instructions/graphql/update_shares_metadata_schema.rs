...
#[graphql(name = "UpdateSharesMetadata")]
pub struct UpdateSharesMetadataGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateSharesMetadataRow>
    for UpdateSharesMetadataGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateSharesMetadataRow,
