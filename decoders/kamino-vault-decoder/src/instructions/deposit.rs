...
impl carbon_core::deserialize::ArrangeAccounts for Deposit {
    ...
    fn arrange_accounts(
        ...
        let [user, vault_state, token_vault, token_mint, base_vault_authority, shares_mint, user_token_ata, user_shares_ata, klend_program, token_program, shares_token_program] =
            accounts
        else {
            return None;
        };
