...
impl InitVaultRow {
    pub fn from_parts(
        _source: crate::instructions::init_vault::InitVault,
...
impl TryFrom<InitVaultRow> for crate::instructions::init_vault::InitVault {
    type Error = carbon_core::error::Error;
    fn try_from(_source: InitVaultRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for InitVaultRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitVaultRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitVaultRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitVaultMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitVaultMigrationOperation {
    async fn up(
        &self,
