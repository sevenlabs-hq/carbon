...
impl InitializeSharesMetadataRow {
    pub fn from_parts(
        source: crate::instructions::initialize_shares_metadata::InitializeSharesMetadata,
...
impl TryFrom<InitializeSharesMetadataRow>
    for crate::instructions::initialize_shares_metadata::InitializeSharesMetadata
{
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializeSharesMetadataRow) -> Result<Self, Self::Error> {
        Ok(Self {
            name: source.name,
            symbol: source.symbol,
            uri: source.uri,
...
impl carbon_core::postgres::operations::Insert for InitializeSharesMetadataRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeSharesMetadataRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeSharesMetadataRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeSharesMetadataMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializeSharesMetadataMigrationOperation {
    async fn up(
        &self,
