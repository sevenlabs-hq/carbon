...
impl UpdateReserveAllocationRow {
    pub fn from_parts(
        source: crate::instructions::update_reserve_allocation::UpdateReserveAllocation,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            weight: source.weight.into(),
            cap: source.cap.into(),
    ...
    for crate::instructions::update_reserve_allocation::UpdateReserveAllocation
{
    ...
    fn try_from(source: UpdateReserveAllocationRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdateReserveAllocationRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateReserveAllocationRow {
    type Key = (
        String,
...
pub struct UpdateReserveAllocationMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateReserveAllocationMigrationOperation {
    async fn up(
        &self,
