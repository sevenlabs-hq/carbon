...
impl TryFrom<crate::instructions::postgres::RedeemRow> for RedeemGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RedeemRow) -> Result<Self, Self::Error> {
        Ok(Self {
