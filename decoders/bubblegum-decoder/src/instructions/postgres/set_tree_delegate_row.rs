...
impl SetTreeDelegateRow {
    pub fn from_parts(
        _source: crate::instructions::set_tree_delegate::SetTreeDelegate,
...
impl TryFrom<SetTreeDelegateRow> for crate::instructions::set_tree_delegate::SetTreeDelegate {
    type Error = carbon_core::error::Error;
    fn try_from(_source: SetTreeDelegateRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SetTreeDelegateRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetTreeDelegateRow {
    type Key = (
        String,
...
pub struct SetTreeDelegateMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetTreeDelegateMigrationOperation {
    async fn up(
        &self,
