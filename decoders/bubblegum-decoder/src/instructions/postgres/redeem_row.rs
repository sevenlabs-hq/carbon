...
impl RedeemRow {
    pub fn from_parts(
        source: crate::instructions::redeem::Redeem,
...
impl TryFrom<RedeemRow> for crate::instructions::redeem::Redeem {
    type Error = carbon_core::error::Error;
    fn try_from(source: RedeemRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for RedeemRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RedeemRow {
    type Key = (
        String,
...
pub struct RedeemMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RedeemMigrationOperation {
    async fn up(
        &self,
