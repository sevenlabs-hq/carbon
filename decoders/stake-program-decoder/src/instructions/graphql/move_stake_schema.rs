...
#[graphql(name = "MoveStake")]
pub struct MoveStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::MoveStakeRow> for MoveStakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::MoveStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
