...
#[graphql(name = "GetMinimumDelegation")]
pub struct GetMinimumDelegationGraphQL {
...
impl TryFrom<crate::instructions::postgres::GetMinimumDelegationRow>
    for GetMinimumDelegationGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::GetMinimumDelegationRow,
