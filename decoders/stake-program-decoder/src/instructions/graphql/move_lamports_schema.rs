...
#[graphql(name = "MoveLamports")]
pub struct MoveLamportsGraphQL {
...
impl TryFrom<crate::instructions::postgres::MoveLamportsRow> for MoveLamportsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::MoveLamportsRow) -> Result<Self, Self::Error> {
        Ok(Self {
