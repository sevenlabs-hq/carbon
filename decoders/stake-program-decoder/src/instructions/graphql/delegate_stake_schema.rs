...
#[graphql(name = "DelegateStake")]
pub struct DelegateStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::DelegateStakeRow> for DelegateStakeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DelegateStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
