...
#[graphql(name = "InitializeChecked")]
pub struct InitializeCheckedGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeCheckedRow> for InitializeCheckedGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeCheckedRow,
