...
#[graphql(name = "DeactivateDelinquent")]
pub struct DeactivateDelinquentGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeactivateDelinquentRow>
    for DeactivateDelinquentGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeactivateDelinquentRow,
