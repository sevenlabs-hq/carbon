...
#[graphql(name = "Deactivate")]
pub struct DeactivateGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeactivateRow> for DeactivateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DeactivateRow) -> Result<Self, Self::Error> {
        Ok(Self {
