...
#[carbon(discriminator = "0xd73c3d2e723780b0")]
pub struct DepositForBurn {
    pub params: DepositForBurnParams,
}

#[derive(Debug, PartialEq, Eq, Clone, Hash, serde::Serialize, serde::Deserialize)]
pub struct DepositForBurnInstructionAccounts {
...
impl carbon_core::deserialize::ArrangeAccounts for DepositForBurn {
    type ArrangedAccounts = DepositForBurnInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(DepositForBurnInstructionAccounts {
            owner,
            event_rent_payer,
