...
impl CarbonDeserialize for DepositForBurnWithHook {
    const DISCRIMINATOR: &'static [u8] = &[111, 245, 62, 131, 204, 108, 223, 155];
...
impl ArrangeAccounts for DepositForBurnWithHook {
