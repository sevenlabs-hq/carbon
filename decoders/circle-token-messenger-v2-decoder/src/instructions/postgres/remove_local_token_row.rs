...
use {
    crate::types::RemoveLocalTokenParams,
...
pub struct RemoveLocalTokenRow {
    ...
    pub params: sqlx::types::Json<RemoveLocalTokenParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl RemoveLocalTokenRow {
    pub fn from_parts(
        source: crate::instructions::remove_local_token::RemoveLocalToken,
...
impl TryFrom<RemoveLocalTokenRow> for crate::instructions::remove_local_token::RemoveLocalToken {
    type Error = carbon_core::error::Error;
    fn try_from(source: RemoveLocalTokenRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for RemoveLocalTokenRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RemoveLocalTokenRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for RemoveLocalTokenRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct RemoveLocalTokenMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RemoveLocalTokenMigrationOperation {
    async fn up(
        &self,
