...
pub struct UpdateDenylisterRow {
    ...
    pub params: sqlx::types::Json<UpdateDenylisterParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl UpdateDenylisterRow {
    pub fn from_parts(
        source: crate::instructions::update_denylister::UpdateDenylister,
...
impl TryFrom<UpdateDenylisterRow> for crate::instructions::update_denylister::UpdateDenylister {
    type Error = carbon_core::error::Error;
    fn try_from(source: UpdateDenylisterRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdateDenylisterRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateDenylisterRow {
    type Key = (
        String,
...
pub struct UpdateDenylisterMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateDenylisterMigrationOperation {
    async fn up(
        &self,
