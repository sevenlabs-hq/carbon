...
pub struct SetMaxBurnAmountPerMessageRow {
    ...
    pub params: sqlx::types::Json<SetMaxBurnAmountPerMessageParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl SetMaxBurnAmountPerMessageRow {
    pub fn from_parts(
        source: crate::instructions::set_max_burn_amount_per_message::SetMaxBurnAmountPerMessage,
...
impl TryFrom<SetMaxBurnAmountPerMessageRow>
    for crate::instructions::set_max_burn_amount_per_message::SetMaxBurnAmountPerMessage
{
    type Error = carbon_core::error::Error;
    fn try_from(source: SetMaxBurnAmountPerMessageRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetMaxBurnAmountPerMessageRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetMaxBurnAmountPerMessageRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetMaxBurnAmountPerMessageRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetMaxBurnAmountPerMessageMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetMaxBurnAmountPerMessageMigrationOperation {
    async fn up(
        &self,
