...
impl HandleReceiveUnfinalizedMessageRow {
    pub fn from_parts(
        source: crate::instructions::handle_receive_unfinalized_message::HandleReceiveUnfinalizedMessage,
...
impl TryFrom<HandleReceiveUnfinalizedMessageRow>
    for crate::instructions::handle_receive_unfinalized_message::HandleReceiveUnfinalizedMessage
{
    type Error = carbon_core::error::Error;
    fn try_from(source: HandleReceiveUnfinalizedMessageRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for HandleReceiveUnfinalizedMessageRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for HandleReceiveUnfinalizedMessageRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for HandleReceiveUnfinalizedMessageRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct HandleReceiveUnfinalizedMessageMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for HandleReceiveUnfinalizedMessageMigrationOperation
{
    async fn up(
        &self,
