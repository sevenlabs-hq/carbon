...
pub struct SetTokenControllerRow {
    ...
    pub params: sqlx::types::Json<SetTokenControllerParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl SetTokenControllerRow {
    pub fn from_parts(
        source: crate::instructions::set_token_controller::SetTokenController,
    ...
    for crate::instructions::set_token_controller::SetTokenController
{
    ...
    fn try_from(source: SetTokenControllerRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetTokenControllerRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetTokenControllerRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetTokenControllerRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetTokenControllerMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetTokenControllerMigrationOperation {
    async fn up(
        &self,
