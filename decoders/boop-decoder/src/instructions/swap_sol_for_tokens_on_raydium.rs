...
impl CarbonDeserialize for SwapSolForTokensOnRaydium {
    const DISCRIMINATOR: &'static [u8] = &[107, 248, 131, 239, 152, 234, 54, 35];
...
impl ArrangeAccounts for SwapSolForTokensOnRaydium {
