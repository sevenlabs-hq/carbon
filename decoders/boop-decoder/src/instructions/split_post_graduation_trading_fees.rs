...
pub struct SplitPostGraduationTradingFees {}

#[derive(Debug, Clone, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SplitPostGraduationTradingFeesInstructionAccounts {
...
impl CarbonDeserialize for SplitPostGraduationTradingFees {
    const DISCRIMINATOR: &'static [u8] = &[241, 178, 177, 69, 38, 187, 58, 176];
...
impl ArrangeAccounts for SplitPostGraduationTradingFees {
    type ArrangedAccounts = SplitPostGraduationTradingFeesInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(SplitPostGraduationTradingFeesInstructionAccounts {
            operator,
            mint,
            wsol,
            config,
