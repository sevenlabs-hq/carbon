...
impl CarbonDeserialize for Graduate {
    const DISCRIMINATOR: &'static [u8] = &[45, 235, 225, 181, 17, 218, 64, 130];
...
impl ArrangeAccounts for Graduate {
    ...
    fn arrange_accounts(
        ...
        let token_distributor = next_account(&mut iter)?;
        let token_distributor_token_account = next_account(&mut iter)?;
        ...
        let bonding_curve_wsol_account = next_account(&mut iter)?;
