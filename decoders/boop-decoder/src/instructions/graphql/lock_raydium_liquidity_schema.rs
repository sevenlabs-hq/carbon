...
#[graphql(name = "LockRaydiumLiquidity")]
pub struct LockRaydiumLiquidityGraphQL {
...
impl TryFrom<crate::instructions::postgres::LockRaydiumLiquidityRow>
    for LockRaydiumLiquidityGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LockRaydiumLiquidityRow,
