...
#[graphql(name = "CancelAuthorityTransfer")]
pub struct CancelAuthorityTransferGraphQL {
...
impl TryFrom<crate::instructions::postgres::CancelAuthorityTransferRow>
    for CancelAuthorityTransferGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CancelAuthorityTransferRow,
