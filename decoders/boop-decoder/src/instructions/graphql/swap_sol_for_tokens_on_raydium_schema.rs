...
#[graphql(name = "SwapSolForTokensOnRaydium")]
pub struct SwapSolForTokensOnRaydiumGraphQL {
...
impl TryFrom<crate::instructions::postgres::SwapSolForTokensOnRaydiumRow>
    for SwapSolForTokensOnRaydiumGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SwapSolForTokensOnRaydiumRow,
