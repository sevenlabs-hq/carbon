...
impl TryFrom<crate::instructions::postgres::CreateTokenRow> for CreateTokenGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CreateTokenRow) -> Result<Self, Self::Error> {
        Ok(Self {
