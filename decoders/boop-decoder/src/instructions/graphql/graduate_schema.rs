...
#[graphql(name = "Graduate")]
pub struct GraduateGraphQL {
...
impl TryFrom<crate::instructions::postgres::GraduateRow> for GraduateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::GraduateRow) -> Result<Self, Self::Error> {
        Ok(Self {
