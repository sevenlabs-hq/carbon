...
#[graphql(name = "DeployBondingCurve")]
pub struct DeployBondingCurveGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeployBondingCurveRow> for DeployBondingCurveGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeployBondingCurveRow,
