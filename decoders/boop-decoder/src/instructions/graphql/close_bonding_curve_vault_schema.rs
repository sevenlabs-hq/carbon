...
#[graphql(name = "CloseBondingCurveVault")]
pub struct CloseBondingCurveVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseBondingCurveVaultRow>
    for CloseBondingCurveVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseBondingCurveVaultRow,
