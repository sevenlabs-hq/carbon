...
#[graphql(name = "CreateTokenFallback")]
pub struct CreateTokenFallbackGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateTokenFallbackRow> for CreateTokenFallbackGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateTokenFallbackRow,
