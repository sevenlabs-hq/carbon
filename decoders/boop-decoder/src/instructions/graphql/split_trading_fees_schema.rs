...
#[graphql(name = "SplitTradingFees")]
pub struct SplitTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::SplitTradingFeesRow> for SplitTradingFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SplitTradingFeesRow,
