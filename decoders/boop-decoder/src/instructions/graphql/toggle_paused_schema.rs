...
#[graphql(name = "TogglePaused")]
pub struct TogglePausedGraphQL {
...
impl TryFrom<crate::instructions::postgres::TogglePausedRow> for TogglePausedGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::TogglePausedRow) -> Result<Self, Self::Error> {
        Ok(Self {
