...
#[graphql(name = "SwapTokensForSolOnRaydium")]
pub struct SwapTokensForSolOnRaydiumGraphQL {
...
impl TryFrom<crate::instructions::postgres::SwapTokensForSolOnRaydiumRow>
    for SwapTokensForSolOnRaydiumGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SwapTokensForSolOnRaydiumRow,
