...
#[graphql(name = "CreateMeteoraPool")]
pub struct CreateMeteoraPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateMeteoraPoolRow> for CreateMeteoraPoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateMeteoraPoolRow,
