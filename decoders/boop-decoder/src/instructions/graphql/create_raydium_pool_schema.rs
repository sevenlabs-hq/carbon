...
#[graphql(name = "CreateRaydiumPool")]
pub struct CreateRaydiumPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateRaydiumPoolRow> for CreateRaydiumPoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateRaydiumPoolRow,
