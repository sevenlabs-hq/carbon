...
#[graphql(name = "CollectTradingFees")]
pub struct CollectTradingFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectTradingFeesRow> for CollectTradingFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectTradingFeesRow,
