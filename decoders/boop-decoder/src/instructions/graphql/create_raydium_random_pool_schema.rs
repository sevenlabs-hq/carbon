...
#[graphql(name = "CreateRaydiumRandomPool")]
pub struct CreateRaydiumRandomPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateRaydiumRandomPoolRow>
    for CreateRaydiumRandomPoolGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateRaydiumRandomPoolRow,
