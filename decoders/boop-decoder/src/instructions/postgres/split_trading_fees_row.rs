...
impl SplitTradingFeesRow {
    pub fn from_parts(
        _source: crate::instructions::split_trading_fees::SplitTradingFees,
...
impl TryFrom<SplitTradingFeesRow> for crate::instructions::split_trading_fees::SplitTradingFees {
    type Error = carbon_core::error::Error;
    fn try_from(_source: SplitTradingFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SplitTradingFeesRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SplitTradingFeesRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SplitTradingFeesRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SplitTradingFeesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SplitTradingFeesMigrationOperation {
    async fn up(
        &self,
