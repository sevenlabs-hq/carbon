...
impl CollectTradingFeesRow {
    pub fn from_parts(
        _source: crate::instructions::collect_trading_fees::CollectTradingFees,
    ...
    for crate::instructions::collect_trading_fees::CollectTradingFees
{
    ...
    fn try_from(_source: CollectTradingFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CollectTradingFeesRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CollectTradingFeesRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CollectTradingFeesRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CollectTradingFeesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectTradingFeesMigrationOperation {
    async fn up(
        &self,
