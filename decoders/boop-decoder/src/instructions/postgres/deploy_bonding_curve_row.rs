...
impl DeployBondingCurveRow {
    pub fn from_parts(
        source: crate::instructions::deploy_bonding_curve::DeployBondingCurve,
    ...
    for crate::instructions::deploy_bonding_curve::DeployBondingCurve
{
    ...
    fn try_from(source: DeployBondingCurveRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for DeployBondingCurveRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DeployBondingCurveRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for DeployBondingCurveRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct DeployBondingCurveMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for DeployBondingCurveMigrationOperation {
    async fn up(
        &self,
