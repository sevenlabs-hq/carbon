...
impl CollectMeteoraTradingFeesV2Row {
    pub fn from_parts(
        _source: crate::instructions::collect_meteora_trading_fees_v2::CollectMeteoraTradingFeesV2,
...
impl TryFrom<CollectMeteoraTradingFeesV2Row>
    for crate::instructions::collect_meteora_trading_fees_v2::CollectMeteoraTradingFeesV2
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: CollectMeteoraTradingFeesV2Row) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CollectMeteoraTradingFeesV2Row {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CollectMeteoraTradingFeesV2Row {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CollectMeteoraTradingFeesV2Row {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CollectMeteoraTradingFeesV2MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectMeteoraTradingFeesV2MigrationOperation {
    async fn up(
        &self,
