...
impl CreateTokenRow {
    pub fn from_parts(
        source: crate::instructions::create_token::CreateToken,
...
impl TryFrom<CreateTokenRow> for crate::instructions::create_token::CreateToken {
    type Error = carbon_core::error::Error;
    fn try_from(source: CreateTokenRow) -> Result<Self, Self::Error> {
        Ok(Self {
            salt: *source.salt,
            name: source.name,
            symbol: source.symbol,
...
impl carbon_core::postgres::operations::Insert for CreateTokenRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CreateTokenRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CreateTokenRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CreateTokenMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CreateTokenMigrationOperation {
    async fn up(
        &self,
