...
impl SwapBaseInputRow {
    pub fn from_parts(
        source: crate::instructions::swap_base_input::SwapBaseInput,
...
impl TryFrom<SwapBaseInputRow> for crate::instructions::swap_base_input::SwapBaseInput {
    type Error = carbon_core::error::Error;
    fn try_from(source: SwapBaseInputRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SwapBaseInputRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SwapBaseInputRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SwapBaseInputRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SwapBaseInputMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SwapBaseInputMigrationOperation {
    async fn up(
        &self,
