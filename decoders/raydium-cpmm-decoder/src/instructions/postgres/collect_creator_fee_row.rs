...
impl carbon_core::postgres::operations::Insert for CollectCreatorFeeRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO raydium_cpmm_collect_creator_fee_instruction (
...
impl carbon_core::postgres::operations::Upsert for CollectCreatorFeeRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO raydium_cpmm_collect_creator_fee_instruction (
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5
            ) ON CONFLICT (
...
impl carbon_core::postgres::operations::Delete for CollectCreatorFeeRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM raydium_cpmm_collect_creator_fee_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for CollectCreatorFeeRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM raydium_cpmm_collect_creator_fee_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
pub struct CollectCreatorFeeMigrationOperation;
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CollectCreatorFeeMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS raydium_cpmm_collect_creator_fee_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS raydium_cpmm_collect_creator_fee_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
