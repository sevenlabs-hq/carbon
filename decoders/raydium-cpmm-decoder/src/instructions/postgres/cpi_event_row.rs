...
impl CpiEventRow {
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                CpiEvent::LpChangeEvent(_) => "lp_change_event".to_string(),
...
impl carbon_core::postgres::operations::Insert for CpiEventRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO raydium_cpmm_cpi_events (
...
impl carbon_core::postgres::operations::Upsert for CpiEventRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO raydium_cpmm_cpi_events (
            __signature, __instruction_index, __stack_height, __slot, "name", "data", __accounts
        ) VALUES (
            $1, $2, $3, $4, $5, $6, $7
...
impl carbon_core::postgres::operations::Delete for CpiEventRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM raydium_cpmm_cpi_events WHERE
...
impl carbon_core::postgres::operations::Lookup for CpiEventRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM raydium_cpmm_cpi_events WHERE
            __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
        "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CpiEventMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS raydium_cpmm_cpi_events (
            -- Instruction data
            "name" TEXT NOT NULL,
            "data" JSONB NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS raydium_cpmm_cpi_events"#)
            .execute(connection)
            .await?;
        Ok(())
    }
