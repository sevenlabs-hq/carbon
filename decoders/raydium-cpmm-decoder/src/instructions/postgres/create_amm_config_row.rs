...
impl carbon_core::postgres::operations::Insert for CreateAmmConfigRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO raydium_cpmm_create_amm_config_instruction (
                "index",
                "trade_fee_rate",
                "protocol_fee_rate",
                "fund_fee_rate",
...
impl carbon_core::postgres::operations::Upsert for CreateAmmConfigRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO raydium_cpmm_create_amm_config_instruction (
                "index",
                "trade_fee_rate",
                "protocol_fee_rate",
                "fund_fee_rate",
...
impl carbon_core::postgres::operations::Delete for CreateAmmConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM raydium_cpmm_create_amm_config_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for CreateAmmConfigRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM raydium_cpmm_create_amm_config_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CreateAmmConfigMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS raydium_cpmm_create_amm_config_instruction (
                -- Instruction data
                "index" INT4 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS raydium_cpmm_create_amm_config_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
