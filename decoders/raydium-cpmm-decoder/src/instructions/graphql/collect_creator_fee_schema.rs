...
#[graphql(name = "CollectCreatorFee")]
pub struct CollectCreatorFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectCreatorFeeRow> for CollectCreatorFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectCreatorFeeRow,
