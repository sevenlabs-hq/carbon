...
#[graphql(name = "CreatePermissionPda")]
pub struct CreatePermissionPdaGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreatePermissionPdaRow> for CreatePermissionPdaGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreatePermissionPdaRow,
