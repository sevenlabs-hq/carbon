...
#[graphql(name = "ClosePermissionPda")]
pub struct ClosePermissionPdaGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePermissionPdaRow> for ClosePermissionPdaGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePermissionPdaRow,
