...
#[graphql(name = "SwapBaseInput")]
pub struct SwapBaseInputGraphQL {
...
impl TryFrom<crate::instructions::postgres::SwapBaseInputRow> for SwapBaseInputGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SwapBaseInputRow) -> Result<Self, Self::Error> {
        Ok(Self {
