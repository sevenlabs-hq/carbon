...
#[graphql(name = "SwapBaseOutput")]
pub struct SwapBaseOutputGraphQL {
...
impl TryFrom<crate::instructions::postgres::SwapBaseOutputRow> for SwapBaseOutputGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SwapBaseOutputRow,
