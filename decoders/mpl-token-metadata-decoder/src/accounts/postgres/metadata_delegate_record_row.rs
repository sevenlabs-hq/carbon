...
impl carbon_core::postgres::operations::Insert for MetadataDelegateRecordRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO mpl_token_metadata_metadata_delegate_record_account (
                "key",
                "bump",
                "mint",
                "delegate",
...
impl carbon_core::postgres::operations::Upsert for MetadataDelegateRecordRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO mpl_token_metadata_metadata_delegate_record_account (
                "key",
                "bump",
                "mint",
                "delegate",
...
impl carbon_core::postgres::operations::Delete for MetadataDelegateRecordRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM mpl_token_metadata_metadata_delegate_record_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for MetadataDelegateRecordRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM mpl_token_metadata_metadata_delegate_record_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for MetadataDelegateRecordMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS mpl_token_metadata_metadata_delegate_record_account (
                -- Account data
                "key" JSONB NOT NULL,
                "bump" INT2 NOT NULL,
                "mint" BYTEA NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS mpl_token_metadata_metadata_delegate_record_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
