...
impl CloseAccountsRow {
    pub fn from_parts(
        _source: crate::instructions::close_accounts::CloseAccounts,
...
impl TryFrom<CloseAccountsRow> for crate::instructions::close_accounts::CloseAccounts {
    type Error = carbon_core::error::Error;
    fn try_from(_source: CloseAccountsRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CloseAccountsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CloseAccountsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CloseAccountsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CloseAccountsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseAccountsMigrationOperation {
    async fn up(
        &self,
