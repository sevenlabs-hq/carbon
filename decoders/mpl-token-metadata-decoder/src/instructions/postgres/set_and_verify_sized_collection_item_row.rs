...
impl SetAndVerifySizedCollectionItemRow {
    pub fn from_parts(
        _source: crate::instructions::set_and_verify_sized_collection_item::SetAndVerifySizedCollectionItem,
...
impl TryFrom<SetAndVerifySizedCollectionItemRow>
    for crate::instructions::set_and_verify_sized_collection_item::SetAndVerifySizedCollectionItem
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: SetAndVerifySizedCollectionItemRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SetAndVerifySizedCollectionItemRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetAndVerifySizedCollectionItemRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetAndVerifySizedCollectionItemRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetAndVerifySizedCollectionItemMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for SetAndVerifySizedCollectionItemMigrationOperation
{
    async fn up(
        &self,
