...
impl DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRow {
    pub fn from_parts(
        _source: crate::instructions::deprecated_mint_new_edition_from_master_edition_via_printing_token::DeprecatedMintNewEditionFromMasterEditionViaPrintingToken,
...
impl TryFrom<DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRow> for crate::instructions::deprecated_mint_new_edition_from_master_edition_via_printing_token::DeprecatedMintNewEditionFromMasterEditionViaPrintingToken {
    type Error = carbon_core::error::Error;
    fn try_from(_source: DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
pub struct DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenMigrationOperation
{
    async fn up(
        &self,
