...
pub struct DelegateRow {
    ...
    pub delegate_args: sqlx::types::Json<DelegateArgs>,
...
impl DelegateRow {
    pub fn from_parts(
        ...
        Self {
            ...
            delegate_args: sqlx::types::Json(source.delegate_args),
...
impl TryFrom<DelegateRow> for crate::instructions::delegate::Delegate {
    ...
    fn try_from(source: DelegateRow) -> Result<Self, Self::Error> {
        Ok(Self {
            delegate_args: source.delegate_args.0,
        })
    }
}
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO delegate_instruction (
                ...
                "delegate_args" = EXCLUDED."delegate_args",
