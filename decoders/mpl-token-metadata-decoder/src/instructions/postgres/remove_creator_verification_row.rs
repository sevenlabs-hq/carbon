...
impl RemoveCreatorVerificationRow {
    pub fn from_parts(
        _source: crate::instructions::remove_creator_verification::RemoveCreatorVerification,
...
impl TryFrom<RemoveCreatorVerificationRow>
    for crate::instructions::remove_creator_verification::RemoveCreatorVerification
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: RemoveCreatorVerificationRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for RemoveCreatorVerificationRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RemoveCreatorVerificationRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for RemoveCreatorVerificationRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct RemoveCreatorVerificationMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RemoveCreatorVerificationMigrationOperation {
    async fn up(
        &self,
