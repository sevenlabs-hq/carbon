...
impl ThawDelegatedAccountRow {
    pub fn from_parts(
        _source: crate::instructions::thaw_delegated_account::ThawDelegatedAccount,
    ...
    for crate::instructions::thaw_delegated_account::ThawDelegatedAccount
{
    ...
    fn try_from(_source: ThawDelegatedAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ThawDelegatedAccountRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ThawDelegatedAccountRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ThawDelegatedAccountRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ThawDelegatedAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ThawDelegatedAccountMigrationOperation {
    async fn up(
        &self,
