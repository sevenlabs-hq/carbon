...
pub struct CreateRow {
    ...
    pub create_args: sqlx::types::Json<CreateArgs>,
...
impl CreateRow {
    pub fn from_parts(
        ...
        Self {
            ...
            create_args: sqlx::types::Json(source.create_args),
...
impl TryFrom<CreateRow> for crate::instructions::create::Create {
    ...
    fn try_from(source: CreateRow) -> Result<Self, Self::Error> {
        Ok(Self {
            create_args: source.create_args.0,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for CreateRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO mpl_token_metadata_create_instruction (
                "create_args",
...
impl carbon_core::postgres::operations::Upsert for CreateRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO mpl_token_metadata_create_instruction (
                "create_args",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5, $6
                ...
                "create_args" = EXCLUDED."create_args",
...
impl carbon_core::postgres::operations::Delete for CreateRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM mpl_token_metadata_create_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for CreateRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM mpl_token_metadata_create_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CreateMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS mpl_token_metadata_create_instruction (
                -- Instruction data
                "create_args" JSONB NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS mpl_token_metadata_create_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
