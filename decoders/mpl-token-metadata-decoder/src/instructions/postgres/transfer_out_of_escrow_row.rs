...
pub struct TransferOutOfEscrowRow {
    ...
    pub transfer_out_of_escrow_args: sqlx::types::Json<TransferOutOfEscrowArgs>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl TransferOutOfEscrowRow {
    pub fn from_parts(
        source: crate::instructions::transfer_out_of_escrow::TransferOutOfEscrow,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            transfer_out_of_escrow_args: sqlx::types::Json(source.transfer_out_of_escrow_args),
    ...
    for crate::instructions::transfer_out_of_escrow::TransferOutOfEscrow
{
    ...
    fn try_from(source: TransferOutOfEscrowRow) -> Result<Self, Self::Error> {
        Ok(Self {
            transfer_out_of_escrow_args: source.transfer_out_of_escrow_args.0,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for TransferOutOfEscrowRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(&self.transfer_out_of_escrow_args)
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO transfer_out_of_escrow_instruction (
                ...
                "transfer_out_of_escrow_args" = EXCLUDED."transfer_out_of_escrow_args",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TransferOutOfEscrowRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TransferOutOfEscrowRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TransferOutOfEscrowMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TransferOutOfEscrowMigrationOperation {
    async fn up(
        &self,
