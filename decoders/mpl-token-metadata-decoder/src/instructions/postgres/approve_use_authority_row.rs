...
use {
    crate::types::ApproveUseAuthorityArgs,
...
pub struct ApproveUseAuthorityRow {
    ...
    pub approve_use_authority_args: sqlx::types::Json<ApproveUseAuthorityArgs>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl ApproveUseAuthorityRow {
    pub fn from_parts(
        source: crate::instructions::approve_use_authority::ApproveUseAuthority,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            approve_use_authority_args: sqlx::types::Json(source.approve_use_authority_args),
    ...
    for crate::instructions::approve_use_authority::ApproveUseAuthority
{
    ...
    fn try_from(source: ApproveUseAuthorityRow) -> Result<Self, Self::Error> {
        Ok(Self {
            approve_use_authority_args: source.approve_use_authority_args.0,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for ApproveUseAuthorityRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(&self.approve_use_authority_args)
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO approve_use_authority_instruction (
                ...
                "approve_use_authority_args" = EXCLUDED."approve_use_authority_args",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ApproveUseAuthorityRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ApproveUseAuthorityRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ApproveUseAuthorityMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ApproveUseAuthorityMigrationOperation {
    async fn up(
        &self,
