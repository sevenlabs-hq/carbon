...
impl carbon_core::deserialize::ArrangeAccounts for Migrate {
    ...
    fn arrange_accounts(
        ...
        let [metadata, edition, token, token_owner, mint, payer, authority, collection_metadata, delegate_record, token_record, system_program, sysvar_instructions, spl_token_program, authorization_rules_program, authorization_rules] =
            accounts
        else {
            return None;
        };
