...
#[graphql(name = "CreateMetadataAccountV2")]
pub struct CreateMetadataAccountV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateMetadataAccountV2Row>
    for CreateMetadataAccountV2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateMetadataAccountV2Row,
