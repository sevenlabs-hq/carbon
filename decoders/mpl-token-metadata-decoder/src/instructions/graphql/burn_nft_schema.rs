...
#[graphql(name = "BurnNft")]
pub struct BurnNftGraphQL {
...
impl TryFrom<crate::instructions::postgres::BurnNftRow> for BurnNftGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::BurnNftRow) -> Result<Self, Self::Error> {
        Ok(Self {
