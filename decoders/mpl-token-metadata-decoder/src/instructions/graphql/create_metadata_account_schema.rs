...
#[graphql(name = "CreateMetadataAccount")]
pub struct CreateMetadataAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateMetadataAccountRow>
    for CreateMetadataAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateMetadataAccountRow,
