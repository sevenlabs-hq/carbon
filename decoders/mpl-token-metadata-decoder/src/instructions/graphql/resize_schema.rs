...
impl TryFrom<crate::instructions::postgres::ResizeRow> for ResizeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ResizeRow) -> Result<Self, Self::Error> {
        Ok(Self {
