...
#[graphql(name = "Collect")]
pub struct CollectGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectRow> for CollectGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CollectRow) -> Result<Self, Self::Error> {
        Ok(Self {
