...
#[graphql(name = "UpdateMetadataAccount")]
pub struct UpdateMetadataAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateMetadataAccountRow>
    for UpdateMetadataAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateMetadataAccountRow,
