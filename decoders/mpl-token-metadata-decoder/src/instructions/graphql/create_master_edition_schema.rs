...
#[graphql(name = "CreateMasterEdition")]
pub struct CreateMasterEditionGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateMasterEditionRow> for CreateMasterEditionGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateMasterEditionRow,
