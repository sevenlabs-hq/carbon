...
#[graphql(name = "BurnEditionNft")]
pub struct BurnEditionNftGraphQL {
...
impl TryFrom<crate::instructions::postgres::BurnEditionNftRow> for BurnEditionNftGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::BurnEditionNftRow,
