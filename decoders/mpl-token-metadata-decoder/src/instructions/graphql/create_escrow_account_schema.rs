...
#[graphql(name = "CreateEscrowAccount")]
pub struct CreateEscrowAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateEscrowAccountRow> for CreateEscrowAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateEscrowAccountRow,
