...
#[graphql(name = "SetTokenStandard")]
pub struct SetTokenStandardGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetTokenStandardRow> for SetTokenStandardGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetTokenStandardRow,
