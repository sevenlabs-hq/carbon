...
#[graphql(name = "CloseEscrowAccount")]
pub struct CloseEscrowAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseEscrowAccountRow> for CloseEscrowAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseEscrowAccountRow,
