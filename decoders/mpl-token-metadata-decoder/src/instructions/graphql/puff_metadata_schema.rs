...
#[graphql(name = "PuffMetadata")]
pub struct PuffMetadataGraphQL {
...
impl TryFrom<crate::instructions::postgres::PuffMetadataRow> for PuffMetadataGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::PuffMetadataRow) -> Result<Self, Self::Error> {
        Ok(Self {
