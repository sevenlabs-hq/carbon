...
#[graphql(name = "CloseAccounts")]
pub struct CloseAccountsGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseAccountsRow> for CloseAccountsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseAccountsRow) -> Result<Self, Self::Error> {
        Ok(Self {
