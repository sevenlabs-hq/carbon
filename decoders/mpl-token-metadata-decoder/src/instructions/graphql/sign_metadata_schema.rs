...
#[graphql(name = "SignMetadata")]
pub struct SignMetadataGraphQL {
...
impl TryFrom<crate::instructions::postgres::SignMetadataRow> for SignMetadataGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SignMetadataRow) -> Result<Self, Self::Error> {
        Ok(Self {
