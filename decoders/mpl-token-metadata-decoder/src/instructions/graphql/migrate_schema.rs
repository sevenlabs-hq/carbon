...
#[graphql(name = "Migrate")]
pub struct MigrateGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateRow> for MigrateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::MigrateRow) -> Result<Self, Self::Error> {
        Ok(Self {
