...
#[graphql(name = "ThawDelegatedAccount")]
pub struct ThawDelegatedAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::ThawDelegatedAccountRow>
    for ThawDelegatedAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ThawDelegatedAccountRow,
