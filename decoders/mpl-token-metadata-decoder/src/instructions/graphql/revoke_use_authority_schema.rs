...
#[graphql(name = "RevokeUseAuthority")]
pub struct RevokeUseAuthorityGraphQL {
...
impl TryFrom<crate::instructions::postgres::RevokeUseAuthorityRow> for RevokeUseAuthorityGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RevokeUseAuthorityRow,
