...
pub struct DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRow {
...
impl
    TryFrom<(
        crate::instructions::deprecated_mint_new_edition_from_master_edition_via_printing_token::DeprecatedMintNewEditionFromMasterEditionViaPrintingToken,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::deprecated_mint_new_edition_from_master_edition_via_printing_token::DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenInstructionAccounts,
...
pub struct DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRowMigrationOperation;
    ...
    for DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRowMigrationOperation
{
    async fn up(
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction ON CLUSTER {cluster} AS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
    ...
    for DeprecatedMintNewEditionFromMasterEditionViaPrintingTokenRowMigrationOperation
{
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS mpl_token_metadata_deprecated_mint_new_edition_from_master_edition_via_printing_token_instruction")
            .execute()
            .await?;
