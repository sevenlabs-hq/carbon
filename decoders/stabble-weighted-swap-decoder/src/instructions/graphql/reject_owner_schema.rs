...
#[graphql(name = "RejectOwner")]
pub struct RejectOwnerGraphQL {
...
impl TryFrom<crate::instructions::postgres::RejectOwnerRow> for RejectOwnerGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RejectOwnerRow) -> Result<Self, Self::Error> {
        Ok(Self {
