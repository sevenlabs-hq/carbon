...
impl carbon_core::postgres::operations::Insert for SwapRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO stabble_weighted_swap_swap_instruction (
                "amount_in",
                "minimum_amount_out",
...
impl carbon_core::postgres::operations::Upsert for SwapRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO stabble_weighted_swap_swap_instruction (
                "amount_in",
                "minimum_amount_out",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
...
impl carbon_core::postgres::operations::Delete for SwapRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM stabble_weighted_swap_swap_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for SwapRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM stabble_weighted_swap_swap_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for SwapMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS stabble_weighted_swap_swap_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS stabble_weighted_swap_swap_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
