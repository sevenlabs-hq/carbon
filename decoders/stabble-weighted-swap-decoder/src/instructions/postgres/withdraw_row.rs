...
impl carbon_core::postgres::operations::Insert for WithdrawRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO stabble_weighted_swap_withdraw_instruction (
                "amount",
                "minimum_amounts_out",
...
impl carbon_core::postgres::operations::Upsert for WithdrawRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO stabble_weighted_swap_withdraw_instruction (
                "amount",
                "minimum_amounts_out",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                ...
                "minimum_amounts_out" = EXCLUDED."minimum_amounts_out",
...
impl carbon_core::postgres::operations::Delete for WithdrawRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM stabble_weighted_swap_withdraw_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for WithdrawRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM stabble_weighted_swap_withdraw_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for WithdrawMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS stabble_weighted_swap_withdraw_instruction (
                -- Instruction data
                "amount" NUMERIC(20) NOT NULL,
                "minimum_amounts_out" NUMERIC(20)[] NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS stabble_weighted_swap_withdraw_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
