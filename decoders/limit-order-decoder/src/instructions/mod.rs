...
impl InstructionDecoder for LimitOrderDecoder {
    ...
    fn decode_instruction(
        ...
        if let Some(decoded_instruction) = fill_order::FillOrder::deserialize(instruction.data.as_slice()) {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) = cancel_expired_order::CancelExpiredOrder::deserialize(instruction.data.as_slice()) {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) = init_fee::InitFee::deserialize(instruction.data.as_slice()) {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
