...
#[graphql(name = "AdvanceNonceAccount")]
pub struct AdvanceNonceAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdvanceNonceAccountRow> for AdvanceNonceAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdvanceNonceAccountRow,
