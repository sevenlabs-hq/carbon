...
#[graphql(name = "UpgradeNonceAccount")]
pub struct UpgradeNonceAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpgradeNonceAccountRow> for UpgradeNonceAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpgradeNonceAccountRow,
