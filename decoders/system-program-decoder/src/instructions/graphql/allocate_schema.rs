...
#[graphql(name = "Allocate")]
pub struct AllocateGraphQL {
...
impl TryFrom<crate::instructions::postgres::AllocateRow> for AllocateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AllocateRow) -> Result<Self, Self::Error> {
        Ok(Self {
