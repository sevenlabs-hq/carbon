...
impl CarbonDeserialize for InitializePermissionlessConstantProductPoolWithConfig {
    const DISCRIMINATOR: &'static [u8] = &[7, 166, 138, 171, 206, 171, 236, 244];
...
impl ArrangeAccounts for InitializePermissionlessConstantProductPoolWithConfig {
