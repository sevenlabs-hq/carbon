...
impl PartnerClaimFeeRow {
    pub fn from_parts(
        source: crate::instructions::partner_claim_fee::PartnerClaimFee,
...
impl TryFrom<PartnerClaimFeeRow> for crate::instructions::partner_claim_fee::PartnerClaimFee {
    type Error = carbon_core::error::Error;
    fn try_from(source: PartnerClaimFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for PartnerClaimFeeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for PartnerClaimFeeRow {
    type Key = (
        String,
...
pub struct PartnerClaimFeeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for PartnerClaimFeeMigrationOperation {
    async fn up(
        &self,
