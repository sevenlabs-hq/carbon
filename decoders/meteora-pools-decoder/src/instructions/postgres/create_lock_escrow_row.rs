...
impl CreateLockEscrowRow {
    pub fn from_parts(
        _source: crate::instructions::create_lock_escrow::CreateLockEscrow,
...
impl TryFrom<CreateLockEscrowRow> for crate::instructions::create_lock_escrow::CreateLockEscrow {
    type Error = carbon_core::error::Error;
    fn try_from(_source: CreateLockEscrowRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for CreateLockEscrowRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CreateLockEscrowRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CreateLockEscrowRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CreateLockEscrowMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CreateLockEscrowMigrationOperation {
    async fn up(
        &self,
