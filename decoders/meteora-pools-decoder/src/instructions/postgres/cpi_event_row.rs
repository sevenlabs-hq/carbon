    ...
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                ...
                CpiEvent::BootstrapLiquidity(_) => "bootstrap_liquidity".to_string(),
                CpiEvent::Swap(_) => "swap".to_string(),
                CpiEvent::SetPoolFees(_) => "set_pool_fees".to_string(),
                CpiEvent::PoolInfo(_) => "pool_info".to_string(),
                CpiEvent::TransferAdmin(_) => "transfer_admin".to_string(),
                CpiEvent::OverrideCurveParam(_) => "override_curve_param".to_string(),
                CpiEvent::PoolCreated(_) => "pool_created".to_string(),
                CpiEvent::PoolEnabled(_) => "pool_enabled".to_string(),
                CpiEvent::MigrateFeeAccount(_) => "migrate_fee_account".to_string(),
                CpiEvent::CreateLockEscrow(_) => "create_lock_escrow".to_string(),
                CpiEvent::Lock(_) => "lock".to_string(),
                CpiEvent::ClaimFee(_) => "claim_fee".to_string(),
                CpiEvent::CreateConfig(_) => "create_config".to_string(),
                CpiEvent::CloseConfig(_) => "close_config".to_string(),
                CpiEvent::WithdrawProtocolFees(_) => "withdraw_protocol_fees".to_string(),
                CpiEvent::PartnerClaimFees(_) => "partner_claim_fees".to_string(),
            },
...
impl carbon_core::postgres::operations::Insert for CpiEventRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO meteora_pools_cpi_events (
...
impl carbon_core::postgres::operations::Upsert for CpiEventRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO meteora_pools_cpi_events (
            __signature, __instruction_index, __stack_height, __slot, "name", "data", __accounts
        ) VALUES (
            $1, $2, $3, $4, $5, $6, $7
...
impl carbon_core::postgres::operations::Delete for CpiEventRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM meteora_pools_cpi_events WHERE
...
impl carbon_core::postgres::operations::Lookup for CpiEventRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM meteora_pools_cpi_events WHERE
            __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
        "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CpiEventMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS meteora_pools_cpi_events (
            -- Instruction data
            "name" TEXT NOT NULL,
            "data" JSONB NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS meteora_pools_cpi_events"#)
            .execute(connection)
            .await?;
        Ok(())
    }
