...
impl
    TryFrom<(
        crate::instructions::initialize_permissionless_constant_product_pool_with_config2::InitializePermissionlessConstantProductPoolWithConfig2,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::initialize_permissionless_constant_product_pool_with_config2::InitializePermissionlessConstantProductPoolWithConfig2InstructionAccounts,
...
impl carbon_core::clickhouse::Table for InitializePermissionlessConstantProductPoolWithConfig2Row {
    fn table() -> &'static str {
        "meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction"
    }
}
...
pub struct InitializePermissionlessConstantProductPoolWithConfig2RowMigrationOperation;
    ...
    for InitializePermissionlessConstantProductPoolWithConfig2RowMigrationOperation
{
    async fn up(
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction ON CLUSTER {cluster} AS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
    ...
    for InitializePermissionlessConstantProductPoolWithConfig2RowMigrationOperation
{
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS meteora_pools_initialize_permissionless_constant_product_pool_with_config2_instruction")
            .execute()
            .await?;
