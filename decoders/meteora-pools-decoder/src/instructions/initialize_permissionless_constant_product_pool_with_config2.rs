...
impl CarbonDeserialize for InitializePermissionlessConstantProductPoolWithConfig2 {
    const DISCRIMINATOR: &'static [u8] = &[48, 149, 220, 130, 61, 11, 9, 178];
...
impl ArrangeAccounts for InitializePermissionlessConstantProductPoolWithConfig2 {
