...
#[graphql(name = "GetPoolInfo")]
pub struct GetPoolInfoGraphQL {
...
impl TryFrom<crate::instructions::postgres::GetPoolInfoRow> for GetPoolInfoGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::GetPoolInfoRow) -> Result<Self, Self::Error> {
        Ok(Self {
