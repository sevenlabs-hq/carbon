...
impl TryFrom<crate::instructions::postgres::CloseConfigRow> for CloseConfigGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
