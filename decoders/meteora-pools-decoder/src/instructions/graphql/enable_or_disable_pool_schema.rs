...
#[graphql(name = "EnableOrDisablePool")]
pub struct EnableOrDisablePoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::EnableOrDisablePoolRow> for EnableOrDisablePoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::EnableOrDisablePoolRow,
