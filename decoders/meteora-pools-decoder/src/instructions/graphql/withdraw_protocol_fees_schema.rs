...
impl TryFrom<crate::instructions::postgres::WithdrawProtocolFeesRow>
    for WithdrawProtocolFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawProtocolFeesRow,
