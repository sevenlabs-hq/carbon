...
#[graphql(name = "CreateMintMetadata")]
pub struct CreateMintMetadataGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateMintMetadataRow> for CreateMintMetadataGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateMintMetadataRow,
