...
impl From<crate::types::RemoveLiquidity> for RemoveLiquidityGraphQL {
    fn from(original: crate::types::RemoveLiquidity) -> Self {
        Self {
            ...
            token_a_out_amount: carbon_core::graphql::primitives::U64(original.token_a_out_amount),
            token_b_out_amount: carbon_core::graphql::primitives::U64(original.token_b_out_amount),
        }
    }
}
