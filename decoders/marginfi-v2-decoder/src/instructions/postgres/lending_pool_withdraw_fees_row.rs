...
impl LendingPoolWithdrawFeesRow {
    pub fn from_parts(
        source: crate::instructions::lending_pool_withdraw_fees::LendingPoolWithdrawFees,
    ...
    for crate::instructions::lending_pool_withdraw_fees::LendingPoolWithdrawFees
{
    ...
    fn try_from(source: LendingPoolWithdrawFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for LendingPoolWithdrawFeesRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for LendingPoolWithdrawFeesRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for LendingPoolWithdrawFeesRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct LendingPoolWithdrawFeesMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for LendingPoolWithdrawFeesMigrationOperation {
    async fn up(
        &self,
