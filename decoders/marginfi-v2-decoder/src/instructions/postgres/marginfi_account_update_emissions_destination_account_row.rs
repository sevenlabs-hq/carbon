...
impl MarginfiAccountUpdateEmissionsDestinationAccountRow {
    pub fn from_parts(
        _source: crate::instructions::marginfi_account_update_emissions_destination_account::MarginfiAccountUpdateEmissionsDestinationAccount,
...
impl TryFrom<MarginfiAccountUpdateEmissionsDestinationAccountRow> for crate::instructions::marginfi_account_update_emissions_destination_account::MarginfiAccountUpdateEmissionsDestinationAccount {
    type Error = carbon_core::error::Error;
    fn try_from(_source: MarginfiAccountUpdateEmissionsDestinationAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
pub struct MarginfiAccountUpdateEmissionsDestinationAccountMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for MarginfiAccountUpdateEmissionsDestinationAccountMigrationOperation
{
    async fn up(
        &self,
