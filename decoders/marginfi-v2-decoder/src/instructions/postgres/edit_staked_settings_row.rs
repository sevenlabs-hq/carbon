...
pub struct EditStakedSettingsRow {
    ...
    pub settings: sqlx::types::Json<StakedSettingsEditConfig>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl EditStakedSettingsRow {
    pub fn from_parts(
        source: crate::instructions::edit_staked_settings::EditStakedSettings,
    ...
    for crate::instructions::edit_staked_settings::EditStakedSettings
{
    ...
    fn try_from(source: EditStakedSettingsRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for EditStakedSettingsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for EditStakedSettingsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for EditStakedSettingsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct EditStakedSettingsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for EditStakedSettingsMigrationOperation {
    async fn up(
        &self,
