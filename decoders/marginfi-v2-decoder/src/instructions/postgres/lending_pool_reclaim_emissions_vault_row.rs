...
impl LendingPoolReclaimEmissionsVaultRow {
    pub fn from_parts(
        _source: crate::instructions::lending_pool_reclaim_emissions_vault::LendingPoolReclaimEmissionsVault,
...
impl TryFrom<LendingPoolReclaimEmissionsVaultRow>
    for crate::instructions::lending_pool_reclaim_emissions_vault::LendingPoolReclaimEmissionsVault
{
    type Error = carbon_core::error::Error;
    fn try_from(_source: LendingPoolReclaimEmissionsVaultRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for LendingPoolReclaimEmissionsVaultRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for LendingPoolReclaimEmissionsVaultRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for LendingPoolReclaimEmissionsVaultRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct LendingPoolReclaimEmissionsVaultMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for LendingPoolReclaimEmissionsVaultMigrationOperation
{
    async fn up(
        &self,
