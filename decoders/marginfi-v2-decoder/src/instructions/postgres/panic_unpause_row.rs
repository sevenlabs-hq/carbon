...
impl PanicUnpauseRow {
    pub fn from_parts(
        _source: crate::instructions::panic_unpause::PanicUnpause,
...
impl TryFrom<PanicUnpauseRow> for crate::instructions::panic_unpause::PanicUnpause {
    type Error = carbon_core::error::Error;
    fn try_from(_source: PanicUnpauseRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for PanicUnpauseRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for PanicUnpauseRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for PanicUnpauseRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct PanicUnpauseMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for PanicUnpauseMigrationOperation {
    async fn up(
        &self,
