...
impl PropagateFeeStateRow {
    pub fn from_parts(
        _source: crate::instructions::propagate_fee_state::PropagateFeeState,
...
impl TryFrom<PropagateFeeStateRow> for crate::instructions::propagate_fee_state::PropagateFeeState {
    type Error = carbon_core::error::Error;
    fn try_from(_source: PropagateFeeStateRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for PropagateFeeStateRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for PropagateFeeStateRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for PropagateFeeStateRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct PropagateFeeStateMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for PropagateFeeStateMigrationOperation {
    async fn up(
        &self,
