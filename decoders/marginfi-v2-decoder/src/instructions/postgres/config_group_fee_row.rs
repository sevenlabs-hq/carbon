...
impl ConfigGroupFeeRow {
    pub fn from_parts(
        source: crate::instructions::config_group_fee::ConfigGroupFee,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            enable_program_fee: source.enable_program_fee,
            accounts: sqlx::types::Json(accounts),
        }
    }
}

impl TryFrom<ConfigGroupFeeRow> for crate::instructions::config_group_fee::ConfigGroupFee {
    type Error = carbon_core::error::Error;
    fn try_from(source: ConfigGroupFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
            enable_program_fee: source.enable_program_fee,
        })
    }
...
impl carbon_core::postgres::operations::Insert for ConfigGroupFeeRow {
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO config_group_fee_instruction (
                ...
                "enable_program_fee" = EXCLUDED."enable_program_fee",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ConfigGroupFeeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ConfigGroupFeeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ConfigGroupFeeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ConfigGroupFeeMigrationOperation {
    async fn up(
        &self,
