...
impl carbon_core::postgres::operations::Insert for MarginfiAccountSetKeeperCloseFlagsRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO marginfi_v2_marginfi_account_set_keeper_close_flags_instruction (
                "bank_keys_opt",
...
impl carbon_core::postgres::operations::Upsert for MarginfiAccountSetKeeperCloseFlagsRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO marginfi_v2_marginfi_account_set_keeper_close_flags_instruction (
                "bank_keys_opt",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5, $6
...
impl carbon_core::postgres::operations::Delete for MarginfiAccountSetKeeperCloseFlagsRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM marginfi_v2_marginfi_account_set_keeper_close_flags_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for MarginfiAccountSetKeeperCloseFlagsRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM marginfi_v2_marginfi_account_set_keeper_close_flags_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
    ...
    for MarginfiAccountSetKeeperCloseFlagsMigrationOperation
{
    async fn up(
        ...
        sqlx::query(r#"CREATE TABLE IF NOT EXISTS marginfi_v2_marginfi_account_set_keeper_close_flags_instruction (
                -- Instruction data
                "bank_keys_opt" BYTEA[],
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS marginfi_v2_marginfi_account_set_keeper_close_flags_instruction"#).execute(connection).await?;
        Ok(())
    }
}
