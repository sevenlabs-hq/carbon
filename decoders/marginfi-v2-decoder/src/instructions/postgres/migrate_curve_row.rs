...
impl MigrateCurveRow {
    pub fn from_parts(
        _source: crate::instructions::migrate_curve::MigrateCurve,
...
impl TryFrom<MigrateCurveRow> for crate::instructions::migrate_curve::MigrateCurve {
    type Error = carbon_core::error::Error;
    fn try_from(_source: MigrateCurveRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrateCurveRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrateCurveRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MigrateCurveRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MigrateCurveMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MigrateCurveMigrationOperation {
    async fn up(
        &self,
