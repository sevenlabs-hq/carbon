...
impl MarginfiAccountInitializePdaRow {
    pub fn from_parts(
        source: crate::instructions::marginfi_account_initialize_pda::MarginfiAccountInitializePda,
...
impl TryFrom<MarginfiAccountInitializePdaRow>
    for crate::instructions::marginfi_account_initialize_pda::MarginfiAccountInitializePda
{
    type Error = carbon_core::error::Error;
    fn try_from(source: MarginfiAccountInitializePdaRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for MarginfiAccountInitializePdaRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MarginfiAccountInitializePdaRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MarginfiAccountInitializePdaRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MarginfiAccountInitializePdaMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MarginfiAccountInitializePdaMigrationOperation {
    async fn up(
        &self,
