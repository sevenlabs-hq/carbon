...
use {
    crate::types::SolendConfigCompact,
    carbon_core::{
...
pub struct LendingPoolAddBankSolendRow {
    ...
    pub bank_config: sqlx::types::Json<SolendConfigCompact>,
    pub bank_seed: U64,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl LendingPoolAddBankSolendRow {
    pub fn from_parts(
        source: crate::instructions::lending_pool_add_bank_solend::LendingPoolAddBankSolend,
...
impl TryFrom<LendingPoolAddBankSolendRow>
    for crate::instructions::lending_pool_add_bank_solend::LendingPoolAddBankSolend
{
    type Error = carbon_core::error::Error;
    fn try_from(source: LendingPoolAddBankSolendRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for LendingPoolAddBankSolendRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for LendingPoolAddBankSolendRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for LendingPoolAddBankSolendRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct LendingPoolAddBankSolendMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for LendingPoolAddBankSolendMigrationOperation {
    async fn up(
        &self,
