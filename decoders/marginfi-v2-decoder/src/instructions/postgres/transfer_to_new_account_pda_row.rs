...
impl carbon_core::postgres::operations::Insert for TransferToNewAccountPdaRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO marginfi_v2_transfer_to_new_account_pda_instruction (
                "account_index",
                "third_party_id",
...
impl carbon_core::postgres::operations::Upsert for TransferToNewAccountPdaRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO marginfi_v2_transfer_to_new_account_pda_instruction (
                "account_index",
                "third_party_id",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
...
impl carbon_core::postgres::operations::Delete for TransferToNewAccountPdaRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM marginfi_v2_transfer_to_new_account_pda_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for TransferToNewAccountPdaRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM marginfi_v2_transfer_to_new_account_pda_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for TransferToNewAccountPdaMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS marginfi_v2_transfer_to_new_account_pda_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS marginfi_v2_transfer_to_new_account_pda_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
