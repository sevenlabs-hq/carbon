...
impl DriftDepositRow {
    pub fn from_parts(
        source: crate::instructions::drift_deposit::DriftDeposit,
...
impl TryFrom<DriftDepositRow> for crate::instructions::drift_deposit::DriftDeposit {
    type Error = carbon_core::error::Error;
    fn try_from(source: DriftDepositRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for DriftDepositRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DriftDepositRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for DriftDepositRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct DriftDepositMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for DriftDepositMigrationOperation {
    async fn up(
        &self,
