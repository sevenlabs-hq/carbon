...
impl MarginfiAccountSetFreezeRow {
    pub fn from_parts(
        source: crate::instructions::marginfi_account_set_freeze::MarginfiAccountSetFreeze,
...
impl TryFrom<MarginfiAccountSetFreezeRow>
    for crate::instructions::marginfi_account_set_freeze::MarginfiAccountSetFreeze
{
    type Error = carbon_core::error::Error;
    fn try_from(source: MarginfiAccountSetFreezeRow) -> Result<Self, Self::Error> {
        Ok(Self {
            frozen: source.frozen,
        })
    }
...
impl carbon_core::postgres::operations::Insert for MarginfiAccountSetFreezeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MarginfiAccountSetFreezeRow {
    type Key = (
        String,
...
pub struct MarginfiAccountSetFreezeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MarginfiAccountSetFreezeMigrationOperation {
    async fn up(
        &self,
