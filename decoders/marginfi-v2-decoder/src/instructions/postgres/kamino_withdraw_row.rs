...
impl KaminoWithdrawRow {
    pub fn from_parts(
        source: crate::instructions::kamino_withdraw::KaminoWithdraw,
...
impl TryFrom<KaminoWithdrawRow> for crate::instructions::kamino_withdraw::KaminoWithdraw {
    type Error = carbon_core::error::Error;
    fn try_from(source: KaminoWithdrawRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for KaminoWithdrawRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for KaminoWithdrawRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for KaminoWithdrawRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct KaminoWithdrawMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for KaminoWithdrawMigrationOperation {
    async fn up(
        &self,
