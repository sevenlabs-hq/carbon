...
pub struct MarginfiAccountPlaceOrderRow {
    ...
    pub trigger: sqlx::types::Json<OrderTrigger>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl MarginfiAccountPlaceOrderRow {
    pub fn from_parts(
        source: crate::instructions::marginfi_account_place_order::MarginfiAccountPlaceOrder,
...
impl TryFrom<MarginfiAccountPlaceOrderRow>
    for crate::instructions::marginfi_account_place_order::MarginfiAccountPlaceOrder
{
    type Error = carbon_core::error::Error;
    fn try_from(source: MarginfiAccountPlaceOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
            bank_keys: source
                .bank_keys
                .into_iter()
...
impl carbon_core::postgres::operations::Insert for MarginfiAccountPlaceOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MarginfiAccountPlaceOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MarginfiAccountPlaceOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MarginfiAccountPlaceOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MarginfiAccountPlaceOrderMigrationOperation {
    async fn up(
        &self,
