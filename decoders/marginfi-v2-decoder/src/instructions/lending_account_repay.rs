...
/// (account authority, or any signer during receivership) Repay borrowed
/// assets. Accrues interest, records repayment, and transfers tokens to the
...
impl CarbonDeserialize for LendingAccountRepay {
    const DISCRIMINATOR: &'static [u8] = &[79, 209, 172, 177, 222, 51, 173, 151];
