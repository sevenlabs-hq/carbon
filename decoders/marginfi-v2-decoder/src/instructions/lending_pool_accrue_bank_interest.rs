...
/// (permissionless) Accrue interest on a bank, updating share values and
/// collecting fees.
...
impl CarbonDeserialize for LendingPoolAccrueBankInterest {
    const DISCRIMINATOR: &'static [u8] = &[108, 201, 30, 87, 47, 65, 97, 188];
