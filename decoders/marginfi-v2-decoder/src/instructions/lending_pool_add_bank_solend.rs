...
impl CarbonDeserialize for LendingPoolAddBankSolend {
    const DISCRIMINATOR: &'static [u8] = &[81, 233, 203, 199, 47, 226, 0, 68];
...
impl ArrangeAccounts for LendingPoolAddBankSolend {
    type ArrangedAccounts = LendingPoolAddBankSolendInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(LendingPoolAddBankSolendInstructionAccounts {
            group,
            admin,
            fee_payer,
            bank_mint,
