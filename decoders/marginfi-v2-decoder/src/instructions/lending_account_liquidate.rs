...
/// (permissionless) Liquidate a lending account balance of an unhealthy
/// marginfi account. The liquidator takes on the liability and receives
/// discounted collateral (2.5% liquidator fee + 2.5% insurance fee).
...
impl CarbonDeserialize for LendingAccountLiquidate {
    const DISCRIMINATOR: &'static [u8] = &[214, 169, 151, 213, 251, 167, 86, 219];
