...
/// (account authority) Same as `transfer_to_new_account` except the resulting
/// account is a PDA seeds:
/// - marginfi_group
...
impl CarbonDeserialize for TransferToNewAccountPda {
    const DISCRIMINATOR: &'static [u8] = &[172, 210, 224, 220, 146, 212, 253, 49];
