...
/// (account authority) Close a marginfi account. Requires all balances to be
/// empty and no active flags (disabled, flashloan, receivership).
...
impl CarbonDeserialize for MarginfiAccountClose {
    const DISCRIMINATOR: &'static [u8] = &[186, 221, 93, 34, 50, 97, 194, 241];
