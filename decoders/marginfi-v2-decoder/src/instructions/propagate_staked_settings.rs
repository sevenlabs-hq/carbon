...
/// (permissionless) Propagate updated staked settings to a staked collateral
/// bank.
...
impl CarbonDeserialize for PropagateStakedSettings {
    const DISCRIMINATOR: &'static [u8] = &[210, 30, 152, 69, 130, 99, 222, 170];
