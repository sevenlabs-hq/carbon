...
#[graphql(name = "SolendDeposit")]
pub struct SolendDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::SolendDepositRow> for SolendDepositGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SolendDepositRow) -> Result<Self, Self::Error> {
        Ok(Self {
