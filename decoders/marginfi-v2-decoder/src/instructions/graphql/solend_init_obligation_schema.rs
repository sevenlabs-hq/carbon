...
#[graphql(name = "SolendInitObligation")]
pub struct SolendInitObligationGraphQL {
...
impl TryFrom<crate::instructions::postgres::SolendInitObligationRow>
    for SolendInitObligationGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SolendInitObligationRow,
