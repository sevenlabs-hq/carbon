...
#[graphql(name = "MigrateCurve")]
pub struct MigrateCurveGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateCurveRow> for MigrateCurveGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::MigrateCurveRow) -> Result<Self, Self::Error> {
        Ok(Self {
