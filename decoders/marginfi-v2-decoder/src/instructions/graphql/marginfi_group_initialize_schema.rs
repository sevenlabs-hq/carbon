...
#[graphql(name = "MarginfiGroupInitialize")]
pub struct MarginfiGroupInitializeGraphQL {
...
impl TryFrom<crate::instructions::postgres::MarginfiGroupInitializeRow>
    for MarginfiGroupInitializeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MarginfiGroupInitializeRow,
