...
#[graphql(name = "InitGlobalFeeState")]
pub struct InitGlobalFeeStateGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitGlobalFeeStateRow> for InitGlobalFeeStateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitGlobalFeeStateRow,
