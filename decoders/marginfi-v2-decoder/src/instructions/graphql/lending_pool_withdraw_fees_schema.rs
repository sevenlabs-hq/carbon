...
#[graphql(name = "LendingPoolWithdrawFees")]
pub struct LendingPoolWithdrawFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingPoolWithdrawFeesRow>
    for LendingPoolWithdrawFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingPoolWithdrawFeesRow,
