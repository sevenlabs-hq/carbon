...
#[graphql(name = "PanicUnpause")]
pub struct PanicUnpauseGraphQL {
...
impl TryFrom<crate::instructions::postgres::PanicUnpauseRow> for PanicUnpauseGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::PanicUnpauseRow) -> Result<Self, Self::Error> {
        Ok(Self {
