...
#[graphql(name = "DriftInitUser")]
pub struct DriftInitUserGraphQL {
...
impl TryFrom<crate::instructions::postgres::DriftInitUserRow> for DriftInitUserGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DriftInitUserRow) -> Result<Self, Self::Error> {
        Ok(Self {
