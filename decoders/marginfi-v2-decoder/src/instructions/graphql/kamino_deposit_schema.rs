...
#[graphql(name = "KaminoDeposit")]
pub struct KaminoDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::KaminoDepositRow> for KaminoDepositGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::KaminoDepositRow) -> Result<Self, Self::Error> {
        Ok(Self {
