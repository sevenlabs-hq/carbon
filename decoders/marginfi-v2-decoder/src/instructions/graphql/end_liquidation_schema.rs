...
#[graphql(name = "EndLiquidation")]
pub struct EndLiquidationGraphQL {
...
impl TryFrom<crate::instructions::postgres::EndLiquidationRow> for EndLiquidationGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::EndLiquidationRow,
