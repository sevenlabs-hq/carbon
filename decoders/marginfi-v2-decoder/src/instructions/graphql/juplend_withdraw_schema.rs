...
#[graphql(name = "JuplendWithdraw")]
pub struct JuplendWithdrawGraphQL {
...
impl TryFrom<crate::instructions::postgres::JuplendWithdrawRow> for JuplendWithdrawGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::JuplendWithdrawRow,
