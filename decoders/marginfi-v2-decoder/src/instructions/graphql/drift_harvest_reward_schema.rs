...
#[graphql(name = "DriftHarvestReward")]
pub struct DriftHarvestRewardGraphQL {
...
impl TryFrom<crate::instructions::postgres::DriftHarvestRewardRow> for DriftHarvestRewardGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DriftHarvestRewardRow,
