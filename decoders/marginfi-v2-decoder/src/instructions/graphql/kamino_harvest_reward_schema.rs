...
#[graphql(name = "KaminoHarvestReward")]
pub struct KaminoHarvestRewardGraphQL {
...
impl TryFrom<crate::instructions::postgres::KaminoHarvestRewardRow> for KaminoHarvestRewardGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::KaminoHarvestRewardRow,
