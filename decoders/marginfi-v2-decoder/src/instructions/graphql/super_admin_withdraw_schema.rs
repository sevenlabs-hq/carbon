...
#[graphql(name = "SuperAdminWithdraw")]
pub struct SuperAdminWithdrawGraphQL {
...
impl TryFrom<crate::instructions::postgres::SuperAdminWithdrawRow> for SuperAdminWithdrawGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SuperAdminWithdrawRow,
