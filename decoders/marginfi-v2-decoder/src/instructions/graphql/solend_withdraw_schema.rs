...
#[graphql(name = "SolendWithdraw")]
pub struct SolendWithdrawGraphQL {
...
impl TryFrom<crate::instructions::postgres::SolendWithdrawRow> for SolendWithdrawGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SolendWithdrawRow,
