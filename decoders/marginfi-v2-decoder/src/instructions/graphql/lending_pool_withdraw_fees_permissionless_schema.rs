...
#[graphql(name = "LendingPoolWithdrawFeesPermissionless")]
pub struct LendingPoolWithdrawFeesPermissionlessGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingPoolWithdrawFeesPermissionlessRow>
    for LendingPoolWithdrawFeesPermissionlessGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingPoolWithdrawFeesPermissionlessRow,
