...
#[graphql(name = "JuplendInitPosition")]
pub struct JuplendInitPositionGraphQL {
...
impl TryFrom<crate::instructions::postgres::JuplendInitPositionRow> for JuplendInitPositionGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::JuplendInitPositionRow,
