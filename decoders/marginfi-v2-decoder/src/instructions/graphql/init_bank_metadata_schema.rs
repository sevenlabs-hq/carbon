...
#[graphql(name = "InitBankMetadata")]
pub struct InitBankMetadataGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitBankMetadataRow> for InitBankMetadataGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitBankMetadataRow,
