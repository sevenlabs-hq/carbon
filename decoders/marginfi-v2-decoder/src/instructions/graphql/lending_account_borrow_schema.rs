...
#[graphql(name = "LendingAccountBorrow")]
pub struct LendingAccountBorrowGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingAccountBorrowRow>
    for LendingAccountBorrowGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingAccountBorrowRow,
