...
#[graphql(name = "LendingAccountWithdraw")]
pub struct LendingAccountWithdrawGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingAccountWithdrawRow>
    for LendingAccountWithdrawGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingAccountWithdrawRow,
