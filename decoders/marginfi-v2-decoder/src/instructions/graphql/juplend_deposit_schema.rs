...
#[graphql(name = "JuplendDeposit")]
pub struct JuplendDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::JuplendDepositRow> for JuplendDepositGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::JuplendDepositRow,
