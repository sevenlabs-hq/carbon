...
#[graphql(name = "DriftDeposit")]
pub struct DriftDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::DriftDepositRow> for DriftDepositGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DriftDepositRow) -> Result<Self, Self::Error> {
        Ok(Self {
