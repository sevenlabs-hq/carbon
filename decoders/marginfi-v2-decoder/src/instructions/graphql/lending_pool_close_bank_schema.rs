...
#[graphql(name = "LendingPoolCloseBank")]
pub struct LendingPoolCloseBankGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingPoolCloseBankRow>
    for LendingPoolCloseBankGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingPoolCloseBankRow,
