...
#[graphql(name = "StartDeleverage")]
pub struct StartDeleverageGraphQL {
...
impl TryFrom<crate::instructions::postgres::StartDeleverageRow> for StartDeleverageGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::StartDeleverageRow,
