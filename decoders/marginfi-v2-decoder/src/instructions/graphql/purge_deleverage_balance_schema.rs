...
#[graphql(name = "PurgeDeleverageBalance")]
pub struct PurgeDeleverageBalanceGraphQL {
...
impl TryFrom<crate::instructions::postgres::PurgeDeleverageBalanceRow>
    for PurgeDeleverageBalanceGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PurgeDeleverageBalanceRow,
