...
#[graphql(name = "MarginfiAccountClose")]
pub struct MarginfiAccountCloseGraphQL {
...
impl TryFrom<crate::instructions::postgres::MarginfiAccountCloseRow>
    for MarginfiAccountCloseGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MarginfiAccountCloseRow,
