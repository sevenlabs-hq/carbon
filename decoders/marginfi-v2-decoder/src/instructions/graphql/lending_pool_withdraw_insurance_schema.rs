...
#[graphql(name = "LendingPoolWithdrawInsurance")]
pub struct LendingPoolWithdrawInsuranceGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingPoolWithdrawInsuranceRow>
    for LendingPoolWithdrawInsuranceGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingPoolWithdrawInsuranceRow,
