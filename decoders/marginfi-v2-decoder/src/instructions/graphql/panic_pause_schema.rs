...
#[graphql(name = "PanicPause")]
pub struct PanicPauseGraphQL {
...
impl TryFrom<crate::instructions::postgres::PanicPauseRow> for PanicPauseGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::PanicPauseRow) -> Result<Self, Self::Error> {
        Ok(Self {
