...
#[graphql(name = "DriftWithdraw")]
pub struct DriftWithdrawGraphQL {
...
impl TryFrom<crate::instructions::postgres::DriftWithdrawRow> for DriftWithdrawGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DriftWithdrawRow) -> Result<Self, Self::Error> {
        Ok(Self {
