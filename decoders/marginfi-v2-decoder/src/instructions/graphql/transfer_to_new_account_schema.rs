...
#[graphql(name = "TransferToNewAccount")]
pub struct TransferToNewAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::TransferToNewAccountRow>
    for TransferToNewAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TransferToNewAccountRow,
