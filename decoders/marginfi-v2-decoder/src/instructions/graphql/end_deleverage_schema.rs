...
#[graphql(name = "EndDeleverage")]
pub struct EndDeleverageGraphQL {
...
impl TryFrom<crate::instructions::postgres::EndDeleverageRow> for EndDeleverageGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::EndDeleverageRow) -> Result<Self, Self::Error> {
        Ok(Self {
