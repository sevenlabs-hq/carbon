...
#[graphql(name = "SuperAdminDeposit")]
pub struct SuperAdminDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::SuperAdminDepositRow> for SuperAdminDepositGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SuperAdminDepositRow,
