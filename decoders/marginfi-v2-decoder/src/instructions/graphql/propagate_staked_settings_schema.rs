...
#[graphql(name = "PropagateStakedSettings")]
pub struct PropagateStakedSettingsGraphQL {
...
impl TryFrom<crate::instructions::postgres::PropagateStakedSettingsRow>
    for PropagateStakedSettingsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PropagateStakedSettingsRow,
