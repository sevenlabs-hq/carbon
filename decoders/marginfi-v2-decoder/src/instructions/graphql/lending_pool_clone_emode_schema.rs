...
#[graphql(name = "LendingPoolCloneEmode")]
pub struct LendingPoolCloneEmodeGraphQL {
...
impl TryFrom<crate::instructions::postgres::LendingPoolCloneEmodeRow>
    for LendingPoolCloneEmodeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LendingPoolCloneEmodeRow,
