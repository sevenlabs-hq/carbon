...
#[graphql(name = "ConfigureBankRateLimits")]
pub struct ConfigureBankRateLimitsGraphQL {
...
impl TryFrom<crate::instructions::postgres::ConfigureBankRateLimitsRow>
    for ConfigureBankRateLimitsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ConfigureBankRateLimitsRow,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            instruction_metadata: row.instruction_metadata.into(),
            hourly_max_outflow: row
                .hourly_max_outflow
                .map(|v| carbon_core::graphql::primitives::U64(*v)),
            daily_max_outflow: row
                .daily_max_outflow
                .map(|v| carbon_core::graphql::primitives::U64(*v)),
