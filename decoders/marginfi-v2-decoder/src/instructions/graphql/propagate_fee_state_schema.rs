...
#[graphql(name = "PropagateFeeState")]
pub struct PropagateFeeStateGraphQL {
...
impl TryFrom<crate::instructions::postgres::PropagateFeeStateRow> for PropagateFeeStateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PropagateFeeStateRow,
