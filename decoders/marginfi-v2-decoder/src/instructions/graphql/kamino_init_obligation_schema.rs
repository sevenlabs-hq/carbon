...
#[graphql(name = "KaminoInitObligation")]
pub struct KaminoInitObligationGraphQL {
...
impl TryFrom<crate::instructions::postgres::KaminoInitObligationRow>
    for KaminoInitObligationGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::KaminoInitObligationRow,
