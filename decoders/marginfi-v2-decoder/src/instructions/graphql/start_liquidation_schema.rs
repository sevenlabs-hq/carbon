...
#[graphql(name = "StartLiquidation")]
pub struct StartLiquidationGraphQL {
...
impl TryFrom<crate::instructions::postgres::StartLiquidationRow> for StartLiquidationGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::StartLiquidationRow,
