...
/// (account authority) Deposit assets into a bank. Accrues interest, records
/// deposit, and transfers tokens from the signer's token account to the bank's
/// liquidity vault.
...
impl CarbonDeserialize for LendingAccountDeposit {
    const DISCRIMINATOR: &'static [u8] = &[171, 94, 235, 103, 82, 64, 212, 140];
