...
/// (admin only) Initialize a new marginfi group. The signer becomes the group
/// admin.
...
impl CarbonDeserialize for MarginfiGroupInitialize {
    const DISCRIMINATOR: &'static [u8] = &[255, 67, 67, 26, 94, 31, 34, 20];
