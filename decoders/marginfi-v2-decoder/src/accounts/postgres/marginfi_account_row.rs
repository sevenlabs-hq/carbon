...
impl carbon_core::postgres::operations::Insert for MarginfiAccountRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO marginfi_v2_marginfi_account_account (
                "group",
                "authority",
                "lending_account",
                "account_flags",
...
impl carbon_core::postgres::operations::Upsert for MarginfiAccountRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO marginfi_v2_marginfi_account_account (
                "group",
                "authority",
                "lending_account",
                "account_flags",
...
impl carbon_core::postgres::operations::Delete for MarginfiAccountRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM marginfi_v2_marginfi_account_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for MarginfiAccountRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM marginfi_v2_marginfi_account_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for MarginfiAccountMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS marginfi_v2_marginfi_account_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS marginfi_v2_marginfi_account_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
