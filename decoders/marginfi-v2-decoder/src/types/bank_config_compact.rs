...
use crate::types::{BankOperationalState, InterestRateConfigCompact, RiskTier, WrappedI80F48};
...
pub struct BankConfigCompact {
    ...
    ///   the new oracle setup from a prior version. Not set in 0.1.3 or earlier
    ///   banks that have not yet migrated.
