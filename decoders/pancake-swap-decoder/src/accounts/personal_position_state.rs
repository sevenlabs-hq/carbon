...
use {
    crate::types::PositionRewardInfo, carbon_core::deserialize::CarbonDeserialize,
...
impl CarbonDeserialize for PersonalPositionState {
    const DISCRIMINATOR: &'static [u8] = &[70, 111, 150, 126, 230, 15, 25, 117];
