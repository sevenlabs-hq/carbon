...
impl carbon_core::postgres::operations::Insert for OperationStateRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pancake_swap_operation_state_account (
                "bump",
                "operation_owners",
                "whitelist_mints",
                __pubkey, __slot
...
impl carbon_core::postgres::operations::Upsert for OperationStateRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pancake_swap_operation_state_account (
                "bump",
                "operation_owners",
                "whitelist_mints",
                __pubkey, __slot
...
impl carbon_core::postgres::operations::Delete for OperationStateRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pancake_swap_operation_state_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for OperationStateRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pancake_swap_operation_state_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for OperationStateMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pancake_swap_operation_state_account (
                -- Account data
                "bump" INT2 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pancake_swap_operation_state_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
