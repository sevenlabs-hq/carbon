...
impl PoolStateRow {
    pub fn from_parts(
        ...
        Self {
            ...
            tick_current: source.tick_current,
...
impl TryFrom<PoolStateRow> for crate::accounts::pool_state::PoolState {
    ...
    fn try_from(source: PoolStateRow) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            mint_decimals0: source.mint_decimals0.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
            mint_decimals1: source.mint_decimals1.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
            ...
            padding4: source.padding4.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
...
impl carbon_core::postgres::operations::Table for crate::accounts::pool_state::PoolState {
    fn table() -> &'static str {
        "pancake_swap_pool_state_account"
    }
...
impl carbon_core::postgres::operations::Insert for PoolStateRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"
            INSERT INTO pancake_swap_pool_state_account (
                "bump",
                "amm_config",
                "owner",
                "token_mint0",
        ...
        .bind(self.owner)
        .bind(self.token_mint0)
        .bind(self.token_mint1)
        .bind(self.token_vault0)
        .bind(self.token_vault1)
        .bind(self.observation_key)
        .bind(self.mint_decimals0)
        .bind(self.mint_decimals1)
        .bind(self.tick_spacing)
        .bind(&self.liquidity)
        .bind(&self.sqrt_price_x64)
        .bind(self.tick_current)
        .bind(self.padding3)
        .bind(self.padding4)
        .bind(&self.fee_growth_global0_x64)
        .bind(&self.fee_growth_global1_x64)
        .bind(&self.protocol_fees_token0)
        .bind(&self.protocol_fees_token1)
        .bind(&self.swap_in_amount_token0)
        .bind(&self.swap_out_amount_token1)
        .bind(&self.swap_in_amount_token1)
        .bind(&self.swap_out_amount_token0)
        .bind(self.status)
        .bind(&self.padding)
        .bind(&self.reward_infos)
        .bind(&self.tick_array_bitmap)
        .bind(&self.total_fees_token0)
        .bind(&self.total_fees_claimed_token0)
        .bind(&self.total_fees_token1)
        .bind(&self.total_fees_claimed_token1)
...
impl carbon_core::postgres::operations::Upsert for PoolStateRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO pancake_swap_pool_state_account (
                "bump",
                "amm_config",
                "owner",
                "token_mint0",
...
impl carbon_core::postgres::operations::Delete for PoolStateRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pancake_swap_pool_state_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for PoolStateRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pancake_swap_pool_state_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for PoolStateMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pancake_swap_pool_state_account (
                -- Account data
                "bump" BYTEA NOT NULL,
                ...
                "mint_decimals0" INT2 NOT NULL,
                "mint_decimals1" INT2 NOT NULL,
                "tick_spacing" INT4 NOT NULL,
                "liquidity" NUMERIC(39) NOT NULL,
                "sqrt_price_x64" NUMERIC(39) NOT NULL,
                "tick_current" INT4 NOT NULL,
                "padding3" INT4 NOT NULL,
                "padding4" INT4 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pancake_swap_pool_state_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
