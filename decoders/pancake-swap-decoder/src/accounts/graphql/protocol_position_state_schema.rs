...
impl TryFrom<crate::accounts::postgres::ProtocolPositionStateRow> for ProtocolPositionStateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::accounts::postgres::ProtocolPositionStateRow,
