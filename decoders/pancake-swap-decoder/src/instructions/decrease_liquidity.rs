...
impl carbon_core::deserialize::ArrangeAccounts for DecreaseLiquidity {
    ...
    fn arrange_accounts(
        ...
        let [nft_owner, nft_account, personal_position, pool_state, protocol_position, token_vault_0, token_vault_1, tick_array_lower, tick_array_upper, recipient_token_account_0, recipient_token_account_1, token_program, _remaining @ ..] =
            accounts
        else {
            return None;
        };
