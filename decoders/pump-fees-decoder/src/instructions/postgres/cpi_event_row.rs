...
impl CpiEventRow {
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                                CpiEvent::CreateFeeSharingConfigEvent(_) => "create_fee_sharing_config_event".to_string(),
                                CpiEvent::InitializeFeeConfigEvent(_) => "initialize_fee_config_event".to_string(),
                                CpiEvent::InitializeFeeProgramGlobalEvent(_) => "initialize_fee_program_global_event".to_string(),
                                CpiEvent::ResetFeeSharingConfigEvent(_) => "reset_fee_sharing_config_event".to_string(),
                                ...
                                CpiEvent::SetSocialClaimAuthorityEvent(_) => "set_social_claim_authority_event".to_string(),
