...
#[graphql(name = "ResetFeeSharingConfigV2")]
pub struct ResetFeeSharingConfigV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::ResetFeeSharingConfigV2Row>
    for ResetFeeSharingConfigV2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ResetFeeSharingConfigV2Row,
