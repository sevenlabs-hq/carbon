...
#[graphql(name = "CrankDonationFeePda")]
pub struct CrankDonationFeePdaGraphQL {
...
impl TryFrom<crate::instructions::postgres::CrankDonationFeePdaRow> for CrankDonationFeePdaGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CrankDonationFeePdaRow,
