...
#[graphql(name = "CreateDonationFeePda")]
pub struct CreateDonationFeePdaGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateDonationFeePdaRow>
    for CreateDonationFeePdaGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateDonationFeePdaRow,
