...
#[graphql(name = "ExtendFeeConfig")]
pub struct ExtendFeeConfigGraphQL {
...
impl TryFrom<crate::instructions::postgres::ExtendFeeConfigRow> for ExtendFeeConfigGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ExtendFeeConfigRow,
