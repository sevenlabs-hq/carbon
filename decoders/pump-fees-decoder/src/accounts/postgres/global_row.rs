...
impl carbon_core::postgres::operations::Insert for GlobalRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"
            INSERT INTO pump_fees_global_account (
                "initialized",
                "authority",
                "fee_recipient",
                "initial_virtual_token_reserves",
...
impl carbon_core::postgres::operations::Upsert for GlobalRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO pump_fees_global_account (
                "initialized",
                "authority",
                "fee_recipient",
                "initial_virtual_token_reserves",
...
impl carbon_core::postgres::operations::Delete for GlobalRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_fees_global_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for GlobalRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_fees_global_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for GlobalMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_fees_global_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_fees_global_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
