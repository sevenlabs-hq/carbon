...
impl WithdrawHostTipRow {
    pub fn from_parts(
        _source: crate::instructions::withdraw_host_tip::WithdrawHostTip,
...
impl TryFrom<WithdrawHostTipRow> for crate::instructions::withdraw_host_tip::WithdrawHostTip {
    type Error = carbon_core::error::Error;
    fn try_from(_source: WithdrawHostTipRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for WithdrawHostTipRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for WithdrawHostTipRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for WithdrawHostTipRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct WithdrawHostTipMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for WithdrawHostTipMigrationOperation {
    async fn up(
        &self,
