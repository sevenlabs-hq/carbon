...
#[graphql(name = "InitializeVault")]
pub struct InitializeVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeVaultRow> for InitializeVaultGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeVaultRow,
