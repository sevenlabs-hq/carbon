...
#[graphql(name = "WithdrawHostTip")]
pub struct WithdrawHostTipGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawHostTipRow> for WithdrawHostTipGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawHostTipRow,
