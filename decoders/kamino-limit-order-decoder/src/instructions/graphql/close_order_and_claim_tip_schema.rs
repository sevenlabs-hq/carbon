...
#[graphql(name = "CloseOrderAndClaimTip")]
pub struct CloseOrderAndClaimTipGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseOrderAndClaimTipRow>
    for CloseOrderAndClaimTipGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseOrderAndClaimTipRow,
