...
#[graphql(name = "UpdateGlobalConfigAdmin")]
pub struct UpdateGlobalConfigAdminGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateGlobalConfigAdminRow>
    for UpdateGlobalConfigAdminGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateGlobalConfigAdminRow,
