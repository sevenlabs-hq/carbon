...
impl CreatePoolRow {
    pub fn from_parts(source: crate::instructions::create_pool::CreatePool, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            is_cashback_coin: sqlx::types::Json(source.is_cashback_coin.into()),
        }
    }
}
