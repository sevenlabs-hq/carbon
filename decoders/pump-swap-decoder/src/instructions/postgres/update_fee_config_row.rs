...
impl carbon_core::postgres::operations::Insert for UpdateFeeConfigRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pump_swap_update_fee_config_instruction (
                "lp_fee_basis_points",
                "protocol_fee_basis_points",
                "protocol_fee_recipients",
                "coin_creator_fee_basis_points",
...
impl carbon_core::postgres::operations::Upsert for UpdateFeeConfigRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pump_swap_update_fee_config_instruction (
                "lp_fee_basis_points",
                "protocol_fee_basis_points",
                "protocol_fee_recipients",
                "coin_creator_fee_basis_points",
...
impl carbon_core::postgres::operations::Delete for UpdateFeeConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_swap_update_fee_config_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for UpdateFeeConfigRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_swap_update_fee_config_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateFeeConfigMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_swap_update_fee_config_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_swap_update_fee_config_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
