...
impl carbon_core::postgres::operations::Insert for ToggleCashbackEnabledRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pump_swap_toggle_cashback_enabled_instruction (
                "enabled",
...
impl carbon_core::postgres::operations::Upsert for ToggleCashbackEnabledRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pump_swap_toggle_cashback_enabled_instruction (
                "enabled",
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5, $6
...
impl carbon_core::postgres::operations::Delete for ToggleCashbackEnabledRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_swap_toggle_cashback_enabled_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for ToggleCashbackEnabledRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_swap_toggle_cashback_enabled_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for ToggleCashbackEnabledMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_swap_toggle_cashback_enabled_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_swap_toggle_cashback_enabled_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
