...
impl SetCoinCreatorRow {
    pub fn from_parts(_source: crate::instructions::set_coin_creator::SetCoinCreator, metadata: InstructionMetadata) -> Self {
        Self {
...
impl carbon_core::postgres::operations::Table for crate::instructions::set_coin_creator::SetCoinCreator {
    fn table() -> &'static str {
