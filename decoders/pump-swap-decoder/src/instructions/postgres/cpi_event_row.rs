    ...
    pub fn from_parts(source: CpiEvent, metadata: InstructionMetadata) -> Self {
        Self {
            ...
            name: match &source {
                                ...
                                CpiEvent::CollectCoinCreatorFeeEvent(_) => "collect_coin_creator_fee_event".to_string(),
                                ...
                                CpiEvent::MigratePoolCoinCreatorEvent(_) => "migrate_pool_coin_creator_event".to_string(),
                                CpiEvent::ReservedFeeRecipientsEvent(_) => "reserved_fee_recipients_event".to_string(),
                                CpiEvent::SellEvent(_) => "sell_event".to_string(),
                                CpiEvent::SetBondingCurveCoinCreatorEvent(_) => "set_bonding_curve_coin_creator_event".to_string(),
                                CpiEvent::SetMetaplexCoinCreatorEvent(_) => "set_metaplex_coin_creator_event".to_string(),
