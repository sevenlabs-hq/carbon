...
impl carbon_core::postgres::operations::Insert for BuyExactQuoteInRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pump_swap_buy_exact_quote_in_instruction (
                "spendable_quote_in",
                "min_base_amount_out",
                "track_volume",
...
impl carbon_core::postgres::operations::Upsert for BuyExactQuoteInRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pump_swap_buy_exact_quote_in_instruction (
                "spendable_quote_in",
                "min_base_amount_out",
                "track_volume",
                __signature, __instruction_index, __stack_height, __slot, __accounts
...
impl carbon_core::postgres::operations::Delete for BuyExactQuoteInRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_swap_buy_exact_quote_in_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for BuyExactQuoteInRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_swap_buy_exact_quote_in_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for BuyExactQuoteInMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_swap_buy_exact_quote_in_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_swap_buy_exact_quote_in_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
