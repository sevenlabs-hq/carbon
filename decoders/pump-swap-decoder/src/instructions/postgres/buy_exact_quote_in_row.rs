...
impl BuyExactQuoteInRow {
    pub fn from_parts(source: crate::instructions::buy_exact_quote_in::BuyExactQuoteIn, metadata: InstructionMetadata) -> Self {
        Self {
...
impl carbon_core::postgres::operations::Table for crate::instructions::buy_exact_quote_in::BuyExactQuoteIn {
    fn table() -> &'static str {
...
impl carbon_core::postgres::operations::Upsert for BuyExactQuoteInRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO buy_exact_quote_in_instruction (
                "spendable_quote_in",
                "min_base_amount_out",
                "track_volume",
                __signature, __instruction_index, __stack_height, __slot
...
impl carbon_core::postgres::operations::Delete for BuyExactQuoteInRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"DELETE FROM buy_exact_quote_in_instruction WHERE
...
impl carbon_core::postgres::operations::LookUp for BuyExactQuoteInRow {
    ...
    async fn lookup(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<Option<Self>> {
        let row = sqlx::query_as(r#"SELECT * FROM buy_exact_quote_in_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#)
        .bind(key.0)
        .bind(key.1)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for BuyExactQuoteInMigrationOperation {
    async fn up(&self, connection: &mut sqlx::PgConnection) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(r#"CREATE TABLE IF NOT EXISTS buy_exact_quote_in_instruction (
                -- Instruction data
    ...
    async fn down(&self, connection: &mut sqlx::PgConnection) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(r#"DROP TABLE IF EXISTS buy_exact_quote_in_instruction"#).execute(connection).await?;
        Ok(())
    }
}
