...
impl carbon_core::postgres::operations::Insert for CloseUserVolumeAccumulatorRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pump_swap_close_user_volume_accumulator_instruction (
...
impl carbon_core::postgres::operations::Upsert for CloseUserVolumeAccumulatorRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pump_swap_close_user_volume_accumulator_instruction (
                __signature, __instruction_index, __stack_height, __slot, __accounts
            ) VALUES (
                $1, $2, $3, $4, $5
            ) ON CONFLICT (
...
impl carbon_core::postgres::operations::Delete for CloseUserVolumeAccumulatorRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_swap_close_user_volume_accumulator_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for CloseUserVolumeAccumulatorRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_swap_close_user_volume_accumulator_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CloseUserVolumeAccumulatorMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_swap_close_user_volume_accumulator_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_swap_close_user_volume_accumulator_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
