...
/// If coin creator fees are currently below
/// rent.minimum_balance(TokenAccount::LEN) The transfer will be skipped
...
impl CarbonDeserialize for TransferCreatorFeesToPump {
    const DISCRIMINATOR: &'static [u8] = &[139, 52, 134, 85, 228, 229, 108, 241];
