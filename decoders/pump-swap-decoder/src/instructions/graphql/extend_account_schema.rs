...
#[graphql(name = "ExtendAccount")]
pub struct ExtendAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::ExtendAccountRow> for ExtendAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ExtendAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
