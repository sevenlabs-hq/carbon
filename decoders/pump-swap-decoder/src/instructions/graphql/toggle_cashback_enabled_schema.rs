...
impl TryFrom<crate::instructions::postgres::ToggleCashbackEnabledRow>
    for ToggleCashbackEnabledGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ToggleCashbackEnabledRow,
