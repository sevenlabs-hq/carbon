...
#[graphql(name = "SetCoinCreator")]
pub struct SetCoinCreatorGraphQL {
...
impl TryFrom<crate::instructions::postgres::SetCoinCreatorRow> for SetCoinCreatorGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SetCoinCreatorRow,
