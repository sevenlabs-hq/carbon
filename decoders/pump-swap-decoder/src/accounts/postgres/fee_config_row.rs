...
impl carbon_core::postgres::operations::Insert for FeeConfigRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pump_swap_fee_config_account (
                "bump",
                "admin",
                "flat_fees",
                "fee_tiers",
...
impl carbon_core::postgres::operations::Upsert for FeeConfigRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pump_swap_fee_config_account (
                "bump",
                "admin",
                "flat_fees",
                "fee_tiers",
...
impl carbon_core::postgres::operations::Delete for FeeConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_swap_fee_config_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for FeeConfigRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_swap_fee_config_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for FeeConfigMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_swap_fee_config_account (
                -- Account data
                "bump" INT2 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_swap_fee_config_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
