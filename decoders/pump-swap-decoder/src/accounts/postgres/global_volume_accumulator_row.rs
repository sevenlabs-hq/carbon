...
impl carbon_core::postgres::operations::Insert for GlobalVolumeAccumulatorRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO pump_swap_global_volume_accumulator_account (
                "start_time",
                "end_time",
                "seconds_in_a_day",
                "mint",
...
impl carbon_core::postgres::operations::Upsert for GlobalVolumeAccumulatorRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO pump_swap_global_volume_accumulator_account (
                "start_time",
                "end_time",
                "seconds_in_a_day",
                "mint",
...
impl carbon_core::postgres::operations::Delete for GlobalVolumeAccumulatorRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM pump_swap_global_volume_accumulator_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for GlobalVolumeAccumulatorRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM pump_swap_global_volume_accumulator_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for GlobalVolumeAccumulatorMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS pump_swap_global_volume_accumulator_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS pump_swap_global_volume_accumulator_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
