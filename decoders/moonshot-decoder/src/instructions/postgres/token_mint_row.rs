...
pub struct TokenMintRow {
    ...
    pub mint_params: sqlx::types::Json<TokenMintParams>,
...
impl TokenMintRow {
    pub fn from_parts(
        source: crate::instructions::token_mint::TokenMint,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            mint_params: sqlx::types::Json(source.mint_params),
            accounts: sqlx::types::Json(accounts),
        }
    }
}

impl TryFrom<TokenMintRow> for crate::instructions::token_mint::TokenMint {
    type Error = carbon_core::error::Error;
    fn try_from(source: TokenMintRow) -> Result<Self, Self::Error> {
        Ok(Self {
            mint_params: source.mint_params.0,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for TokenMintRow {
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO token_mint_instruction (
                ...
                "mint_params" = EXCLUDED."mint_params",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TokenMintRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TokenMintRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TokenMintMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TokenMintMigrationOperation {
    async fn up(
        &self,
