...
impl MigrateFundsRow {
    pub fn from_parts(
        _source: crate::instructions::migrate_funds::MigrateFunds,
...
impl TryFrom<MigrateFundsRow> for crate::instructions::migrate_funds::MigrateFunds {
    type Error = carbon_core::error::Error;
    fn try_from(_source: MigrateFundsRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for MigrateFundsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for MigrateFundsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for MigrateFundsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct MigrateFundsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for MigrateFundsMigrationOperation {
    async fn up(
        &self,
