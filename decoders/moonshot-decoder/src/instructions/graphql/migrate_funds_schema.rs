...
#[graphql(name = "MigrateFunds")]
pub struct MigrateFundsGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateFundsRow> for MigrateFundsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::MigrateFundsRow) -> Result<Self, Self::Error> {
        Ok(Self {
