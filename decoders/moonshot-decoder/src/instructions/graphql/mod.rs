...
pub mod buy_schema;
pub mod config_init_schema;
pub mod config_update_schema;
pub mod cpi_event_schema;
pub mod migrate_funds_schema;
pub mod sell_schema;
pub mod token_mint_schema;

use juniper::GraphQLObject;
pub use {
    buy_schema::*, config_init_schema::*, config_update_schema::*, cpi_event_schema::*,
    migrate_funds_schema::*, sell_schema::*, token_mint_schema::*,
};
