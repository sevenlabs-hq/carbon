...
pub struct DecompressV1Row {
    ...
    pub decompress_v1_args: sqlx::types::Json<DecompressV1Args>,
...
impl DecompressV1Row {
    pub fn from_parts(
        ...
        Self {
            ...
            decompress_v1_args: sqlx::types::Json(source.decompress_v1_args),
...
impl TryFrom<DecompressV1Row> for crate::instructions::decompress_v1::DecompressV1 {
    ...
    fn try_from(source: DecompressV1Row) -> Result<Self, Self::Error> {
        Ok(Self {
            decompress_v1_args: source.decompress_v1_args.0,
        })
    }
}
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO decompress_v1_instruction (
                ...
                "decompress_v1_args" = EXCLUDED."decompress_v1_args",
    ...
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS decompress_v1_instruction (
                -- Instruction data
                "decompress_v1_args" JSONB NOT NULL,
