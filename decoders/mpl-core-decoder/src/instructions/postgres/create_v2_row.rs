...
pub struct CreateV2Row {
    ...
    pub create_v2_args: sqlx::types::Json<CreateV2Args>,
...
impl CreateV2Row {
    pub fn from_parts(
        ...
        Self {
            ...
            create_v2_args: sqlx::types::Json(source.create_v2_args),
...
impl TryFrom<CreateV2Row> for crate::instructions::create_v2::CreateV2 {
    ...
    fn try_from(source: CreateV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
            create_v2_args: source.create_v2_args.0,
        })
    }
}
    ...
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO create_v2_instruction (
                ...
                "create_v2_args" = EXCLUDED."create_v2_args",
