...
impl
    TryFrom<(
        crate::instructions::update_collection_external_plugin_adapter_v1::UpdateCollectionExternalPluginAdapterV1,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::update_collection_external_plugin_adapter_v1::UpdateCollectionExternalPluginAdapterV1InstructionAccounts,
    )> for UpdateCollectionExternalPluginAdapterV1Row
{
...
impl carbon_core::clickhouse::ClusterTable for UpdateCollectionExternalPluginAdapterV1Row {
    fn local_table() -> &'static str {
        "mpl_core_update_collection_external_plugin_adapter_v1_instruction_local"
    }

    fn distributed_table() -> &'static str {
        "mpl_core_update_collection_external_plugin_adapter_v1_instruction"
    }
}

#[cfg(not(feature = "clickhouse-cluster"))]
impl carbon_core::clickhouse::Table for UpdateCollectionExternalPluginAdapterV1Row {
    fn table() -> &'static str {
        "mpl_core_update_collection_external_plugin_adapter_v1_instruction"
    }
}
...
pub struct UpdateCollectionExternalPluginAdapterV1RowMigrationOperation;

#[cfg(feature = "clickhouse-cluster")]
#[async_trait::async_trait]
impl carbon_core::clickhouse::Operation
    for UpdateCollectionExternalPluginAdapterV1RowMigrationOperation
{
    async fn up(
        &self,
        client: &clickhouse::Client,
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/mpl_core_update_collection_external_plugin_adapter_v1_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS mpl_core_update_collection_external_plugin_adapter_v1_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS mpl_core_update_collection_external_plugin_adapter_v1_instruction ON CLUSTER {cluster} AS mpl_core_update_collection_external_plugin_adapter_v1_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), mpl_core_update_collection_external_plugin_adapter_v1_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS mpl_core_update_collection_external_plugin_adapter_v1_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS mpl_core_update_collection_external_plugin_adapter_v1_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
    ...
    for UpdateCollectionExternalPluginAdapterV1RowMigrationOperation
{
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS mpl_core_update_collection_external_plugin_adapter_v1_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS mpl_core_update_collection_external_plugin_adapter_v1_instruction")
            .execute()
            .await?;
