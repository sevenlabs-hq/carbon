...
#[graphql(name = "AdminCancelOrders")]
pub struct AdminCancelOrdersGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminCancelOrdersRow> for AdminCancelOrdersGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminCancelOrdersRow,
