...
#[graphql(name = "WithdrawPnl")]
pub struct WithdrawPnlGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawPnlRow> for WithdrawPnlGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::WithdrawPnlRow) -> Result<Self, Self::Error> {
        Ok(Self {
