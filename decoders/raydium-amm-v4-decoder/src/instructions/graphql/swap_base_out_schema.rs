...
#[graphql(name = "SwapBaseOut")]
pub struct SwapBaseOutGraphQL {
...
impl TryFrom<crate::instructions::postgres::SwapBaseOutRow> for SwapBaseOutGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SwapBaseOutRow) -> Result<Self, Self::Error> {
        Ok(Self {
