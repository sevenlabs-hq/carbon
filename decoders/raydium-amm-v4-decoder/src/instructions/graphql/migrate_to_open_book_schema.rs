...
#[graphql(name = "MigrateToOpenBook")]
pub struct MigrateToOpenBookGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigrateToOpenBookRow> for MigrateToOpenBookGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MigrateToOpenBookRow,
