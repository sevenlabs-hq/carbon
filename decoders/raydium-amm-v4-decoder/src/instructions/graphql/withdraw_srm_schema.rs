...
#[graphql(name = "WithdrawSrm")]
pub struct WithdrawSrmGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawSrmRow> for WithdrawSrmGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::WithdrawSrmRow) -> Result<Self, Self::Error> {
        Ok(Self {
