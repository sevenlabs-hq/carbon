    ...
    fn arrange_accounts(
        ...
        match accounts.len() {
            17 => {
                ...
                let pool_coin_token_account = accounts.get(4)?;
                let pool_pc_token_account = accounts.get(5)?;
                let serum_program_id = accounts.get(6)?;
                let serum_market = accounts.get(7)?;
                let serum_bids = accounts.get(8)?;
                let serum_asks = accounts.get(9)?;
                let serum_event_queue = accounts.get(10)?;
                ...
                let user_source_token_account = accounts.get(14)?;
                let user_destination_token_account = accounts.get(15)?;
                let user_source_owner = accounts.get(16)?;
