...
impl SwapV3Row {
    pub fn from_parts(
        source: crate::instructions::swap_v3::SwapV3,
...
impl TryFrom<SwapV3Row> for crate::instructions::swap_v3::SwapV3 {
    type Error = carbon_core::error::Error;
    fn try_from(source: SwapV3Row) -> Result<Self, Self::Error> {
        Ok(Self {
            args: source.args.0,
...
impl carbon_core::postgres::operations::Insert for SwapV3Row {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SwapV3Row {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SwapV3Row {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SwapV3MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SwapV3MigrationOperation {
    async fn up(
        &self,
