...
#[graphql(name = "WithdrawExcessLamports")]
pub struct WithdrawExcessLamportsGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawExcessLamportsRow>
    for WithdrawExcessLamportsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawExcessLamportsRow,
