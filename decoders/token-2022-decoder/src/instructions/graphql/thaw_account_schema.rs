...
#[graphql(name = "ThawAccount")]
pub struct ThawAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::ThawAccountRow> for ThawAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ThawAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
