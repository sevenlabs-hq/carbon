...
#[graphql(name = "PermissionedBurn")]
pub struct PermissionedBurnGraphQL {
...
impl TryFrom<crate::instructions::postgres::PermissionedBurnRow> for PermissionedBurnGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PermissionedBurnRow,
