...
#[graphql(name = "PermissionedBurnChecked")]
pub struct PermissionedBurnCheckedGraphQL {
...
impl TryFrom<crate::instructions::postgres::PermissionedBurnCheckedRow>
    for PermissionedBurnCheckedGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::PermissionedBurnCheckedRow,
