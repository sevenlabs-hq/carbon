...
#[graphql(name = "CloseAccount")]
pub struct CloseAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseAccountRow> for CloseAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
