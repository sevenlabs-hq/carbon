...
#[graphql(name = "CreateNativeMint")]
pub struct CreateNativeMintGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateNativeMintRow> for CreateNativeMintGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateNativeMintRow,
