...
#[graphql(name = "FreezeAccount")]
pub struct FreezeAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::FreezeAccountRow> for FreezeAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::FreezeAccountRow) -> Result<Self, Self::Error> {
        Ok(Self {
