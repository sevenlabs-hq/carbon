...
impl DisableCpiGuardRow {
    pub fn from_parts(
        _source: crate::instructions::disable_cpi_guard::DisableCpiGuard,
...
impl TryFrom<DisableCpiGuardRow> for crate::instructions::disable_cpi_guard::DisableCpiGuard {
    type Error = carbon_core::error::Error;
    fn try_from(_source: DisableCpiGuardRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
pub struct DisableCpiGuardMigrationOperation;
