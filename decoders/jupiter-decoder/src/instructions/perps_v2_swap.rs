...
impl ArrangeAccounts for PerpsV2Swap {
    ...
    fn arrange_accounts(&self, accounts: Vec<solana_sdk::pubkey::Pubkey>) -> Option<Self::ArrangedAccounts> {
        ...
        Some(PerpsV2SwapInstructionAccounts {
            ...
            receiving_custody_doves_price_account: *receiving_custody_doves_price_account,
            receiving_custody_pythnet_price_account: *receiving_custody_pythnet_price_account,
            receiving_custody_token_account: *receiving_custody_token_account,
            dispensing_custody: *dispensing_custody,
            dispensing_custody_doves_price_account: *dispensing_custody_doves_price_account,
