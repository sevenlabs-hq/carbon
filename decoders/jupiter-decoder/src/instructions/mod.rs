...
#[derive(
    carbon_proc_macros::InstructionType, serde::Serialize, PartialEq, Eq, Debug, Clone, Hash,
)]
...
impl InstructionDecoder for JupiterDecoder {
    ...
    fn decode_instruction(
        ...
        if let Some(decoded_instruction) =
            exact_out_route::ExactOutRoute::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        {
            println!("Shared accounts route: {:#?}", decoded_instruction);
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        println!("before create token account: {:#?}", instruction.data);
        if let Some(decoded_instruction) =
            create_token_account::CreateTokenAccount::deserialize(instruction.data.as_slice())
        {
            println!("Create token account: {:#?}", decoded_instruction);
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            claim_token::ClaimToken::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            whirlpool_swap_v2::WhirlpoolSwapV2::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            raydium_clmm_swap_v2::RaydiumClmmSwapV2::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            open_book_v2_swap::OpenBookV2Swap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            clone_swap::CloneSwap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            raydium_cp_swap::RaydiumCpSwap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            one_intro_swap::OneIntroSwap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            pumpdotfun_wrapped_buy::PumpdotfunWrappedBuy::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            pumpdotfun_wrapped_sell::PumpdotfunWrappedSell::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            perps_v2_swap::PerpsV2Swap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            perps_v2_add_liquidity::PerpsV2AddLiquidity::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            perps_v2_remove_liquidity::PerpsV2RemoveLiquidity::deserialize(
                instruction.data.as_slice(),
            )
        {
            return Some(carbon_core::instruction::DecodedInstruction {
        ...
        if let Some(decoded_instruction) =
            moonshot_wrapped_buy::MoonshotWrappedBuy::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            moonshot_wrapped_sell::MoonshotWrappedSell::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            stabble_stable_swap::StabbleStableSwap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            stabble_weighted_swap::StabbleWeightedSwap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
        ...
        if let Some(decoded_instruction) =
            obric_swap::ObricSwap::deserialize(instruction.data.as_slice())
        {
            return Some(carbon_core::instruction::DecodedInstruction {
                program_id: instruction.program_id,
