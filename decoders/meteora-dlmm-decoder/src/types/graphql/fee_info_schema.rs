...
impl From<crate::types::FeeInfo> for FeeInfoGraphQL {
    fn from(original: crate::types::FeeInfo) -> Self {
        Self {
            fee_x_per_token_complete: carbon_core::graphql::primitives::U128(
                original.fee_x_per_token_complete,
            ),
            fee_y_per_token_complete: carbon_core::graphql::primitives::U128(
                original.fee_y_per_token_complete,
            ),
