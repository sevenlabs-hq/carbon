...
impl From<crate::types::UpdatePositionLockReleasePoint> for UpdatePositionLockReleasePointGraphQL {
    fn from(original: crate::types::UpdatePositionLockReleasePoint) -> Self {
        Self {
            ...
            new_lock_release_point: carbon_core::graphql::primitives::U64(
                original.new_lock_release_point,
            ),
            old_lock_release_point: carbon_core::graphql::primitives::U64(
                original.old_lock_release_point,
            ),
