...
impl From<crate::types::CompositionFee> for CompositionFeeGraphQL {
    fn from(original: crate::types::CompositionFee) -> Self {
        Self {
            ...
            protocol_token_x_fee_amount: carbon_core::graphql::primitives::U64(
                original.protocol_token_x_fee_amount,
            ),
            protocol_token_y_fee_amount: carbon_core::graphql::primitives::U64(
                original.protocol_token_y_fee_amount,
            ),
        }
    }
}
