...
mod tests {
    ...
    fn test_decode_lb_pair_account() {
        ...
        let expected_account = LbPair {
            ...
            activation_type: 0,
            active_id: 2314,
            base_factor_seed: [232, 3],
            base_key: pubkey!("11111111111111111111111111111111"),
            bin_array_bitmap: Default::default(),
            bin_step: 100,
            bin_step_seed: [100, 0],
            bump_seed: [255],
            creator: pubkey!("ECT3FF9qYr3YgkPtNeJ4VgeGsybXReDSQ7shp1EFH5mJ"),
            last_updated_at: 1735030695,
            oracle: pubkey!("A85D9MkhqntAgk8foSvrptG5k4KTVpLrXf7so53C8m2V"),
            padding0: 0,
            padding1: [0; 32],
            padding2: [0; 32],
            padding3: [0; 8],
            ...
            require_base_factor_seed: 1,
            reserve_x: pubkey!("5XuCjSAsJj4T5W5m8gkSU1i5s5FjxRkFzZHpAcZjaHid"),
            reserve_y: pubkey!("97wxjXLaC6vR9aFSLeLWKDf2s4JFrScuCEfbUCggyjjc"),
            ...
            status: 0,
            token_x_mint: pubkey!("9fEXUmPnDJYAXpoZ9nWi1gQZPwzVKdf8g9fYXW6Epump"),
