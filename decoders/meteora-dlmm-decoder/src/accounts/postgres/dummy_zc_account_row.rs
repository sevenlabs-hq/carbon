...
impl DummyZcAccountRow {
    pub fn from_parts(
        source: crate::accounts::dummy_zc_account::DummyZcAccount,
        metadata: AccountMetadata,
    ) -> Self {
        Self {
            account_metadata: metadata.into(),
            position_bin_data: sqlx::types::Json(source.position_bin_data),
        }
    }
}

impl TryFrom<DummyZcAccountRow> for crate::accounts::dummy_zc_account::DummyZcAccount {
    ...
    for crate::accounts::dummy_zc_account::DummyZcAccount
{
    ...
    fn columns() -> Vec<&'static str> {
        vec!["__pubkey", "__slot", "position_bin_data"]
    }
}
