...
impl carbon_core::postgres::operations::Insert for ClaimFeeOperatorRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO meteora_dlmm_claim_fee_operator_account (
                "operator",
                "padding",
                __pubkey, __slot
            ) VALUES (
...
impl carbon_core::postgres::operations::Upsert for ClaimFeeOperatorRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO meteora_dlmm_claim_fee_operator_account (
                "operator",
                "padding",
                __pubkey, __slot
            ) VALUES (
...
impl carbon_core::postgres::operations::Delete for ClaimFeeOperatorRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM meteora_dlmm_claim_fee_operator_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for ClaimFeeOperatorRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM meteora_dlmm_claim_fee_operator_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for ClaimFeeOperatorMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS meteora_dlmm_claim_fee_operator_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS meteora_dlmm_claim_fee_operator_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
