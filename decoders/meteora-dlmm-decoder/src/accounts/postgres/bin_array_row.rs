...
impl BinArrayRow {
    pub fn from_parts(
        source: crate::accounts::bin_array::BinArray,
        ...
        Self {
            ...
            bins: sqlx::types::Json(source.bins.to_vec()),
        }
    }
}

impl TryFrom<BinArrayRow> for crate::accounts::bin_array::BinArray {
...
impl carbon_core::postgres::operations::Table for crate::accounts::bin_array::BinArray {
    ...
    fn columns() -> Vec<&'static str> {
        vec![
            "__pubkey", "__slot", "index", "version", "padding1", "lb_pair", "bins",
        ]
    }
}
