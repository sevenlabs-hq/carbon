...
impl PresetParameter2Row {
    pub fn from_parts(
        source: crate::accounts::preset_parameter2::PresetParameter2,
...
impl TryFrom<PresetParameter2Row> for crate::accounts::preset_parameter2::PresetParameter2 {
    ...
    fn try_from(source: PresetParameter2Row) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            base_fee_power_factor: source.base_fee_power_factor.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
