...
impl CarbonDeserialize for AddLiquidityByStrategy2 {
    const DISCRIMINATOR: &'static [u8] = &[3, 221, 149, 218, 111, 141, 118, 213];
...
impl ArrangeAccounts for AddLiquidityByStrategy2 {
