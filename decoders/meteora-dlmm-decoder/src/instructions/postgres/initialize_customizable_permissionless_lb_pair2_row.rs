...
impl InitializeCustomizablePermissionlessLbPair2Row {
    pub fn from_parts(
        source: crate::instructions::initialize_customizable_permissionless_lb_pair2::InitializeCustomizablePermissionlessLbPair2,
...
impl TryFrom<InitializeCustomizablePermissionlessLbPair2Row> for crate::instructions::initialize_customizable_permissionless_lb_pair2::InitializeCustomizablePermissionlessLbPair2 {
...
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeCustomizablePermissionlessLbPair2MigrationOperation
{
    async fn up(
        &self,
