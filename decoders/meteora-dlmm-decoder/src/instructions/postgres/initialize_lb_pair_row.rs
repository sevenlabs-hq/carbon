...
impl InitializeLbPairRow {
    pub fn from_parts(
        source: crate::instructions::initialize_lb_pair::InitializeLbPair,
...
impl TryFrom<InitializeLbPairRow> for crate::instructions::initialize_lb_pair::InitializeLbPair {
