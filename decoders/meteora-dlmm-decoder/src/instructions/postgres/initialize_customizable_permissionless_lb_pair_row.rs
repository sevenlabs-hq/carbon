...
impl InitializeCustomizablePermissionlessLbPairRow {
    pub fn from_parts(
        source: crate::instructions::initialize_customizable_permissionless_lb_pair::InitializeCustomizablePermissionlessLbPair,
...
impl TryFrom<InitializeCustomizablePermissionlessLbPairRow> for crate::instructions::initialize_customizable_permissionless_lb_pair::InitializeCustomizablePermissionlessLbPair {
...
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeCustomizablePermissionlessLbPairMigrationOperation
{
    async fn up(
        &self,
