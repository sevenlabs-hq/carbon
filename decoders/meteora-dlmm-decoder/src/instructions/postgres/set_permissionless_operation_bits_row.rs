...
impl SetPermissionlessOperationBitsRow {
    pub fn from_parts(
        source: crate::instructions::set_permissionless_operation_bits::SetPermissionlessOperationBits,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            bits: source.bits.into(),
            accounts: sqlx::types::Json(accounts),
        }
    }
}

impl TryFrom<SetPermissionlessOperationBitsRow>
    for crate::instructions::set_permissionless_operation_bits::SetPermissionlessOperationBits
{
    type Error = carbon_core::error::Error;
    fn try_from(source: SetPermissionlessOperationBitsRow) -> Result<Self, Self::Error> {
        Ok(Self {
            bits: source.bits.try_into().map_err(|_| {
...
impl carbon_core::postgres::operations::Insert for SetPermissionlessOperationBitsRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetPermissionlessOperationBitsRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Lookup for SetPermissionlessOperationBitsRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetPermissionlessOperationBitsMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetPermissionlessOperationBitsMigrationOperation {
    async fn up(
        &self,
