...
#[graphql(name = "CloseBinArray")]
pub struct CloseBinArrayGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseBinArrayRow> for CloseBinArrayGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::CloseBinArrayRow) -> Result<Self, Self::Error> {
        Ok(Self {
