...
#[graphql(name = "InitializeTokenBadge")]
pub struct InitializeTokenBadgeGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeTokenBadgeRow>
    for InitializeTokenBadgeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeTokenBadgeRow,
