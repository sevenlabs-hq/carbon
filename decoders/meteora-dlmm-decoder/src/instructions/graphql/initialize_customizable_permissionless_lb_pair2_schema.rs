...
use {crate::types::graphql::CustomizableParamsGraphQL, juniper::GraphQLObject, serde_json};
...
impl TryFrom<crate::instructions::postgres::InitializeCustomizablePermissionlessLbPair2Row>
    for InitializeCustomizablePermissionlessLbPair2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeCustomizablePermissionlessLbPair2Row,
