...
impl TryFrom<crate::instructions::postgres::UpdatePositionOperatorRow>
    for UpdatePositionOperatorGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdatePositionOperatorRow,
