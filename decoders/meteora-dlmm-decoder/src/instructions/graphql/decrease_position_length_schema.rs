...
impl TryFrom<crate::instructions::postgres::DecreasePositionLengthRow>
    for DecreasePositionLengthGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DecreasePositionLengthRow,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            instruction_metadata: row.instruction_metadata.into(),
            length_to_remove: *row.length_to_remove,
