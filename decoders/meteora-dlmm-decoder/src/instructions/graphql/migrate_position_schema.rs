...
#[graphql(name = "MigratePosition")]
pub struct MigratePositionGraphQL {
...
impl TryFrom<crate::instructions::postgres::MigratePositionRow> for MigratePositionGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::MigratePositionRow,
