...
#[graphql(name = "ClosePresetParameter2")]
pub struct ClosePresetParameter2GraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePresetParameter2Row>
    for ClosePresetParameter2GraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePresetParameter2Row,
