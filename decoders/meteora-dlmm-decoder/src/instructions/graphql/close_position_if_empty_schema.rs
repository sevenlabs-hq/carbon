...
#[graphql(name = "ClosePositionIfEmpty")]
pub struct ClosePositionIfEmptyGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePositionIfEmptyRow>
    for ClosePositionIfEmptyGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePositionIfEmptyRow,
