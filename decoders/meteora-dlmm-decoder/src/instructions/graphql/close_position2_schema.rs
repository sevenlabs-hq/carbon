...
#[graphql(name = "ClosePosition2")]
pub struct ClosePosition2GraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePosition2Row> for ClosePosition2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePosition2Row,
