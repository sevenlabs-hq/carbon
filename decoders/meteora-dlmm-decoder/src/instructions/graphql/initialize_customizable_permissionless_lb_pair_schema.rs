...
impl TryFrom<crate::instructions::postgres::InitializeCustomizablePermissionlessLbPairRow>
    for InitializeCustomizablePermissionlessLbPairGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeCustomizablePermissionlessLbPairRow,
