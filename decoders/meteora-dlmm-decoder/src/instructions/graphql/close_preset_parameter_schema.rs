...
#[graphql(name = "ClosePresetParameter")]
pub struct ClosePresetParameterGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePresetParameterRow>
    for ClosePresetParameterGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClosePresetParameterRow,
