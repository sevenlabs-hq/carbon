...
#[graphql(name = "UpdateFeesAndRewards")]
pub struct UpdateFeesAndRewardsGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateFeesAndRewardsRow>
    for UpdateFeesAndRewardsGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateFeesAndRewardsRow,
