...
#[graphql(name = "CloseTokenBadge")]
pub struct CloseTokenBadgeGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseTokenBadgeRow> for CloseTokenBadgeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseTokenBadgeRow,
