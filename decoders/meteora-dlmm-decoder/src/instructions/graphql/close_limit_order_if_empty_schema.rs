...
#[graphql(name = "CloseLimitOrderIfEmpty")]
pub struct CloseLimitOrderIfEmptyGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseLimitOrderIfEmptyRow>
    for CloseLimitOrderIfEmptyGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseLimitOrderIfEmptyRow,
