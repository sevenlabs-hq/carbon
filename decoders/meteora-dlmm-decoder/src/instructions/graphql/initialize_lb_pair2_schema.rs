...
use {crate::types::graphql::InitializeLbPair2ParamsGraphQL, juniper::GraphQLObject, serde_json};
...
pub struct InitializeLbPair2GraphQL {
    ...
    pub params: InitializeLbPair2ParamsGraphQL,
...
impl TryFrom<crate::instructions::postgres::InitializeLbPair2Row> for InitializeLbPair2GraphQL {
    ...
    fn try_from(
        row: crate::instructions::postgres::InitializeLbPair2Row,
