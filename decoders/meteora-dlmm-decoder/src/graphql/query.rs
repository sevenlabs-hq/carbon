...
impl QueryRoot {
    ...
    async fn bin_array(
        ...
        let row = crate::accounts::postgres::BinArrayRow::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
    ...
    async fn bin_array_bitmap_extension(
        ...
        let row = crate::accounts::postgres::BinArrayBitmapExtensionRow::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
        Ok(row.and_then(|row| row.try_into().ok()))
    }
    ...
    async fn dummy_zc_account(
        ...
        let row = crate::accounts::postgres::DummyZcAccountRow::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
        Ok(row.and_then(|row| row.try_into().ok()))
    }
    ...
    async fn lb_pair(
        ...
        let row = crate::accounts::postgres::LbPairRow::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
        Ok(row.and_then(|row| row.try_into().ok()))
    }
    ...
    async fn position_v2(
        ...
        let row = crate::accounts::postgres::PositionV2Row::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
        Ok(row.and_then(|row| row.try_into().ok()))
    }
    ...
    async fn preset_parameter(
        ...
        let row = crate::accounts::postgres::PresetParameterRow::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
        Ok(row.and_then(|row| row.try_into().ok()))
    }
    ...
    async fn preset_parameter2(
        ...
        let row = crate::accounts::postgres::PresetParameter2Row::lookup(pk, &context.pool)
            .await
            .map_err(|e| juniper::FieldError::new(e.to_string(), juniper::Value::null()))?;
        Ok(row.and_then(|row| row.try_into().ok()))
    }
    ...
    async fn list_close_claim_fee_operator_account(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::CloseClaimFeeOperatorAccountGraphQL>> {
    ...
    async fn close_position_if_empty(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_close_position_if_empty(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::ClosePositionIfEmptyGraphQL>> {
    ...
    async fn close_preset_parameter(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_close_preset_parameter(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::ClosePresetParameterGraphQL>> {
    ...
    async fn close_preset_parameter2(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_close_preset_parameter2(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::ClosePresetParameter2GraphQL>> {
    ...
    async fn increase_position_length2(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_increase_position_length2(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::IncreasePositionLength2GraphQL>> {
    ...
    async fn initialize_bin_array_bitmap_extension(
        context: &crate::graphql::context::GraphQLContext,
        signature: String,
        instruction_index: i32,
    ...
    async fn list_initialize_bin_array_bitmap_extension(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::InitializeBinArrayBitmapExtensionGraphQL>>
    ...
    async fn list_initialize_position2(
        context: &crate::graphql::context::GraphQLContext,
        limit: i32,
        offset: i32,
    ) -> FieldResult<Vec<crate::instructions::graphql::InitializePosition2GraphQL>> {
