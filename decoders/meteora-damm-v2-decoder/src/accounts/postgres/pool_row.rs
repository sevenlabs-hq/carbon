...
impl carbon_core::postgres::operations::Insert for PoolRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"
            INSERT INTO meteora_damm_v2_pool_account (
                "pool_fees",
                "token_a_mint",
                "token_b_mint",
                "token_a_vault",
...
impl carbon_core::postgres::operations::Upsert for PoolRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO meteora_damm_v2_pool_account (
                "pool_fees",
                "token_a_mint",
                "token_b_mint",
                "token_a_vault",
...
impl carbon_core::postgres::operations::Delete for PoolRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM meteora_damm_v2_pool_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for PoolRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM meteora_damm_v2_pool_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for PoolMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS meteora_damm_v2_pool_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS meteora_damm_v2_pool_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
