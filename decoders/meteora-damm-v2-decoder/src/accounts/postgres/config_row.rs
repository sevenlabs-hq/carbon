...
impl carbon_core::postgres::operations::Insert for ConfigRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO meteora_damm_v2_config_account (
                "vault_config_key",
                "pool_creator_authority",
                "pool_fees",
                "activation_type",
...
impl carbon_core::postgres::operations::Upsert for ConfigRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO meteora_damm_v2_config_account (
                "vault_config_key",
                "pool_creator_authority",
                "pool_fees",
                "activation_type",
...
impl carbon_core::postgres::operations::Delete for ConfigRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM meteora_damm_v2_config_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl carbon_core::postgres::operations::Lookup for ConfigRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM meteora_damm_v2_config_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for ConfigMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS meteora_damm_v2_config_account (
                -- Account data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS meteora_damm_v2_config_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
