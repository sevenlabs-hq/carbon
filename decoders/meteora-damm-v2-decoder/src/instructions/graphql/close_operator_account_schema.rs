...
#[graphql(name = "CloseOperatorAccount")]
pub struct CloseOperatorAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::CloseOperatorAccountRow>
    for CloseOperatorAccountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CloseOperatorAccountRow,
