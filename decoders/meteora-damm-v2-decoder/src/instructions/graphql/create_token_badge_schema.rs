...
#[graphql(name = "CreateTokenBadge")]
pub struct CreateTokenBadgeGraphQL {
...
impl TryFrom<crate::instructions::postgres::CreateTokenBadgeRow> for CreateTokenBadgeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CreateTokenBadgeRow,
