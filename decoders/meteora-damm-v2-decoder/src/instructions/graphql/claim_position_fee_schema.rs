...
#[graphql(name = "ClaimPositionFee")]
pub struct ClaimPositionFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClaimPositionFeeRow> for ClaimPositionFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ClaimPositionFeeRow,
