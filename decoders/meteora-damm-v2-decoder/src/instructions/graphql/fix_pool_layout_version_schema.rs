...
#[graphql(name = "FixPoolLayoutVersion")]
pub struct FixPoolLayoutVersionGraphQL {
...
impl TryFrom<crate::instructions::postgres::FixPoolLayoutVersionRow>
    for FixPoolLayoutVersionGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::FixPoolLayoutVersionRow,
