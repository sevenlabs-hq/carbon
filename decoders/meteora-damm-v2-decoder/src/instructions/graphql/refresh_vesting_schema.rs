...
#[graphql(name = "RefreshVesting")]
pub struct RefreshVestingGraphQL {
...
impl TryFrom<crate::instructions::postgres::RefreshVestingRow> for RefreshVestingGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RefreshVestingRow,
