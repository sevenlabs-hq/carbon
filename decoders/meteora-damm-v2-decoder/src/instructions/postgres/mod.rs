...
impl sqlx_migrator::Migration<sqlx::Postgres> for MeteoraDammV2InstructionsMigration {
    ...
    fn operations(&self) -> Vec<Box<dyn sqlx_migrator::Operation<sqlx::Postgres>>> {
        vec![
            ...
            Box::new(FixConfigFeeParamsMigrationOperation),
            Box::new(FixPoolFeeParamsMigrationOperation),
            Box::new(FixPoolLayoutVersionMigrationOperation),
            ...
            Box::new(LockInnerPositionMigrationOperation),
...
impl carbon_core::postgres::operations::Insert for MeteoraDammV2InstructionWithMetadata {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        let MeteoraDammV2InstructionWithMetadata(decoded_instruction, metadata, raw_accounts) =
            self;
        match decoded_instruction {
            MeteoraDammV2Instruction::AddLiquidity { data, .. } => {
            ...
            MeteoraDammV2Instruction::ClaimPositionFee { data, .. } => {
            ...
            MeteoraDammV2Instruction::ClaimProtocolFee { data, .. } => {
            ...
            MeteoraDammV2Instruction::ClaimReward { data, .. } => {
            ...
            MeteoraDammV2Instruction::CloseConfig { data, .. } => {
            ...
            MeteoraDammV2Instruction::CloseOperatorAccount { data, .. } => {
            ...
            MeteoraDammV2Instruction::ClosePosition { data, .. } => {
            ...
            MeteoraDammV2Instruction::CloseTokenBadge { data, .. } => {
            ...
            MeteoraDammV2Instruction::CreateConfig { data, .. } => {
            ...
            MeteoraDammV2Instruction::CreateDynamicConfig { data, .. } => {
            ...
            MeteoraDammV2Instruction::CreateOperatorAccount { data, .. } => {
            ...
            MeteoraDammV2Instruction::CreatePosition { data, .. } => {
            ...
            MeteoraDammV2Instruction::CreateTokenBadge { data, .. } => {
            ...
            MeteoraDammV2Instruction::DummyIx { data, .. } => {
            ...
            MeteoraDammV2Instruction::FixConfigFeeParams { data, .. } => {
                let row = fix_config_fee_params_row::FixConfigFeeParamsRow::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
            ...
            MeteoraDammV2Instruction::FixPoolFeeParams { data, .. } => {
                let row = fix_pool_fee_params_row::FixPoolFeeParamsRow::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
            ...
            MeteoraDammV2Instruction::FixPoolLayoutVersion { data, .. } => {
                let row = fix_pool_layout_version_row::FixPoolLayoutVersionRow::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
            ...
            MeteoraDammV2Instruction::FundReward { data, .. } => {
            ...
            MeteoraDammV2Instruction::InitializeCustomizablePool { data, .. } => {
                let row =
            ...
            MeteoraDammV2Instruction::InitializePool { data, .. } => {
            ...
            MeteoraDammV2Instruction::InitializePoolWithDynamicConfig { data, .. } => {
                let row = initialize_pool_with_dynamic_config_row::InitializePoolWithDynamicConfigRow::from_parts(data.clone(), metadata.clone(), raw_accounts.clone());
                row.insert(pool).await?;
                Ok(())
            }
            MeteoraDammV2Instruction::InitializeReward { data, .. } => {
            ...
            MeteoraDammV2Instruction::LockInnerPosition { data, .. } => {
                let row = lock_inner_position_row::LockInnerPositionRow::from_parts(
                    data.clone(),
                    metadata.clone(),
                    raw_accounts.clone(),
                );
            ...
            MeteoraDammV2Instruction::LockPosition { data, .. } => {
            ...
            MeteoraDammV2Instruction::PermanentLockPosition { data, .. } => {
            ...
            MeteoraDammV2Instruction::RefreshVesting { data, .. } => {
            ...
            MeteoraDammV2Instruction::RemoveAllLiquidity { data, .. } => {
            ...
            MeteoraDammV2Instruction::RemoveLiquidity { data, .. } => {
            ...
            MeteoraDammV2Instruction::SetPoolStatus { data, .. } => {
            ...
            MeteoraDammV2Instruction::SplitPosition { data, .. } => {
            ...
            MeteoraDammV2Instruction::SplitPosition2 { data, .. } => {
            ...
            MeteoraDammV2Instruction::Swap { data, .. } => {
            ...
            MeteoraDammV2Instruction::Swap2 { data, .. } => {
            ...
            MeteoraDammV2Instruction::UpdatePoolFees { data, .. } => {
            ...
            MeteoraDammV2Instruction::UpdateRewardDuration { data, .. } => {
            ...
            MeteoraDammV2Instruction::UpdateRewardFunder { data, .. } => {
            ...
            MeteoraDammV2Instruction::WithdrawIneligibleReward { data, .. } => {
            ...
            MeteoraDammV2Instruction::ZapProtocolFee { data, .. } => {
