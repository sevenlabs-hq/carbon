...
pub use self::{
    ...
    dummy_ix_row::*, fix_config_fee_params_row::*, fix_pool_fee_params_row::*, fund_reward_row::*,
    initialize_customizable_pool_row::*, initialize_pool_row::*,
    initialize_pool_with_dynamic_config_row::*, initialize_reward_row::*,
...
impl carbon_core::postgres::operations::Insert for MeteoraDammV2InstructionWithMetadata {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        match decoded_instruction {
            ...
            MeteoraDammV2Instruction::ClaimPartnerFee { data, .. } => {
