...
impl SetPoolStatusRow {
    pub fn from_parts(
        source: crate::instructions::set_pool_status::SetPoolStatus,
...
impl TryFrom<SetPoolStatusRow> for crate::instructions::set_pool_status::SetPoolStatus {
    type Error = carbon_core::error::Error;
    fn try_from(source: SetPoolStatusRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SetPoolStatusRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetPoolStatusRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SetPoolStatusRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SetPoolStatusMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetPoolStatusMigrationOperation {
    async fn up(
        &self,
