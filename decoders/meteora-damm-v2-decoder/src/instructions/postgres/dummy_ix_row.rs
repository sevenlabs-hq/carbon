...
pub struct DummyIxRow {
    ...
    pub ixs: sqlx::types::Json<DummyParams>,
...
impl DummyIxRow {
    pub fn from_parts(
        source: crate::instructions::dummy_ix::DummyIx,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            ixs: sqlx::types::Json(source.ixs),
            accounts: sqlx::types::Json(accounts),
        }
    }
}

impl TryFrom<DummyIxRow> for crate::instructions::dummy_ix::DummyIx {
    type Error = carbon_core::error::Error;
    fn try_from(source: DummyIxRow) -> Result<Self, Self::Error> {
        Ok(Self { ixs: source.ixs.0 })
    }
}
...
impl carbon_core::postgres::operations::Insert for DummyIxRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DummyIxRow {
    type Key = (
        String,
...
pub struct DummyIxMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for DummyIxMigrationOperation {
    async fn up(
        &self,
