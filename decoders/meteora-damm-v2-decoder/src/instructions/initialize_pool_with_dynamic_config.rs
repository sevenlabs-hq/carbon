...
impl CarbonDeserialize for InitializePoolWithDynamicConfig {
    const DISCRIMINATOR: &'static [u8] = &[149, 82, 72, 197, 253, 252, 68, 15];
...
impl ArrangeAccounts for InitializePoolWithDynamicConfig {
