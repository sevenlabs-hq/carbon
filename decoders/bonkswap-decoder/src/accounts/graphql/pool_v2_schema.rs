...
use {
    crate::types::graphql::{FixedPointGraphQL, ProductGraphQL, TokenGraphQL},
...
impl TryFrom<crate::accounts::postgres::PoolV2Row> for PoolV2GraphQL {
    ...
    fn try_from(row: crate::accounts::postgres::PoolV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            token_x: carbon_core::graphql::primitives::Pubkey(row.token_x.0),
            token_y: carbon_core::graphql::primitives::Pubkey(row.token_y.0),
            pool_x_account: carbon_core::graphql::primitives::Pubkey(row.pool_x_account.0),
            pool_y_account: carbon_core::graphql::primitives::Pubkey(row.pool_y_account.0),
            admin: carbon_core::graphql::primitives::Pubkey(row.admin.0),
            project_owner: carbon_core::graphql::primitives::Pubkey(row.project_owner.0),
            ...
            lp_token: carbon_core::graphql::primitives::Pubkey(row.lp_token.0),
