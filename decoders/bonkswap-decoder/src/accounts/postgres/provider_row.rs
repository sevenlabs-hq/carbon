...
impl ProviderRow {
    pub fn from_parts(
        source: crate::accounts::provider::Provider,
...
impl TryFrom<ProviderRow> for crate::accounts::provider::Provider {
...
impl carbon_core::postgres::operations::Insert for ProviderRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(self.owner)
        .bind(&self.shares)
        .bind(&self.last_fee_accumulator_x)
        .bind(&self.last_fee_accumulator_y)
        .bind(&self.last_seconds_per_share)
        .bind(&self.last_withdraw_time)
        .bind(&self.tokens_owed_x)
        .bind(&self.tokens_owed_y)
        .bind(&self.current_farm_count)
        .bind(self.bump)
