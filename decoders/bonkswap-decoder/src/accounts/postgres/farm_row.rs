...
impl FarmRow {
    pub fn from_parts(source: crate::accounts::farm::Farm, metadata: AccountMetadata) -> Self {
        Self {
            ...
            token_accounts: source
                ...
                .map(|element| element.into())
                .collect(),
            supply: sqlx::types::Json(source.supply.to_vec()),
            supply_left: sqlx::types::Json(source.supply_left.to_vec()),
...
impl TryFrom<FarmRow> for crate::accounts::farm::Farm {
...
impl carbon_core::postgres::operations::Insert for FarmRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        ...
        .bind(self.pool)
        .bind(&self.tokens)
        .bind(&self.token_accounts)
        .bind(&self.supply)
        .bind(&self.supply_left)
        .bind(&self.accumulated_seconds_per_share)
        .bind(&self.offset_seconds_per_share)
