...
impl PoolV2Row {
    pub fn from_parts(source: crate::accounts::pool_v2::PoolV2, metadata: AccountMetadata) -> Self {
        Self {
            ...
            lp_token: source.lp_token.into(),
            lp_token_mint_bump: source.lp_token_mint_bump.into(),
            padding: source
                .padding
                .into_iter()
...
impl TryFrom<PoolV2Row> for crate::accounts::pool_v2::PoolV2 {
    type Error = carbon_core::error::Error;
    fn try_from(source: PoolV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            lp_token: *source.lp_token,
            lp_token_mint_bump: source.lp_token_mint_bump.try_into().map_err(|_| {
                carbon_core::error::Error::Custom(
                    "Failed to convert value from postgres primitive".to_string(),
                )
            })?,
...
impl carbon_core::postgres::operations::Table for crate::accounts::pool_v2::PoolV2 {
    fn table() -> &'static str {
        "bonkswap_pool_v2_account"
    }
...
impl carbon_core::postgres::operations::Insert for PoolV2Row {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"
            INSERT INTO bonkswap_pool_v2_account (
                "token_x",
                "token_y",
                "pool_x_account",
                "pool_y_account",
        ...
        .bind(&self.token_x_reserve)
        .bind(&self.token_y_reserve)
        .bind(&self.self_shares)
        .bind(&self.all_shares)
        .bind(&self.buyback_amount_x)
        .bind(&self.buyback_amount_y)
        .bind(&self.project_amount_x)
        .bind(&self.project_amount_y)
        .bind(&self.mercanti_amount_x)
        .bind(&self.mercanti_amount_y)
        .bind(&self.lp_accumulator_x)
        .bind(&self.lp_accumulator_y)
        .bind(&self.const_k)
        .bind(&self.price)
        .bind(&self.lp_fee)
        ...
        .bind(&self.farm_count)
        .bind(self.pool_bump)
        .bind(self.lp_token)
        .bind(self.lp_token_mint_bump)
        .bind(&self.padding)
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Upsert for PoolV2Row {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO bonkswap_pool_v2_account (
                "token_x",
                "token_y",
                "pool_x_account",
                "pool_y_account",
                ...
                "lp_token_mint_bump" = EXCLUDED."lp_token_mint_bump",
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for PoolV2Row {
    type Key = carbon_core::postgres::primitives::Pubkey;

    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM bonkswap_pool_v2_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Lookup for PoolV2Row {
    type Key = carbon_core::postgres::primitives::Pubkey;
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM bonkswap_pool_v2_account WHERE
                __pubkey = $1
            "#,
        )
        .bind(key)
...
pub struct PoolV2MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for PoolV2MigrationOperation {
    async fn up(
        &self,
        connection: &mut sqlx::PgConnection,
    ) -> Result<(), sqlx_migrator::error::Error> {
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS bonkswap_pool_v2_account (
                -- Account data
                ...
                "lp_token" BYTEA NOT NULL,
                "lp_token_mint_bump" INT2 NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS bonkswap_pool_v2_account"#)
            .execute(connection)
            .await?;
        Ok(())
    }
