...
impl carbon_core::postgres::operations::Insert for CreatePoolRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO bonkswap_create_pool_instruction (
                "lp_fee",
                "buyback_fee",
                "project_fee",
                "mercanti_fee",
...
impl carbon_core::postgres::operations::Upsert for CreatePoolRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO bonkswap_create_pool_instruction (
                "lp_fee",
                "buyback_fee",
                "project_fee",
                "mercanti_fee",
...
impl carbon_core::postgres::operations::Delete for CreatePoolRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM bonkswap_create_pool_instruction WHERE
...
impl carbon_core::postgres::operations::Lookup for CreatePoolRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM bonkswap_create_pool_instruction WHERE
                __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
            "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CreatePoolMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS bonkswap_create_pool_instruction (
                -- Instruction data
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS bonkswap_create_pool_instruction"#)
            .execute(connection)
            .await?;
        Ok(())
    }
