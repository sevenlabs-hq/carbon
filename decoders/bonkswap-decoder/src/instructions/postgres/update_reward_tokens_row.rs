...
use crate::instructions::UpdateRewardTokens;
...
impl UpdateRewardTokensRow {
    pub fn from_parts(_source: UpdateRewardTokens, metadata: InstructionMetadata) -> Self {
        Self {
...
impl TryFrom<UpdateRewardTokensRow> for UpdateRewardTokens {
    type Error = carbon_core::error::Error;
    fn try_from(_source: UpdateRewardTokensRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}

impl carbon_core::postgres::operations::Table for UpdateRewardTokens {
    fn table() -> &'static str {
...
impl carbon_core::postgres::operations::Insert for UpdateRewardTokensRow {
...
impl carbon_core::postgres::operations::Upsert for UpdateRewardTokensRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO update_reward_tokens_instruction (
                                    __signature, __instruction_index, __stack_height, __slot
                    ) VALUES (
                                                                        $1,                        $2,                        $3,                        $4                    ) ON CONFLICT (
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateRewardTokensRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateRewardTokensRow {
    type Key = (String, carbon_core::postgres::primitives::U32);
...
pub struct UpdateRewardTokensMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateRewardTokensMigrationOperation {
    async fn up(
        &self,
