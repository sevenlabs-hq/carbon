...
impl CreateTripleFarmRow {
    pub fn from_parts(
        source: crate::instructions::create_triple_farm::CreateTripleFarm,
...
impl TryFrom<CreateTripleFarmRow> for crate::instructions::create_triple_farm::CreateTripleFarm {
