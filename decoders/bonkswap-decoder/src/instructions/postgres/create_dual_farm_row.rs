...
use crate::instructions::CreateDualFarm;
...
impl TryFrom<CreateDualFarmRow> for CreateDualFarm {
...
impl carbon_core::postgres::operations::Table for CreateDualFarm {
    fn table() -> &'static str {
...
impl carbon_core::postgres::operations::Upsert for CreateDualFarmRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO create_dual_farm_instruction (
                        "supply_marco",
                        "supply_project_first",
                        "duration",
                        "bump",
