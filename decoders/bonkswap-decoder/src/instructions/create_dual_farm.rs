...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CreateDualFarmInstructionAccounts {
    #[cfg_attr(
        feature = "base58",
...
impl CarbonDeserialize for CreateDualFarm {
    const DISCRIMINATOR: &'static [u8] = &[42, 180, 103, 138, 206, 43, 208, 98];
...
impl ArrangeAccounts for CreateDualFarm {
    type ArrangedAccounts = CreateDualFarmInstructionAccounts;
    ...
    fn arrange_accounts(
        ...
        Some(CreateDualFarmInstructionAccounts {
            state,
            pool,
            farm,
            token_x,
