...
#[graphql(name = "ResetFarm")]
pub struct ResetFarmGraphQL {
...
impl TryFrom<crate::instructions::postgres::ResetFarmRow> for ResetFarmGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ResetFarmRow) -> Result<Self, Self::Error> {
        Ok(Self {
