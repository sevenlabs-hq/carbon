...
#[graphql(name = "UpdateRewardTokens")]
pub struct UpdateRewardTokensGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateRewardTokensRow> for UpdateRewardTokensGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateRewardTokensRow,
