...
#[graphql(name = "WithdrawLpFee")]
pub struct WithdrawLpFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawLpFeeRow> for WithdrawLpFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::WithdrawLpFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
