...
#[graphql(name = "WithdrawRewards")]
pub struct WithdrawRewardsGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawRewardsRow> for WithdrawRewardsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawRewardsRow,
