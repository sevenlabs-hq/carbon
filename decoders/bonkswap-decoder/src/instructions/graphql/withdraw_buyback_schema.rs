...
#[graphql(name = "WithdrawBuyback")]
pub struct WithdrawBuybackGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawBuybackRow> for WithdrawBuybackGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawBuybackRow,
