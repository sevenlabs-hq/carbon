...
#[graphql(name = "ClosePool")]
pub struct ClosePoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::ClosePoolRow> for ClosePoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ClosePoolRow) -> Result<Self, Self::Error> {
        Ok(Self {
