...
#[graphql(name = "WithdrawMercantiFee")]
pub struct WithdrawMercantiFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawMercantiFeeRow> for WithdrawMercantiFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawMercantiFeeRow,
