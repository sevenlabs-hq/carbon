...
#[graphql(name = "WithdrawProjectFee")]
pub struct WithdrawProjectFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawProjectFeeRow> for WithdrawProjectFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawProjectFeeRow,
