...
#[graphql(name = "InitClaimAccount")]
pub struct InitClaimAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitClaimAccountRow> for InitClaimAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitClaimAccountRow,
