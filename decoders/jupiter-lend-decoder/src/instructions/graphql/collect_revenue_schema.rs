...
#[graphql(name = "CollectRevenue")]
pub struct CollectRevenueGraphQL {
...
impl TryFrom<crate::instructions::postgres::CollectRevenueRow> for CollectRevenueGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::CollectRevenueRow,
