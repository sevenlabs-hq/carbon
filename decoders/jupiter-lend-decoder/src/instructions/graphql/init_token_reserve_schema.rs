...
#[graphql(name = "InitTokenReserve")]
pub struct InitTokenReserveGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitTokenReserveRow> for InitTokenReserveGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitTokenReserveRow,
