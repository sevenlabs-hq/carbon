...
#[graphql(name = "WithdrawFromFarmVault")]
pub struct WithdrawFromFarmVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawFromFarmVaultRow>
    for WithdrawFromFarmVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawFromFarmVaultRow,
