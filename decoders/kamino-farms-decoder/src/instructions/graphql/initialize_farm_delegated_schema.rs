...
#[graphql(name = "InitializeFarmDelegated")]
pub struct InitializeFarmDelegatedGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeFarmDelegatedRow>
    for InitializeFarmDelegatedGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeFarmDelegatedRow,
