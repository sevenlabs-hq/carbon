...
#[graphql(name = "RefreshFarm")]
pub struct RefreshFarmGraphQL {
...
impl TryFrom<crate::instructions::postgres::RefreshFarmRow> for RefreshFarmGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RefreshFarmRow) -> Result<Self, Self::Error> {
        Ok(Self {
