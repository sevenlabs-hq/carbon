...
#[graphql(name = "WithdrawSlashedAmount")]
pub struct WithdrawSlashedAmountGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawSlashedAmountRow>
    for WithdrawSlashedAmountGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawSlashedAmountRow,
