...
#[graphql(name = "AddRewards")]
pub struct AddRewardsGraphQL {
...
impl TryFrom<crate::instructions::postgres::AddRewardsRow> for AddRewardsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AddRewardsRow) -> Result<Self, Self::Error> {
        Ok(Self {
