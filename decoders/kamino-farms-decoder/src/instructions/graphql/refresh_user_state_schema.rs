...
#[graphql(name = "RefreshUserState")]
pub struct RefreshUserStateGraphQL {
...
impl TryFrom<crate::instructions::postgres::RefreshUserStateRow> for RefreshUserStateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RefreshUserStateRow,
