...
#[graphql(name = "DepositToFarmVault")]
pub struct DepositToFarmVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositToFarmVaultRow> for DepositToFarmVaultGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositToFarmVaultRow,
