...
#[graphql(name = "WithdrawTreasury")]
pub struct WithdrawTreasuryGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawTreasuryRow> for WithdrawTreasuryGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawTreasuryRow,
