...
#[graphql(name = "InitializeFarm")]
pub struct InitializeFarmGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeFarmRow> for InitializeFarmGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeFarmRow,
