...
#[graphql(name = "InitializeGlobalConfig")]
pub struct InitializeGlobalConfigGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeGlobalConfigRow>
    for InitializeGlobalConfigGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeGlobalConfigRow,
