...
#[graphql(name = "WithdrawReward")]
pub struct WithdrawRewardGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawRewardRow> for WithdrawRewardGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawRewardRow,
