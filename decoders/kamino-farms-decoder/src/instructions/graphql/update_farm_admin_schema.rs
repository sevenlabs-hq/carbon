...
#[graphql(name = "UpdateFarmAdmin")]
pub struct UpdateFarmAdminGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateFarmAdminRow> for UpdateFarmAdminGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateFarmAdminRow,
