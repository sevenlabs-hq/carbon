...
impl StakeRow {
    pub fn from_parts(
        source: crate::instructions::stake::Stake,
...
impl TryFrom<StakeRow> for crate::instructions::stake::Stake {
    type Error = carbon_core::error::Error;
    fn try_from(source: StakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for StakeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for StakeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for StakeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct StakeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for StakeMigrationOperation {
    async fn up(
        &self,
