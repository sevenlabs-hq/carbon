...
impl SetStakeDelegatedRow {
    pub fn from_parts(
        source: crate::instructions::set_stake_delegated::SetStakeDelegated,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            new_amount: source.new_amount.into(),
            accounts: sqlx::types::Json(accounts),
        }
    }
}

impl TryFrom<SetStakeDelegatedRow> for crate::instructions::set_stake_delegated::SetStakeDelegated {
    type Error = carbon_core::error::Error;
    fn try_from(source: SetStakeDelegatedRow) -> Result<Self, Self::Error> {
        Ok(Self {
            new_amount: *source.new_amount,
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for SetStakeDelegatedRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SetStakeDelegatedRow {
    type Key = (
        String,
...
pub struct SetStakeDelegatedMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SetStakeDelegatedMigrationOperation {
    async fn up(
        &self,
