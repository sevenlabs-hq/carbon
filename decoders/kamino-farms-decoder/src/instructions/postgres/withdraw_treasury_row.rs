...
impl WithdrawTreasuryRow {
    pub fn from_parts(
        source: crate::instructions::withdraw_treasury::WithdrawTreasury,
...
impl TryFrom<WithdrawTreasuryRow> for crate::instructions::withdraw_treasury::WithdrawTreasury {
    type Error = carbon_core::error::Error;
    fn try_from(source: WithdrawTreasuryRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for WithdrawTreasuryRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for WithdrawTreasuryRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for WithdrawTreasuryRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct WithdrawTreasuryMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for WithdrawTreasuryMigrationOperation {
    async fn up(
        &self,
