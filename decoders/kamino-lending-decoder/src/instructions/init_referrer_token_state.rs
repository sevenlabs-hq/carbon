...
impl CarbonDeserialize for InitReferrerTokenState {
    const DISCRIMINATOR: &'static [u8] = &[116, 45, 66, 148, 58, 13, 218, 115];
...
impl ArrangeAccounts for InitReferrerTokenState {
