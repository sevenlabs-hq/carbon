...
impl
    TryFrom<(
        crate::instructions::withdraw_obligation_collateral_and_redeem_reserve_collateral::WithdrawObligationCollateralAndRedeemReserveCollateral,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::withdraw_obligation_collateral_and_redeem_reserve_collateral::WithdrawObligationCollateralAndRedeemReserveCollateralInstructionAccounts,
...
impl carbon_core::clickhouse::Table for WithdrawObligationCollateralAndRedeemReserveCollateralRow {
    fn table() -> &'static str {
        "kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction"
    }
}
...
pub struct WithdrawObligationCollateralAndRedeemReserveCollateralRowMigrationOperation;
    ...
    for WithdrawObligationCollateralAndRedeemReserveCollateralRowMigrationOperation
{
    async fn up(
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction ON CLUSTER {cluster} AS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
    ...
    for WithdrawObligationCollateralAndRedeemReserveCollateralRowMigrationOperation
{
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
    ...
    async fn down(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query("DROP TABLE IF EXISTS kamino_lending_withdraw_obligation_collateral_and_redeem_reserve_collateral_instruction")
            .execute()
            .await?;
