...
impl WithdrawObligationCollateralAndRedeemReserveCollateralV2Row {
    pub fn from_parts(
        source: crate::instructions::withdraw_obligation_collateral_and_redeem_reserve_collateral_v2::WithdrawObligationCollateralAndRedeemReserveCollateralV2,
...
impl TryFrom<WithdrawObligationCollateralAndRedeemReserveCollateralV2Row> for crate::instructions::withdraw_obligation_collateral_and_redeem_reserve_collateral_v2::WithdrawObligationCollateralAndRedeemReserveCollateralV2 {
    type Error = carbon_core::error::Error;
    fn try_from(source: WithdrawObligationCollateralAndRedeemReserveCollateralV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
...
pub struct WithdrawObligationCollateralAndRedeemReserveCollateralV2MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for WithdrawObligationCollateralAndRedeemReserveCollateralV2MigrationOperation
{
    async fn up(
        &self,
