...
impl LiquidateObligationAndRedeemReserveCollateralV2Row {
    pub fn from_parts(
        source: crate::instructions::liquidate_obligation_and_redeem_reserve_collateral_v2::LiquidateObligationAndRedeemReserveCollateralV2,
...
impl TryFrom<LiquidateObligationAndRedeemReserveCollateralV2Row> for crate::instructions::liquidate_obligation_and_redeem_reserve_collateral_v2::LiquidateObligationAndRedeemReserveCollateralV2 {
    type Error = carbon_core::error::Error;
    fn try_from(source: LiquidateObligationAndRedeemReserveCollateralV2Row) -> Result<Self, Self::Error> {
        Ok(Self {
...
pub struct LiquidateObligationAndRedeemReserveCollateralV2MigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for LiquidateObligationAndRedeemReserveCollateralV2MigrationOperation
{
    async fn up(
        &self,
