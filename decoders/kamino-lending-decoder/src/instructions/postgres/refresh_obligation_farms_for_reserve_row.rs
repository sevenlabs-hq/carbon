...
impl RefreshObligationFarmsForReserveRow {
    pub fn from_parts(
        source: crate::instructions::refresh_obligation_farms_for_reserve::RefreshObligationFarmsForReserve,
...
impl TryFrom<RefreshObligationFarmsForReserveRow>
    for crate::instructions::refresh_obligation_farms_for_reserve::RefreshObligationFarmsForReserve
{
    type Error = carbon_core::error::Error;
    fn try_from(source: RefreshObligationFarmsForReserveRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for RefreshObligationFarmsForReserveRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RefreshObligationFarmsForReserveRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for RefreshObligationFarmsForReserveRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct RefreshObligationFarmsForReserveMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for RefreshObligationFarmsForReserveMigrationOperation
{
    async fn up(
        &self,
