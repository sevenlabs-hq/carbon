...
impl InitReserveRow {
    pub fn from_parts(
        _source: crate::instructions::init_reserve::InitReserve,
...
impl TryFrom<InitReserveRow> for crate::instructions::init_reserve::InitReserve {
    type Error = carbon_core::error::Error;
    fn try_from(_source: InitReserveRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for InitReserveRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitReserveRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitReserveRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitReserveMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitReserveMigrationOperation {
    async fn up(
        &self,
