...
impl ApproveObligationOwnershipTransferRow {
    pub fn from_parts(
        _source: crate::instructions::approve_obligation_ownership_transfer::ApproveObligationOwnershipTransfer,
...
impl TryFrom<ApproveObligationOwnershipTransferRow> for crate::instructions::approve_obligation_ownership_transfer::ApproveObligationOwnershipTransfer {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ApproveObligationOwnershipTransferRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for ApproveObligationOwnershipTransferRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ApproveObligationOwnershipTransferRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Lookup for ApproveObligationOwnershipTransferRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ApproveObligationOwnershipTransferMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for ApproveObligationOwnershipTransferMigrationOperation
{
    async fn up(
        &self,
