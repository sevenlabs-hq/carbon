...
impl RepayObligationLiquidityRow {
    pub fn from_parts(
        source: crate::instructions::repay_obligation_liquidity::RepayObligationLiquidity,
...
impl TryFrom<RepayObligationLiquidityRow>
    for crate::instructions::repay_obligation_liquidity::RepayObligationLiquidity
{
    type Error = carbon_core::error::Error;
    fn try_from(source: RepayObligationLiquidityRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for RepayObligationLiquidityRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RepayObligationLiquidityRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for RepayObligationLiquidityRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct RepayObligationLiquidityMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RepayObligationLiquidityMigrationOperation {
    async fn up(
        &self,
