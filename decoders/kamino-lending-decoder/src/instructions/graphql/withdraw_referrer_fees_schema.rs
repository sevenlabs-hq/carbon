...
#[graphql(name = "WithdrawReferrerFees")]
pub struct WithdrawReferrerFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawReferrerFeesRow>
    for WithdrawReferrerFeesGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawReferrerFeesRow,
