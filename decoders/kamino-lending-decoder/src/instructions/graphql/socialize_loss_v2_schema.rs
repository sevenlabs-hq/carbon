...
#[graphql(name = "SocializeLossV2")]
pub struct SocializeLossV2GraphQL {
...
impl TryFrom<crate::instructions::postgres::SocializeLossV2Row> for SocializeLossV2GraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SocializeLossV2Row,
