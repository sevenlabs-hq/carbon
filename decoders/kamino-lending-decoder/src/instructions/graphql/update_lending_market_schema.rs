...
#[graphql(name = "UpdateLendingMarket")]
pub struct UpdateLendingMarketGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateLendingMarketRow> for UpdateLendingMarketGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateLendingMarketRow,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
            instruction_metadata: row.instruction_metadata.into(),
            mode: carbon_core::graphql::primitives::U64(*row.mode),
            value: row
                .value
                .into_iter()
