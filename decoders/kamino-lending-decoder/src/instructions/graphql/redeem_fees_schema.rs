...
#[graphql(name = "RedeemFees")]
pub struct RedeemFeesGraphQL {
...
impl TryFrom<crate::instructions::postgres::RedeemFeesRow> for RedeemFeesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RedeemFeesRow) -> Result<Self, Self::Error> {
        Ok(Self {
