...
#[graphql(name = "TopupReserveRewards")]
pub struct TopupReserveRewardsGraphQL {
...
impl TryFrom<crate::instructions::postgres::TopupReserveRewardsRow> for TopupReserveRewardsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TopupReserveRewardsRow,
