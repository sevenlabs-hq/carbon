...
#[graphql(name = "RolloverFixedTermBorrow")]
pub struct RolloverFixedTermBorrowGraphQL {
...
impl TryFrom<crate::instructions::postgres::RolloverFixedTermBorrowRow>
    for RolloverFixedTermBorrowGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RolloverFixedTermBorrowRow,
