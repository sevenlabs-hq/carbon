...
#[graphql(name = "WithdrawQueuedLiquidity")]
pub struct WithdrawQueuedLiquidityGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawQueuedLiquidityRow>
    for WithdrawQueuedLiquidityGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::WithdrawQueuedLiquidityRow,
