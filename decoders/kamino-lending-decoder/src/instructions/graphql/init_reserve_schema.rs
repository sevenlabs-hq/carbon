...
#[graphql(name = "InitReserve")]
pub struct InitReserveGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitReserveRow> for InitReserveGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::InitReserveRow) -> Result<Self, Self::Error> {
        Ok(Self {
