...
#[graphql(name = "RefreshReserve")]
pub struct RefreshReserveGraphQL {
...
impl TryFrom<crate::instructions::postgres::RefreshReserveRow> for RefreshReserveGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RefreshReserveRow,
