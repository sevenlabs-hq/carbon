...
#[graphql(name = "RefreshObligation")]
pub struct RefreshObligationGraphQL {
...
impl TryFrom<crate::instructions::postgres::RefreshObligationRow> for RefreshObligationGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RefreshObligationRow,
