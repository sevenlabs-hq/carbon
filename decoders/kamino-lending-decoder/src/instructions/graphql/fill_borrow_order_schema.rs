...
#[graphql(name = "FillBorrowOrder")]
pub struct FillBorrowOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::FillBorrowOrderRow> for FillBorrowOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::FillBorrowOrderRow,
