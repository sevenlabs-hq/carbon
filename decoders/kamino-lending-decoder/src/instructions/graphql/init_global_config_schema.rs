...
#[graphql(name = "InitGlobalConfig")]
pub struct InitGlobalConfigGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitGlobalConfigRow> for InitGlobalConfigGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitGlobalConfigRow,
