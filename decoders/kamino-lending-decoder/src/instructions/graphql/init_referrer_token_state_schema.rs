...
#[graphql(name = "InitReferrerTokenState")]
pub struct InitReferrerTokenStateGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitReferrerTokenStateRow>
    for InitReferrerTokenStateGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitReferrerTokenStateRow,
