...
impl CarbonDeserialize for InitReferrerStateAndShortUrl {
    const DISCRIMINATOR: &'static [u8] = &[165, 19, 25, 127, 100, 55, 31, 90];
...
impl ArrangeAccounts for InitReferrerStateAndShortUrl {
    ...
    fn arrange_accounts(
        ...
        let referrer_short_url = next_account(&mut iter)?;
