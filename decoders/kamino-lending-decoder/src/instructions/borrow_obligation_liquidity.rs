...
impl CarbonDeserialize for BorrowObligationLiquidity {
    const DISCRIMINATOR: &'static [u8] = &[121, 127, 18, 204, 73, 245, 225, 65];
...
impl ArrangeAccounts for BorrowObligationLiquidity {
