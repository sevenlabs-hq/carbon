...
impl CarbonDeserialize for WithdrawObligationCollateralAndRedeemReserveCollateral {
    const DISCRIMINATOR: &'static [u8] = &[75, 93, 93, 220, 34, 150, 218, 196];
...
impl ArrangeAccounts for WithdrawObligationCollateralAndRedeemReserveCollateral {
