...
/// the program owner and referral fee. The fees are paid out as a percentage of
/// liquidity token amounts during repayments and liquidations.
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(Debug, Clone, borsh::BorshSerialize, borsh::BorshDeserialize, PartialEq)]
pub struct ReserveFees {
    /// Fee assessed on `BorrowObligationLiquidity`, as scaled fraction (60 bits
    /// fractional part) Must be between `0` and `2^60`, such that `2^60 =
