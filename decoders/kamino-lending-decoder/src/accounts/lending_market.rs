...
use {
    crate::types::ElevationGroup, carbon_core::deserialize::CarbonDeserialize,
...
impl CarbonDeserialize for LendingMarket {
    const DISCRIMINATOR: &'static [u8] = &[246, 114, 50, 98, 72, 157, 28, 120];
