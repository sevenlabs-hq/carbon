...
use {
    crate::types::ConstituentSpotBalance, carbon_core::deserialize::CarbonDeserialize,
...
impl CarbonDeserialize for Constituent {
    const DISCRIMINATOR: &'static [u8] = &[0, 61, 36, 35, 177, 76, 216, 205];
