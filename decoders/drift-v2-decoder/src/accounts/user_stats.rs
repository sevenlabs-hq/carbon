...
use {crate::types::UserFees, carbon_core::deserialize::CarbonDeserialize, solana_pubkey::Pubkey};
...
impl CarbonDeserialize for UserStats {
    const DISCRIMINATOR: &'static [u8] = &[176, 223, 136, 27, 122, 79, 32, 227];
