...
use crate::types::{MarketType, OrderStatus, OrderTriggerCondition, OrderType, PositionDirection};
...
pub struct Order {
    ...
    /// For orders with an auction, this price isn't used until the auction is
    /// complete precision: PRICE_PRECISION
    pub price: u64,
    ...
    /// At what price the order will be triggered. Only relevant for trigger
    /// orders precision: PRICE_PRECISION
    ...
    /// Whether the order is triggered above or below the trigger price. Only
    /// relevant for trigger orders
    pub trigger_condition: OrderTriggerCondition,
    /// How many slots the auction lasts
    pub auction_duration: u8,
    /// Last 8 bits of the slot the order was posted on-chain (not order slot
    /// for signed msg orders)
