...
pub struct InsuranceClaim {
    ...
    /// The max amount of insurance that perp market can use to resolve
    /// bankruptcy and pnl deficits precision: QUOTE_PRECISION
    pub quote_max_insurance: u64,
    /// The amount of insurance that has been used to resolve bankruptcy and pnl
    /// deficits precision: QUOTE_PRECISION
