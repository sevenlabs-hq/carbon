...
impl UpdateIfRebalanceConfigRow {
    pub fn from_parts(
        source: crate::instructions::update_if_rebalance_config::UpdateIfRebalanceConfig,
    ...
    for crate::instructions::update_if_rebalance_config::UpdateIfRebalanceConfig
{
    ...
    fn try_from(source: UpdateIfRebalanceConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdateIfRebalanceConfigRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateIfRebalanceConfigRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateIfRebalanceConfigRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateIfRebalanceConfigMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateIfRebalanceConfigMigrationOperation {
    async fn up(
        &self,
