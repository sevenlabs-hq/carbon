...
impl ReclaimRentRow {
    pub fn from_parts(
        _source: crate::instructions::reclaim_rent::ReclaimRent,
...
impl TryFrom<ReclaimRentRow> for crate::instructions::reclaim_rent::ReclaimRent {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ReclaimRentRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ReclaimRentRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ReclaimRentRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ReclaimRentRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ReclaimRentMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ReclaimRentMigrationOperation {
    async fn up(
        &self,
