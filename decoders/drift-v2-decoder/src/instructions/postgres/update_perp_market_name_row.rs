...
impl UpdatePerpMarketNameRow {
    pub fn from_parts(
        source: crate::instructions::update_perp_market_name::UpdatePerpMarketName,
    ...
    for crate::instructions::update_perp_market_name::UpdatePerpMarketName
{
    ...
    fn try_from(source: UpdatePerpMarketNameRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdatePerpMarketNameRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdatePerpMarketNameRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdatePerpMarketNameRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdatePerpMarketNameMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdatePerpMarketNameMigrationOperation {
    async fn up(
        &self,
