...
impl EndInsuranceFundSwapRow {
    pub fn from_parts(
        source: crate::instructions::end_insurance_fund_swap::EndInsuranceFundSwap,
    ...
    for crate::instructions::end_insurance_fund_swap::EndInsuranceFundSwap
{
    ...
    fn try_from(source: EndInsuranceFundSwapRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for EndInsuranceFundSwapRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for EndInsuranceFundSwapRow {
    type Key = (
        String,
...
pub struct EndInsuranceFundSwapMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for EndInsuranceFundSwapMigrationOperation {
    async fn up(
        &self,
