...
impl InitializeRevenueShareRow {
    pub fn from_parts(
        _source: crate::instructions::initialize_revenue_share::InitializeRevenueShare,
    ...
    for crate::instructions::initialize_revenue_share::InitializeRevenueShare
{
    ...
    fn try_from(_source: InitializeRevenueShareRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for InitializeRevenueShareRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeRevenueShareRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeRevenueShareRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeRevenueShareMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializeRevenueShareMigrationOperation {
    async fn up(
        &self,
