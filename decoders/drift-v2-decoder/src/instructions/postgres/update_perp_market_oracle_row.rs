...
impl UpdatePerpMarketOracleRow {
    pub fn from_parts(
        source: crate::instructions::update_perp_market_oracle::UpdatePerpMarketOracle,
    ...
    for crate::instructions::update_perp_market_oracle::UpdatePerpMarketOracle
{
    ...
    fn try_from(source: UpdatePerpMarketOracleRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdatePerpMarketOracleRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdatePerpMarketOracleRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdatePerpMarketOracleRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdatePerpMarketOracleMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdatePerpMarketOracleMigrationOperation {
    async fn up(
        &self,
