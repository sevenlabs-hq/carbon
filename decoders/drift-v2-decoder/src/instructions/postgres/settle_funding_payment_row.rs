...
impl SettleFundingPaymentRow {
    pub fn from_parts(
        _source: crate::instructions::settle_funding_payment::SettleFundingPayment,
    ...
    for crate::instructions::settle_funding_payment::SettleFundingPayment
{
    ...
    fn try_from(_source: SettleFundingPaymentRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for SettleFundingPaymentRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SettleFundingPaymentRow {
    type Key = (
        String,
...
pub struct SettleFundingPaymentMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SettleFundingPaymentMigrationOperation {
    async fn up(
        &self,
