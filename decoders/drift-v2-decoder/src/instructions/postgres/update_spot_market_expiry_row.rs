...
impl UpdateSpotMarketExpiryRow {
    pub fn from_parts(
        source: crate::instructions::update_spot_market_expiry::UpdateSpotMarketExpiry,
    ...
    for crate::instructions::update_spot_market_expiry::UpdateSpotMarketExpiry
{
    ...
    fn try_from(source: UpdateSpotMarketExpiryRow) -> Result<Self, Self::Error> {
        Ok(Self {
            expiry_ts: source.expiry_ts,
        })
    }
...
impl carbon_core::postgres::operations::Insert for UpdateSpotMarketExpiryRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateSpotMarketExpiryRow {
    type Key = (
        String,
...
pub struct UpdateSpotMarketExpiryMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateSpotMarketExpiryMigrationOperation {
    async fn up(
        &self,
