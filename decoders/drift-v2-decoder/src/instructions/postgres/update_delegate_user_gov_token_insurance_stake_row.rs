...
impl UpdateDelegateUserGovTokenInsuranceStakeRow {
    pub fn from_parts(
        _source: crate::instructions::update_delegate_user_gov_token_insurance_stake::UpdateDelegateUserGovTokenInsuranceStake,
...
impl TryFrom<UpdateDelegateUserGovTokenInsuranceStakeRow> for crate::instructions::update_delegate_user_gov_token_insurance_stake::UpdateDelegateUserGovTokenInsuranceStake {
    type Error = carbon_core::error::Error;
    fn try_from(_source: UpdateDelegateUserGovTokenInsuranceStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for UpdateDelegateUserGovTokenInsuranceStakeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateDelegateUserGovTokenInsuranceStakeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateDelegateUserGovTokenInsuranceStakeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateDelegateUserGovTokenInsuranceStakeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for UpdateDelegateUserGovTokenInsuranceStakeMigrationOperation
{
    async fn up(
        &self,
