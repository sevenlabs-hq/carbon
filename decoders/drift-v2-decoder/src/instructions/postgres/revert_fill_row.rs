...
impl RevertFillRow {
    pub fn from_parts(
        _source: crate::instructions::revert_fill::RevertFill,
...
impl TryFrom<RevertFillRow> for crate::instructions::revert_fill::RevertFill {
    type Error = carbon_core::error::Error;
    fn try_from(_source: RevertFillRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for RevertFillRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for RevertFillRow {
    type Key = (
        String,
...
pub struct RevertFillMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for RevertFillMigrationOperation {
    async fn up(
        &self,
