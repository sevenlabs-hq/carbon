...
impl SettleRevenueToInsuranceFundRow {
    pub fn from_parts(
        source: crate::instructions::settle_revenue_to_insurance_fund::SettleRevenueToInsuranceFund,
...
impl TryFrom<SettleRevenueToInsuranceFundRow>
    for crate::instructions::settle_revenue_to_insurance_fund::SettleRevenueToInsuranceFund
{
    type Error = carbon_core::error::Error;
    fn try_from(source: SettleRevenueToInsuranceFundRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for SettleRevenueToInsuranceFundRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SettleRevenueToInsuranceFundRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SettleRevenueToInsuranceFundRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SettleRevenueToInsuranceFundMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for SettleRevenueToInsuranceFundMigrationOperation {
    async fn up(
        &self,
