...
impl UpdateUserReduceOnlyRow {
    pub fn from_parts(
        source: crate::instructions::update_user_reduce_only::UpdateUserReduceOnly,
    ...
    for crate::instructions::update_user_reduce_only::UpdateUserReduceOnly
{
    ...
    fn try_from(source: UpdateUserReduceOnlyRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdateUserReduceOnlyRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateUserReduceOnlyRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateUserReduceOnlyRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateUserReduceOnlyMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateUserReduceOnlyMigrationOperation {
    async fn up(
        &self,
