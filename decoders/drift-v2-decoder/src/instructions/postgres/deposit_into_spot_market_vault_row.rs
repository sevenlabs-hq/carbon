...
impl DepositIntoSpotMarketVaultRow {
    pub fn from_parts(
        source: crate::instructions::deposit_into_spot_market_vault::DepositIntoSpotMarketVault,
...
impl TryFrom<DepositIntoSpotMarketVaultRow>
    for crate::instructions::deposit_into_spot_market_vault::DepositIntoSpotMarketVault
{
    type Error = carbon_core::error::Error;
    fn try_from(source: DepositIntoSpotMarketVaultRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for DepositIntoSpotMarketVaultRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DepositIntoSpotMarketVaultRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for DepositIntoSpotMarketVaultRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct DepositIntoSpotMarketVaultMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for DepositIntoSpotMarketVaultMigrationOperation {
    async fn up(
        &self,
