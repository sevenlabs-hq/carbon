...
impl InitializePythPullOracleRow {
    pub fn from_parts(
        source: crate::instructions::initialize_pyth_pull_oracle::InitializePythPullOracle,
...
impl TryFrom<InitializePythPullOracleRow>
    for crate::instructions::initialize_pyth_pull_oracle::InitializePythPullOracle
{
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializePythPullOracleRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializePythPullOracleRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializePythPullOracleRow {
    type Key = (
        String,
...
pub struct InitializePythPullOracleMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializePythPullOracleMigrationOperation {
    async fn up(
        &self,
