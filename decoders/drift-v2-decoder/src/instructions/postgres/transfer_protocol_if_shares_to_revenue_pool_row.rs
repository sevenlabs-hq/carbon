...
impl TransferProtocolIfSharesToRevenuePoolRow {
    pub fn from_parts(
        source: crate::instructions::transfer_protocol_if_shares_to_revenue_pool::TransferProtocolIfSharesToRevenuePool,
...
impl TryFrom<TransferProtocolIfSharesToRevenuePoolRow> for crate::instructions::transfer_protocol_if_shares_to_revenue_pool::TransferProtocolIfSharesToRevenuePool {
    type Error = carbon_core::error::Error;
    fn try_from(source: TransferProtocolIfSharesToRevenuePoolRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for TransferProtocolIfSharesToRevenuePoolRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TransferProtocolIfSharesToRevenuePoolRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TransferProtocolIfSharesToRevenuePoolRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TransferProtocolIfSharesToRevenuePoolMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for TransferProtocolIfSharesToRevenuePoolMigrationOperation
{
    async fn up(
        &self,
