...
impl DepositIntoInsuranceFundStakeRow {
    pub fn from_parts(
        source: crate::instructions::deposit_into_insurance_fund_stake::DepositIntoInsuranceFundStake,
...
impl TryFrom<DepositIntoInsuranceFundStakeRow>
    for crate::instructions::deposit_into_insurance_fund_stake::DepositIntoInsuranceFundStake
{
    type Error = carbon_core::error::Error;
    fn try_from(source: DepositIntoInsuranceFundStakeRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for DepositIntoInsuranceFundStakeRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for DepositIntoInsuranceFundStakeRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for DepositIntoInsuranceFundStakeRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct DepositIntoInsuranceFundStakeMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for DepositIntoInsuranceFundStakeMigrationOperation {
    async fn up(
        &self,
