...
impl InitializeOpenbookV2FulfillmentConfigRow {
    pub fn from_parts(
        source: crate::instructions::initialize_openbook_v2_fulfillment_config::InitializeOpenbookV2FulfillmentConfig,
...
impl TryFrom<InitializeOpenbookV2FulfillmentConfigRow> for crate::instructions::initialize_openbook_v2_fulfillment_config::InitializeOpenbookV2FulfillmentConfig {
    ...
    fn try_from(source: InitializeOpenbookV2FulfillmentConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializeOpenbookV2FulfillmentConfigRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeOpenbookV2FulfillmentConfigRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeOpenbookV2FulfillmentConfigRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeOpenbookV2FulfillmentConfigMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeOpenbookV2FulfillmentConfigMigrationOperation
{
    async fn up(
        &self,
