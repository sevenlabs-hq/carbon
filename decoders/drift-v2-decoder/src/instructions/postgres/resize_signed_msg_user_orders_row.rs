...
impl ResizeSignedMsgUserOrdersRow {
    pub fn from_parts(
        source: crate::instructions::resize_signed_msg_user_orders::ResizeSignedMsgUserOrders,
...
impl TryFrom<ResizeSignedMsgUserOrdersRow>
    for crate::instructions::resize_signed_msg_user_orders::ResizeSignedMsgUserOrders
{
    type Error = carbon_core::error::Error;
    fn try_from(source: ResizeSignedMsgUserOrdersRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for ResizeSignedMsgUserOrdersRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ResizeSignedMsgUserOrdersRow {
    type Key = (
        String,
...
pub struct ResizeSignedMsgUserOrdersMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ResizeSignedMsgUserOrdersMigrationOperation {
    async fn up(
        &self,
