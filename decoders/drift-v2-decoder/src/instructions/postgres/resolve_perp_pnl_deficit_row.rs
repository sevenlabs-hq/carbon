...
impl ResolvePerpPnlDeficitRow {
    pub fn from_parts(
        source: crate::instructions::resolve_perp_pnl_deficit::ResolvePerpPnlDeficit,
    ...
    for crate::instructions::resolve_perp_pnl_deficit::ResolvePerpPnlDeficit
{
    ...
    fn try_from(source: ResolvePerpPnlDeficitRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for ResolvePerpPnlDeficitRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ResolvePerpPnlDeficitRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ResolvePerpPnlDeficitRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ResolvePerpPnlDeficitMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ResolvePerpPnlDeficitMigrationOperation {
    async fn up(
        &self,
