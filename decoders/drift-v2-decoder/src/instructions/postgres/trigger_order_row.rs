...
impl TriggerOrderRow {
    pub fn from_parts(
        source: crate::instructions::trigger_order::TriggerOrder,
...
impl TryFrom<TriggerOrderRow> for crate::instructions::trigger_order::TriggerOrder {
    type Error = carbon_core::error::Error;
    fn try_from(source: TriggerOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
            order_id: source.order_id.try_into().map_err(|_| {
...
impl carbon_core::postgres::operations::Insert for TriggerOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TriggerOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TriggerOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TriggerOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TriggerOrderMigrationOperation {
    async fn up(
        &self,
