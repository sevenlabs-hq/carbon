...
impl UpdatePerpMarketOracleLowRiskSlotDelayOverrideRow {
    pub fn from_parts(
        source: crate::instructions::update_perp_market_oracle_low_risk_slot_delay_override::UpdatePerpMarketOracleLowRiskSlotDelayOverride,
        metadata: InstructionMetadata,
        accounts: Vec<solana_instruction::AccountMeta>,
    ) -> Self {
        Self {
            instruction_metadata: metadata.into(),
            oracle_low_risk_slot_delay_override: source.oracle_low_risk_slot_delay_override,
...
impl TryFrom<UpdatePerpMarketOracleLowRiskSlotDelayOverrideRow> for crate::instructions::update_perp_market_oracle_low_risk_slot_delay_override::UpdatePerpMarketOracleLowRiskSlotDelayOverride {
    ...
    fn try_from(source: UpdatePerpMarketOracleLowRiskSlotDelayOverrideRow) -> Result<Self, Self::Error> {
        Ok(Self {
            oracle_low_risk_slot_delay_override: source.oracle_low_risk_slot_delay_override,
        })
    }
    ...
    for UpdatePerpMarketOracleLowRiskSlotDelayOverrideRow
{
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(r#"INSERT INTO update_perp_market_oracle_low_risk_slot_delay_override_instruction (
                ...
                "oracle_low_risk_slot_delay_override" = EXCLUDED."oracle_low_risk_slot_delay_override",
...
pub struct UpdatePerpMarketOracleLowRiskSlotDelayOverrideMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for UpdatePerpMarketOracleLowRiskSlotDelayOverrideMigrationOperation
{
    async fn up(
        &self,
