...
impl UpdateSpotAuctionDurationRow {
    pub fn from_parts(
        source: crate::instructions::update_spot_auction_duration::UpdateSpotAuctionDuration,
...
impl TryFrom<UpdateSpotAuctionDurationRow>
    for crate::instructions::update_spot_auction_duration::UpdateSpotAuctionDuration
{
    type Error = carbon_core::error::Error;
    fn try_from(source: UpdateSpotAuctionDurationRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for UpdateSpotAuctionDurationRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for UpdateSpotAuctionDurationRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for UpdateSpotAuctionDurationRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct UpdateSpotAuctionDurationMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for UpdateSpotAuctionDurationMigrationOperation {
    async fn up(
        &self,
