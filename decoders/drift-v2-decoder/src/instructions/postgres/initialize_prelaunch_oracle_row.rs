...
impl InitializePrelaunchOracleRow {
    pub fn from_parts(
        source: crate::instructions::initialize_prelaunch_oracle::InitializePrelaunchOracle,
...
impl TryFrom<InitializePrelaunchOracleRow>
    for crate::instructions::initialize_prelaunch_oracle::InitializePrelaunchOracle
{
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializePrelaunchOracleRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializePrelaunchOracleRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializePrelaunchOracleRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializePrelaunchOracleRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializePrelaunchOracleMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializePrelaunchOracleMigrationOperation {
    async fn up(
        &self,
