...
impl ResetFuelSeasonRow {
    pub fn from_parts(
        _source: crate::instructions::reset_fuel_season::ResetFuelSeason,
...
impl TryFrom<ResetFuelSeasonRow> for crate::instructions::reset_fuel_season::ResetFuelSeason {
    type Error = carbon_core::error::Error;
    fn try_from(_source: ResetFuelSeasonRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for ResetFuelSeasonRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for ResetFuelSeasonRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for ResetFuelSeasonRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct ResetFuelSeasonMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for ResetFuelSeasonMigrationOperation {
    async fn up(
        &self,
