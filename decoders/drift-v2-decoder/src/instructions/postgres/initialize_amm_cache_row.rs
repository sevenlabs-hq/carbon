...
impl InitializeAmmCacheRow {
    pub fn from_parts(
        _source: crate::instructions::initialize_amm_cache::InitializeAmmCache,
    ...
    for crate::instructions::initialize_amm_cache::InitializeAmmCache
{
    ...
    fn try_from(_source: InitializeAmmCacheRow) -> Result<Self, Self::Error> {
        Ok(Self {})
    }
}
...
impl carbon_core::postgres::operations::Insert for InitializeAmmCacheRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeAmmCacheRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeAmmCacheRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeAmmCacheMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for InitializeAmmCacheMigrationOperation {
    async fn up(
        &self,
