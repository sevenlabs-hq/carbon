...
impl TransferDepositRow {
    pub fn from_parts(
        source: crate::instructions::transfer_deposit::TransferDeposit,
...
impl TryFrom<TransferDepositRow> for crate::instructions::transfer_deposit::TransferDeposit {
    type Error = carbon_core::error::Error;
    fn try_from(source: TransferDepositRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for TransferDepositRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for TransferDepositRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for TransferDepositRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct TransferDepositMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for TransferDepositMigrationOperation {
    async fn up(
        &self,
