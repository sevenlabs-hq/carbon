...
impl InitializeSerumFulfillmentConfigRow {
    pub fn from_parts(
        source: crate::instructions::initialize_serum_fulfillment_config::InitializeSerumFulfillmentConfig,
...
impl TryFrom<InitializeSerumFulfillmentConfigRow>
    for crate::instructions::initialize_serum_fulfillment_config::InitializeSerumFulfillmentConfig
{
    type Error = carbon_core::error::Error;
    fn try_from(source: InitializeSerumFulfillmentConfigRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for InitializeSerumFulfillmentConfigRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for InitializeSerumFulfillmentConfigRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for InitializeSerumFulfillmentConfigRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct InitializeSerumFulfillmentConfigMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for InitializeSerumFulfillmentConfigMigrationOperation
{
    async fn up(
        &self,
