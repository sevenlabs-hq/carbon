...
impl SettleExpiredMarketPoolsToRevenuePoolRow {
    pub fn from_parts(
        _source: crate::instructions::settle_expired_market_pools_to_revenue_pool::SettleExpiredMarketPoolsToRevenuePool,
...
impl TryFrom<SettleExpiredMarketPoolsToRevenuePoolRow> for crate::instructions::settle_expired_market_pools_to_revenue_pool::SettleExpiredMarketPoolsToRevenuePool {
    type Error = carbon_core::error::Error;
    fn try_from(_source: SettleExpiredMarketPoolsToRevenuePoolRow) -> Result<Self, Self::Error> {
        Ok(Self {
        })
    }
}
...
impl carbon_core::postgres::operations::Insert for SettleExpiredMarketPoolsToRevenuePoolRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for SettleExpiredMarketPoolsToRevenuePoolRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for SettleExpiredMarketPoolsToRevenuePoolRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct SettleExpiredMarketPoolsToRevenuePoolMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres>
    for SettleExpiredMarketPoolsToRevenuePoolMigrationOperation
{
    async fn up(
        &self,
