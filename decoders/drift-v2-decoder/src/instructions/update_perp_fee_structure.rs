...
impl CarbonDeserialize for UpdatePerpFeeStructure {
    const DISCRIMINATOR: &'static [u8] = &[23, 178, 111, 203, 73, 22, 140, 75];
...
impl ArrangeAccounts for UpdatePerpFeeStructure {
