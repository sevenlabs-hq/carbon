...
impl CarbonDeserialize for DeleteInitializedPerpMarket {
    const DISCRIMINATOR: &'static [u8] = &[91, 154, 24, 87, 106, 59, 190, 66];
...
impl ArrangeAccounts for DeleteInitializedPerpMarket {
