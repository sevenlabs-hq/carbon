...
impl CarbonDeserialize for DepositIntoSpotMarketRevenuePool {
    const DISCRIMINATOR: &'static [u8] = &[92, 40, 151, 42, 122, 254, 139, 246];
...
impl ArrangeAccounts for DepositIntoSpotMarketRevenuePool {
