...
impl CarbonDeserialize for UpdateSpotMarketStepSizeAndTickSize {
    const DISCRIMINATOR: &'static [u8] = &[238, 153, 137, 80, 206, 59, 250, 61];
...
impl ArrangeAccounts for UpdateSpotMarketStepSizeAndTickSize {
