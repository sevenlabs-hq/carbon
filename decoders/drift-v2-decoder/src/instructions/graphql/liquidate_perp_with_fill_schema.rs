...
#[graphql(name = "LiquidatePerpWithFill")]
pub struct LiquidatePerpWithFillGraphQL {
...
impl TryFrom<crate::instructions::postgres::LiquidatePerpWithFillRow>
    for LiquidatePerpWithFillGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LiquidatePerpWithFillRow,
