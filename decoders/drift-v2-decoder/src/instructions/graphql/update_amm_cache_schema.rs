...
#[graphql(name = "UpdateAmmCache")]
pub struct UpdateAmmCacheGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateAmmCacheRow> for UpdateAmmCacheGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateAmmCacheRow,
