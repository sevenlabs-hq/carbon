...
#[graphql(name = "InitializeInsuranceFundStake")]
pub struct InitializeInsuranceFundStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeInsuranceFundStakeRow>
    for InitializeInsuranceFundStakeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeInsuranceFundStakeRow,
