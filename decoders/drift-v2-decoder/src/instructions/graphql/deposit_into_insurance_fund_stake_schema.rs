...
#[graphql(name = "DepositIntoInsuranceFundStake")]
pub struct DepositIntoInsuranceFundStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositIntoInsuranceFundStakeRow>
    for DepositIntoInsuranceFundStakeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositIntoInsuranceFundStakeRow,
