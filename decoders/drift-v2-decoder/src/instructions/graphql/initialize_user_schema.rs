...
#[graphql(name = "InitializeUser")]
pub struct InitializeUserGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeUserRow> for InitializeUserGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeUserRow,
