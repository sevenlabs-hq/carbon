...
#[graphql(name = "UpdatePerpMarketPnlPool")]
pub struct UpdatePerpMarketPnlPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdatePerpMarketPnlPoolRow>
    for UpdatePerpMarketPnlPoolGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdatePerpMarketPnlPoolRow,
