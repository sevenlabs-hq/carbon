...
#[graphql(name = "FillPerpOrder")]
pub struct FillPerpOrderGraphQL {
...
impl TryFrom<crate::instructions::postgres::FillPerpOrderRow> for FillPerpOrderGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::FillPerpOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
