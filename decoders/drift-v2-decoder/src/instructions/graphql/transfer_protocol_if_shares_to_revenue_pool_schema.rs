...
#[graphql(name = "TransferProtocolIfSharesToRevenuePool")]
pub struct TransferProtocolIfSharesToRevenuePoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::TransferProtocolIfSharesToRevenuePoolRow>
    for TransferProtocolIfSharesToRevenuePoolGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::TransferProtocolIfSharesToRevenuePoolRow,
