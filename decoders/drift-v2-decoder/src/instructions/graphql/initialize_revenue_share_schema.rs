...
#[graphql(name = "InitializeRevenueShare")]
pub struct InitializeRevenueShareGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeRevenueShareRow>
    for InitializeRevenueShareGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeRevenueShareRow,
