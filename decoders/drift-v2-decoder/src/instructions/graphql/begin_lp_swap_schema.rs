...
#[graphql(name = "BeginLpSwap")]
pub struct BeginLpSwapGraphQL {
...
impl TryFrom<crate::instructions::postgres::BeginLpSwapRow> for BeginLpSwapGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::BeginLpSwapRow) -> Result<Self, Self::Error> {
        Ok(Self {
