...
#[graphql(name = "DepositIntoPerpMarketFeePool")]
pub struct DepositIntoPerpMarketFeePoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositIntoPerpMarketFeePoolRow>
    for DepositIntoPerpMarketFeePoolGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositIntoPerpMarketFeePoolRow,
