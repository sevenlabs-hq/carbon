...
#[graphql(name = "RevertFill")]
pub struct RevertFillGraphQL {
...
impl TryFrom<crate::instructions::postgres::RevertFillRow> for RevertFillGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::RevertFillRow) -> Result<Self, Self::Error> {
        Ok(Self {
