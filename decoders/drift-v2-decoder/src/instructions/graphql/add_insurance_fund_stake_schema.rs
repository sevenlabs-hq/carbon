...
#[graphql(name = "AddInsuranceFundStake")]
pub struct AddInsuranceFundStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::AddInsuranceFundStakeRow>
    for AddInsuranceFundStakeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AddInsuranceFundStakeRow,
