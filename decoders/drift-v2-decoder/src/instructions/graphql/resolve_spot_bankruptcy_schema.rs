...
#[graphql(name = "ResolveSpotBankruptcy")]
pub struct ResolveSpotBankruptcyGraphQL {
...
impl TryFrom<crate::instructions::postgres::ResolveSpotBankruptcyRow>
    for ResolveSpotBankruptcyGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ResolveSpotBankruptcyRow,
