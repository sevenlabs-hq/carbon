...
#[graphql(name = "DeleteAmmCache")]
pub struct DeleteAmmCacheGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeleteAmmCacheRow> for DeleteAmmCacheGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeleteAmmCacheRow,
