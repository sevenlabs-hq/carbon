...
#[graphql(name = "SettleExpiredMarket")]
pub struct SettleExpiredMarketGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettleExpiredMarketRow> for SettleExpiredMarketGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SettleExpiredMarketRow,
