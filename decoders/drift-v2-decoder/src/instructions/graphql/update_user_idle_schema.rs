...
#[graphql(name = "UpdateUserIdle")]
pub struct UpdateUserIdleGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateUserIdleRow> for UpdateUserIdleGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateUserIdleRow,
