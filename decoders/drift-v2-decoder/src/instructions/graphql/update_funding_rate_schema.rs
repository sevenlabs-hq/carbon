...
#[graphql(name = "UpdateFundingRate")]
pub struct UpdateFundingRateGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateFundingRateRow> for UpdateFundingRateGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateFundingRateRow,
