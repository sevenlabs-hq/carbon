...
#[graphql(name = "DepositIntoSpotMarketRevenuePool")]
pub struct DepositIntoSpotMarketRevenuePoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositIntoSpotMarketRevenuePoolRow>
    for DepositIntoSpotMarketRevenuePoolGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositIntoSpotMarketRevenuePoolRow,
