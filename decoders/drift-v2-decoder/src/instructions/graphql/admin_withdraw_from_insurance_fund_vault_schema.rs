...
#[graphql(name = "AdminWithdrawFromInsuranceFundVault")]
pub struct AdminWithdrawFromInsuranceFundVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminWithdrawFromInsuranceFundVaultRow>
    for AdminWithdrawFromInsuranceFundVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AdminWithdrawFromInsuranceFundVaultRow,
