...
#[graphql(name = "SettlePnl")]
pub struct SettlePnlGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettlePnlRow> for SettlePnlGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SettlePnlRow) -> Result<Self, Self::Error> {
        Ok(Self {
