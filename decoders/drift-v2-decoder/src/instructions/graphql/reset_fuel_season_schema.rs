...
#[graphql(name = "ResetFuelSeason")]
pub struct ResetFuelSeasonGraphQL {
...
impl TryFrom<crate::instructions::postgres::ResetFuelSeasonRow> for ResetFuelSeasonGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ResetFuelSeasonRow,
