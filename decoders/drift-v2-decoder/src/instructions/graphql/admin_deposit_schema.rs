...
#[graphql(name = "AdminDeposit")]
pub struct AdminDepositGraphQL {
...
impl TryFrom<crate::instructions::postgres::AdminDepositRow> for AdminDepositGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::AdminDepositRow) -> Result<Self, Self::Error> {
        Ok(Self {
