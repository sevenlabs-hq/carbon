...
impl TryFrom<crate::instructions::postgres::DeleteUserRow> for DeleteUserGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::DeleteUserRow) -> Result<Self, Self::Error> {
        Ok(Self {
