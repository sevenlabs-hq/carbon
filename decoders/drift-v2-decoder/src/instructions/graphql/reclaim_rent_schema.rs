...
#[graphql(name = "ReclaimRent")]
pub struct ReclaimRentGraphQL {
...
impl TryFrom<crate::instructions::postgres::ReclaimRentRow> for ReclaimRentGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::ReclaimRentRow) -> Result<Self, Self::Error> {
        Ok(Self {
