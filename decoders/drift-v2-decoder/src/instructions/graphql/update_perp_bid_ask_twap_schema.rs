...
#[graphql(name = "UpdatePerpBidAskTwap")]
pub struct UpdatePerpBidAskTwapGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdatePerpBidAskTwapRow>
    for UpdatePerpBidAskTwapGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdatePerpBidAskTwapRow,
