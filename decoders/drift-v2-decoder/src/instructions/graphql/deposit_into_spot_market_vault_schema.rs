...
#[graphql(name = "DepositIntoSpotMarketVault")]
pub struct DepositIntoSpotMarketVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositIntoSpotMarketVaultRow>
    for DepositIntoSpotMarketVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositIntoSpotMarketVaultRow,
