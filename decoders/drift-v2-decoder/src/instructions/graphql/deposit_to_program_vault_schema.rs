...
#[graphql(name = "DepositToProgramVault")]
pub struct DepositToProgramVaultGraphQL {
...
impl TryFrom<crate::instructions::postgres::DepositToProgramVaultRow>
    for DepositToProgramVaultGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DepositToProgramVaultRow,
