...
#[graphql(name = "AddMarketToAmmCache")]
pub struct AddMarketToAmmCacheGraphQL {
...
impl TryFrom<crate::instructions::postgres::AddMarketToAmmCacheRow> for AddMarketToAmmCacheGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::AddMarketToAmmCacheRow,
