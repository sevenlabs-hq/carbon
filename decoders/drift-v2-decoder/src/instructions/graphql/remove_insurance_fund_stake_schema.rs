...
#[graphql(name = "RemoveInsuranceFundStake")]
pub struct RemoveInsuranceFundStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::RemoveInsuranceFundStakeRow>
    for RemoveInsuranceFundStakeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RemoveInsuranceFundStakeRow,
