...
#[graphql(name = "UpdatePrelaunchOracle")]
pub struct UpdatePrelaunchOracleGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdatePrelaunchOracleRow>
    for UpdatePrelaunchOracleGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdatePrelaunchOracleRow,
