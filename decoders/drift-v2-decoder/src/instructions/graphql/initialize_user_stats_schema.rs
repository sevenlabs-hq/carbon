...
#[graphql(name = "InitializeUserStats")]
pub struct InitializeUserStatsGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeUserStatsRow> for InitializeUserStatsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeUserStatsRow,
