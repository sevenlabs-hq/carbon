...
#[graphql(name = "LogUserBalances")]
pub struct LogUserBalancesGraphQL {
...
impl TryFrom<crate::instructions::postgres::LogUserBalancesRow> for LogUserBalancesGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::LogUserBalancesRow,
