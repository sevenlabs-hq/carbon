...
#[graphql(name = "ForceDeleteUser")]
pub struct ForceDeleteUserGraphQL {
...
impl TryFrom<crate::instructions::postgres::ForceDeleteUserRow> for ForceDeleteUserGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ForceDeleteUserRow,
