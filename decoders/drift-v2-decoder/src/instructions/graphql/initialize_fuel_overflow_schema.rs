...
#[graphql(name = "InitializeFuelOverflow")]
pub struct InitializeFuelOverflowGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeFuelOverflowRow>
    for InitializeFuelOverflowGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeFuelOverflowRow,
