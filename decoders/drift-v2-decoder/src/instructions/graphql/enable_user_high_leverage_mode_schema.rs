...
#[graphql(name = "EnableUserHighLeverageMode")]
pub struct EnableUserHighLeverageModeGraphQL {
...
impl TryFrom<crate::instructions::postgres::EnableUserHighLeverageModeRow>
    for EnableUserHighLeverageModeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::EnableUserHighLeverageModeRow,
