...
#[graphql(name = "UpdateLpPoolAum")]
pub struct UpdateLpPoolAumGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateLpPoolAumRow> for UpdateLpPoolAumGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateLpPoolAumRow,
