...
#[graphql(name = "SweepFuel")]
pub struct SweepFuelGraphQL {
...
impl TryFrom<crate::instructions::postgres::SweepFuelRow> for SweepFuelGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SweepFuelRow) -> Result<Self, Self::Error> {
        Ok(Self {
