...
#[graphql(name = "DeleteInitializedPerpMarket")]
pub struct DeleteInitializedPerpMarketGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeleteInitializedPerpMarketRow>
    for DeleteInitializedPerpMarketGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeleteInitializedPerpMarketRow,
