...
#[graphql(name = "RequestRemoveInsuranceFundStake")]
pub struct RequestRemoveInsuranceFundStakeGraphQL {
...
impl TryFrom<crate::instructions::postgres::RequestRemoveInsuranceFundStakeRow>
    for RequestRemoveInsuranceFundStakeGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::RequestRemoveInsuranceFundStakeRow,
