...
#[graphql(name = "UpdateHighLeverageModeConfig")]
pub struct UpdateHighLeverageModeConfigGraphQL {
...
impl TryFrom<crate::instructions::postgres::UpdateHighLeverageModeConfigRow>
    for UpdateHighLeverageModeConfigGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UpdateHighLeverageModeConfigRow,
