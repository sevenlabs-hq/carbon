...
#[graphql(name = "SettlePerpToLpPool")]
pub struct SettlePerpToLpPoolGraphQL {
...
impl TryFrom<crate::instructions::postgres::SettlePerpToLpPoolRow> for SettlePerpToLpPoolGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::SettlePerpToLpPoolRow,
