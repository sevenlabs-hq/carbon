...
#[graphql(name = "DeleteInitializedSpotMarket")]
pub struct DeleteInitializedSpotMarketGraphQL {
...
impl TryFrom<crate::instructions::postgres::DeleteInitializedSpotMarketRow>
    for DeleteInitializedSpotMarketGraphQL
{
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::DeleteInitializedSpotMarketRow,
