...
#[graphql(name = "InitializeAmmCache")]
pub struct InitializeAmmCacheGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeAmmCacheRow> for InitializeAmmCacheGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeAmmCacheRow,
