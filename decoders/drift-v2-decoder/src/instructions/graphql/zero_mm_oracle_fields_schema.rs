...
#[graphql(name = "ZeroMmOracleFields")]
pub struct ZeroMmOracleFieldsGraphQL {
...
impl TryFrom<crate::instructions::postgres::ZeroMmOracleFieldsRow> for ZeroMmOracleFieldsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::ZeroMmOracleFieldsRow,
