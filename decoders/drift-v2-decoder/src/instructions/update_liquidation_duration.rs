...
impl CarbonDeserialize for UpdateLiquidationDuration {
    const DISCRIMINATOR: &'static [u8] = &[28, 154, 20, 249, 102, 192, 73, 71];
...
impl ArrangeAccounts for UpdateLiquidationDuration {
