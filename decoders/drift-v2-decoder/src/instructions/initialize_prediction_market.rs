...
impl CarbonDeserialize for InitializePredictionMarket {
    const DISCRIMINATOR: &'static [u8] = &[248, 70, 198, 224, 224, 105, 125, 195];
...
impl ArrangeAccounts for InitializePredictionMarket {
