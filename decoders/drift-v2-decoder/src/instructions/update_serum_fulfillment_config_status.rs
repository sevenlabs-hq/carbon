...
impl CarbonDeserialize for UpdateSerumFulfillmentConfigStatus {
    const DISCRIMINATOR: &'static [u8] = &[171, 109, 240, 251, 95, 1, 149, 89];
...
impl ArrangeAccounts for UpdateSerumFulfillmentConfigStatus {
