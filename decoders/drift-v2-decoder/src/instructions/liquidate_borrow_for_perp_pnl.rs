...
impl CarbonDeserialize for LiquidateBorrowForPerpPnl {
    const DISCRIMINATOR: &'static [u8] = &[169, 17, 32, 90, 207, 148, 209, 27];
...
impl ArrangeAccounts for LiquidateBorrowForPerpPnl {
