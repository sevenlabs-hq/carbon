...
impl CarbonDeserialize for UpdateSpotMarketMaxTokenBorrows {
    const DISCRIMINATOR: &'static [u8] = &[57, 102, 204, 212, 253, 95, 13, 199];
...
impl ArrangeAccounts for UpdateSpotMarketMaxTokenBorrows {
