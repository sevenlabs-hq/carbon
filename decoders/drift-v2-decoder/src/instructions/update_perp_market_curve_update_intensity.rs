...
impl CarbonDeserialize for UpdatePerpMarketCurveUpdateIntensity {
    const DISCRIMINATOR: &'static [u8] = &[50, 131, 6, 156, 226, 231, 189, 72];
...
impl ArrangeAccounts for UpdatePerpMarketCurveUpdateIntensity {
