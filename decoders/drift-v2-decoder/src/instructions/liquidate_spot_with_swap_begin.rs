...
impl CarbonDeserialize for LiquidateSpotWithSwapBegin {
    const DISCRIMINATOR: &'static [u8] = &[12, 43, 176, 83, 156, 251, 117, 13];
...
impl ArrangeAccounts for LiquidateSpotWithSwapBegin {
