...
impl CarbonDeserialize for UpdatePerpMarketConcentrationCoef {
    const DISCRIMINATOR: &'static [u8] = &[24, 78, 232, 126, 169, 176, 230, 16];
...
impl ArrangeAccounts for UpdatePerpMarketConcentrationCoef {
