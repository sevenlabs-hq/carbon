...
impl CarbonDeserialize for UpdateSpotMarketFeeAdjustment {
    const DISCRIMINATOR: &'static [u8] = &[148, 182, 3, 126, 157, 114, 220, 99];
...
impl ArrangeAccounts for UpdateSpotMarketFeeAdjustment {
