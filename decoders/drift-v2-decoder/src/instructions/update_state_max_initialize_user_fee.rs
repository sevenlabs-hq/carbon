...
impl CarbonDeserialize for UpdateStateMaxInitializeUserFee {
    const DISCRIMINATOR: &'static [u8] = &[237, 225, 25, 237, 193, 45, 77, 97];
...
impl ArrangeAccounts for UpdateStateMaxInitializeUserFee {
