...
impl CarbonDeserialize for UpdatePerpMarketFeeAdjustment {
    const DISCRIMINATOR: &'static [u8] = &[194, 174, 87, 102, 43, 148, 32, 112];
...
impl ArrangeAccounts for UpdatePerpMarketFeeAdjustment {
