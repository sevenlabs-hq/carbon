...
impl
    TryFrom<(
        crate::instructions::openbook_v2_fulfillment_config_status::OpenbookV2FulfillmentConfigStatus,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::openbook_v2_fulfillment_config_status::OpenbookV2FulfillmentConfigStatusInstructionAccounts,
    )> for OpenbookV2FulfillmentConfigStatusRow
{
...
impl carbon_core::clickhouse::ClusterTable for OpenbookV2FulfillmentConfigStatusRow {
    fn local_table() -> &'static str {
        "drift_v2_openbook_v2_fulfillment_config_status_instruction_local"
    }
...
impl carbon_core::clickhouse::Table for OpenbookV2FulfillmentConfigStatusRow {
    fn table() -> &'static str {
        "drift_v2_openbook_v2_fulfillment_config_status_instruction"
    }
}
...
pub struct OpenbookV2FulfillmentConfigStatusRowMigrationOperation;

#[cfg(feature = "clickhouse-cluster")]
#[async_trait::async_trait]
impl carbon_core::clickhouse::Operation for OpenbookV2FulfillmentConfigStatusRowMigrationOperation {
    async fn up(
        &self,
        client: &clickhouse::Client,
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/drift_v2_openbook_v2_fulfillment_config_status_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS drift_v2_openbook_v2_fulfillment_config_status_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS drift_v2_openbook_v2_fulfillment_config_status_instruction ON CLUSTER {cluster} AS drift_v2_openbook_v2_fulfillment_config_status_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), drift_v2_openbook_v2_fulfillment_config_status_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS drift_v2_openbook_v2_fulfillment_config_status_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS drift_v2_openbook_v2_fulfillment_config_status_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
...
impl carbon_core::clickhouse::Operation for OpenbookV2FulfillmentConfigStatusRowMigrationOperation {
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS drift_v2_openbook_v2_fulfillment_config_status_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
