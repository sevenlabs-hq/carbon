...
pub struct UpdateUserGovTokenInsuranceStakeRow {
...
impl
    TryFrom<(
        crate::instructions::update_user_gov_token_insurance_stake::UpdateUserGovTokenInsuranceStake,
        carbon_core::instruction::InstructionMetadata,
        crate::instructions::update_user_gov_token_insurance_stake::UpdateUserGovTokenInsuranceStakeInstructionAccounts,
    )> for UpdateUserGovTokenInsuranceStakeRow
{
...
impl carbon_core::clickhouse::ClusterTable for UpdateUserGovTokenInsuranceStakeRow {
    fn local_table() -> &'static str {
        "drift_v2_update_user_gov_token_insurance_stake_instruction_local"
    }

    fn distributed_table() -> &'static str {
        "drift_v2_update_user_gov_token_insurance_stake_instruction"
    }
}

#[cfg(not(feature = "clickhouse-cluster"))]
impl carbon_core::clickhouse::Table for UpdateUserGovTokenInsuranceStakeRow {
    fn table() -> &'static str {
        "drift_v2_update_user_gov_token_insurance_stake_instruction"
    }
}
...
pub struct UpdateUserGovTokenInsuranceStakeRowMigrationOperation;

#[cfg(feature = "clickhouse-cluster")]
#[async_trait::async_trait]
impl carbon_core::clickhouse::Operation for UpdateUserGovTokenInsuranceStakeRowMigrationOperation {
    async fn up(
        &self,
        client: &clickhouse::Client,
        ...
        let replica_path = format!(
            "/clickhouse/tables/{}/drift_v2_update_user_gov_token_insurance_stake_instruction_local",
            config.shard_name,
        );
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS drift_v2_update_user_gov_token_insurance_stake_instruction_local ON CLUSTER {cluster} (
                        __signature String,
        ...
        client
            .query(&format!(
                r#"
                    CREATE TABLE IF NOT EXISTS drift_v2_update_user_gov_token_insurance_stake_instruction ON CLUSTER {cluster} AS drift_v2_update_user_gov_token_insurance_stake_instruction_local
                    ENGINE = Distributed({cluster}, currentDatabase(), drift_v2_update_user_gov_token_insurance_stake_instruction_local, rand())
                "#,
                cluster = cluster_name,
            ))
            .execute()
    ...
    async fn down(
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS drift_v2_update_user_gov_token_insurance_stake_instruction ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
        ...
        client
            .query(&format!(
                "DROP TABLE IF EXISTS drift_v2_update_user_gov_token_insurance_stake_instruction_local ON CLUSTER {cluster}",
                cluster = cluster_name,
            ))
            .execute()
            .await?;
...
impl carbon_core::clickhouse::Operation for UpdateUserGovTokenInsuranceStakeRowMigrationOperation {
    async fn up(&self, client: &clickhouse::Client) -> clickhouse::error::Result<()> {
        client
            .query(
                r#"
                    CREATE TABLE IF NOT EXISTS drift_v2_update_user_gov_token_insurance_stake_instruction (
                        __signature String,
                        __instruction_index UInt32,
                        __stack_height UInt32,
                        __slot UInt64,
