...
pub struct CancelDustOrderRow {
    ...
    pub params: sqlx::types::Json<CancelDustOrderParams>,
    #[sqlx(rename = "__accounts")]
    pub accounts: sqlx::types::Json<Vec<solana_instruction::AccountMeta>>,
}

impl CancelDustOrderRow {
    pub fn from_parts(
        source: crate::instructions::cancel_dust_order::CancelDustOrder,
...
impl TryFrom<CancelDustOrderRow> for crate::instructions::cancel_dust_order::CancelDustOrder {
    type Error = carbon_core::error::Error;
    fn try_from(source: CancelDustOrderRow) -> Result<Self, Self::Error> {
        Ok(Self {
...
impl carbon_core::postgres::operations::Insert for CancelDustOrderRow {
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::Delete for CancelDustOrderRow {
    type Key = (
        String,
...
#[async_trait::async_trait]
impl carbon_core::postgres::operations::LookUp for CancelDustOrderRow {
    type Key = (
        String,
        carbon_core::postgres::primitives::U32,
        carbon_core::postgres::primitives::U32,
...
pub struct CancelDustOrderMigrationOperation;

#[async_trait::async_trait]
impl sqlx_migrator::Operation<sqlx::Postgres> for CancelDustOrderMigrationOperation {
    async fn up(
        &self,
