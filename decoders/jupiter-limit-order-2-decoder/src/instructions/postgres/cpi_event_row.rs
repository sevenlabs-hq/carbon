...
impl CpiEventRow {
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                CpiEvent::CancelDustOrderEvent(_) => "cancel_dust_order_event".to_string(),
                CpiEvent::CancelOrderEvent(_) => "cancel_order_event".to_string(),
                CpiEvent::CreateOrderEvent(_) => "create_order_event".to_string(),
...
impl carbon_core::postgres::operations::Table for CpiEvent {
    fn table() -> &'static str {
        "jupiter_limit_order_2_cpi_events"
    }
...
impl carbon_core::postgres::operations::Insert for CpiEventRow {
    async fn insert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"
            INSERT INTO jupiter_limit_order_2_cpi_events (
...
impl carbon_core::postgres::operations::Upsert for CpiEventRow {
    async fn upsert(&self, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"INSERT INTO jupiter_limit_order_2_cpi_events (
            __signature, __instruction_index, __stack_height, __slot, "name", "data", __accounts
        ) VALUES (
            $1, $2, $3, $4, $5, $6, $7
...
impl carbon_core::postgres::operations::Delete for CpiEventRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM jupiter_limit_order_2_cpi_events WHERE
...
impl carbon_core::postgres::operations::Lookup for CpiEventRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM jupiter_limit_order_2_cpi_events WHERE
            __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
        "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CpiEventMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS jupiter_limit_order_2_cpi_events (
            -- Instruction data
            "name" TEXT NOT NULL,
            "data" JSONB NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS jupiter_limit_order_2_cpi_events"#)
            .execute(connection)
            .await?;
        Ok(())
    }
