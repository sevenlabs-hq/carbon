...
#[graphql(name = "WithdrawFee")]
pub struct WithdrawFeeGraphQL {
...
impl TryFrom<crate::instructions::postgres::WithdrawFeeRow> for WithdrawFeeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::WithdrawFeeRow) -> Result<Self, Self::Error> {
        Ok(Self {
