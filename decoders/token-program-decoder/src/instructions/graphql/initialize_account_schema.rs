...
#[graphql(name = "InitializeAccount")]
pub struct InitializeAccountGraphQL {
...
impl TryFrom<crate::instructions::postgres::InitializeAccountRow> for InitializeAccountGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::InitializeAccountRow,
