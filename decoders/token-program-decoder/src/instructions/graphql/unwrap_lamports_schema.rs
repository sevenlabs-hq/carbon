...
#[graphql(name = "UnwrapLamports")]
pub struct UnwrapLamportsGraphQL {
...
impl TryFrom<crate::instructions::postgres::UnwrapLamportsRow> for UnwrapLamportsGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::UnwrapLamportsRow,
