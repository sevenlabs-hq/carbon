...
#[graphql(name = "SyncNative")]
pub struct SyncNativeGraphQL {
...
impl TryFrom<crate::instructions::postgres::SyncNativeRow> for SyncNativeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(row: crate::instructions::postgres::SyncNativeRow) -> Result<Self, Self::Error> {
        Ok(Self {
