...
#[graphql(name = "GetAccountDataSize")]
pub struct GetAccountDataSizeGraphQL {
...
impl TryFrom<crate::instructions::postgres::GetAccountDataSizeRow> for GetAccountDataSizeGraphQL {
    type Error = carbon_core::error::Error;
    fn try_from(
        row: crate::instructions::postgres::GetAccountDataSizeRow,
